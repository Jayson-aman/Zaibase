...
const styles = StyleSheet.create({
  ...
  backBtn: { minWidth: 64 },
  backBtnText: { fontSize: 17, color: '#1E40AF', fontWeight: '600' },
  headerTitle: {
    flex: 1,
    fontSize: 17,
    fontWeight: '800',
  ...
  heading: { fontSize: 16, fontWeight: '800', color: '#1E40AF', marginBottom: 8 },
  paragraph: { fontSize: 14.5, lineHeight: 24, color: '#334155', marginBottom: 6 },
  bulletRow: { flexDirection: 'row', marginBottom: 4, paddingRight: 4 },
  bulletDot: { fontSize: 14.5, lineHeight: 24, color: '#64748B', marginRight: 2 },
  bulletText: { flex: 1, fontSize: 14.5, lineHeight: 24, color: '#334155' },
  updated: { fontSize: 13, color: '#94A3B8', marginTop: 12, textAlign: 'right' },
});
