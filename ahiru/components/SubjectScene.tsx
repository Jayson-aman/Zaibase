...
const SCENES: Record<SubjectKey, { bg: [string, string]; elems: Elem[] }> = {
  sansu: {
    bg: ['#FFFDE7', '#FFE082'],
    elems: [
      { emoji: '✏️', left: 6,  top: 8,  size: 38, anim: 'bounce', delay: 0,   dur: 800 },
      { emoji: '📐', left: 50, top: 5,  size: 44, anim: 'swing',  delay: 150, dur: 1100 },
      { emoji: '💡', left: 74, top: 48, size: 36, anim: 'pulse',  delay: 300, dur: 850 },
      { emoji: '⭐', left: 12, top: 60, size: 32, anim: 'pop',    delay: 500, dur: 950 },
      { emoji: '🔢', left: 55, top: 62, size: 30, anim: 'float',  delay: 100, dur: 1300 },
    ],
  },
  kokugo: {
    bg: ['#FCE4EC', '#F8BBD0'],
    elems: [
      { emoji: '📖', left: 8,  top: 6,  size: 44, anim: 'float',  delay: 0,   dur: 1400 },
      { emoji: '🌸', left: 62, top: 5,  size: 36, anim: 'spin',   delay: 200, dur: 3000 },
      { emoji: '✍️', left: 10, top: 58, size: 38, anim: 'bounce', delay: 100, dur: 900 },
      { emoji: '🎭', left: 66, top: 55, size: 32, anim: 'swing',  delay: 400, dur: 1200 },
      { emoji: '💫', left: 38, top: 70, size: 28, anim: 'pop',    delay: 650, dur: 1000 },
    ],
  },
  rika: {
    bg: ['#E8F5E9', '#C8E6C9'],
    elems: [
      { emoji: '🔬', left: 30, top: 5,  size: 46, anim: 'bounce', delay: 0,   dur: 1000 },
      { emoji: '🌱', left: 6,  top: 52, size: 38, anim: 'float',  delay: 200, dur: 1600 },
      { emoji: '🧪', left: 66, top: 38, size: 36, anim: 'swing',  delay: 400, dur: 1100 },
      { emoji: '💧', left: 72, top: 68, size: 30, anim: 'pop',    delay: 600, dur: 750 },
      { emoji: '⚡', left: 18, top: 18, size: 28, anim: 'pulse',  delay: 300, dur: 700 },
    ],
  },
  shakai: {
    bg: ['#FFF8E1', '#FFECB3'],
    elems: [
      { emoji: '🗾', left: 20, top: 8,  size: 44, anim: 'float',  delay: 0,   dur: 1800 },
      { emoji: '🏯', left: 64, top: 5,  size: 38, anim: 'bounce', delay: 200, dur: 1000 },
      { emoji: '🚅', left: 4,  top: 60, size: 34, anim: 'swing',  delay: 400, dur: 900 },
      { emoji: '⛩️', left: 62, top: 57, size: 36, anim: 'pulse',  delay: 100, dur: 1200 },
      { emoji: '🌸', left: 36, top: 72, size: 28, anim: 'pop',    delay: 600, dur: 1100 },
    ],
  },
  eigo: {
    bg: ['#E3F2FD', '#BBDEFB'],
    elems: [
      { emoji: '✈️', left: 4,  top: 10, size: 42, anim: 'swing',  delay: 0,   dur: 1300 },
      { emoji: '🌍', left: 54, top: 6,  size: 44, anim: 'spin',   delay: 0,   dur: 4000 },
      { emoji: '💬', left: 8,  top: 58, size: 36, anim: 'pop',    delay: 300, dur: 1000 },
      { emoji: '⭐', left: 68, top: 60, size: 30, anim: 'bounce', delay: 500, dur: 800 },
      { emoji: '🌟', left: 38, top: 72, size: 26, anim: 'pulse',  delay: 200, dur: 900 },
    ],
  },
};
