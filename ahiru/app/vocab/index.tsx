...
const s = StyleSheet.create({
  ...
  exampleBox:        { backgroundColor: '#FAF7F2', borderRadius: 10, padding: 12, marginBottom: 10, borderLeftWidth: 2, borderLeftColor: D.blue },
  ...
  purchaseBtnText:   { fontSize: 20, fontWeight: '800', color: '#2B2420' },
