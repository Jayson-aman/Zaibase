...
const CHUGAKU_NG =
  /光補償点|光飽和点|原形質分離|浸透圧|根圧|減数分裂|染色体|デオキシリボ|遺伝子型|表現型|メンデル|顕性|潜性|優性の法則|分離の法則|独立の法則|検定交雑|検定交配|突然変異|自然選択|自然淘汰|半保存的複製|二重らせん|対立遺伝子|雑種第一代|陽生植物|陰生植物|カルビン回路|RuBisCO|明反応|暗反応|NADPH|細胞呼吸|塩基配列|体細胞分裂|生殖細胞|配偶子|ミトコンドリア|オルガネラ/;
check(
