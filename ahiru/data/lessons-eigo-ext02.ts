...
export const eigoExt02Lessons: Lesson[] = [
  //  1. be動詞（am/is/are）の使い分け・短縮形（s041〜s045） 
  {
    ...
    intro: '「私は学生。」は、日本語では動詞がなくても通じます。ところが英語で I a student. とは言えません。必ず am が要ります。be動詞は「です」ではなく「＝」だと考えると、なぜ省けないのかが見えてきます。',
    order: 541,
    studyPeriod: '小4',
    targetLevel: 'kiso',
    keyPoints: [
...
例）She is Japanese.（○）※ Japanese はここでは形容詞`,
...

  {
    ...
    intro: 'You is my friend. と書いてしまう人は少なくありません。you は1人でも are だからです。be動詞は、主語が何人称で単数か複数かだけで自動的に決まります。3つの使い分けをここで整理しましょう。',
    order: 542,
    studyPeriod: '小4',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：be動詞のすぐ前の語を見て決めるのではなく、「文の主語は何か」をつかんでから決める。前置詞（with / on / in など）から始まるかたまりは主語ではない。`,
...

  {
    ...
    intro: '「ケンと私は」を Ken and I is と続けたくなりますが、2人なので we、つまり are です。名詞を代名詞に置きかえられれば、be動詞も自動的に決まります。まずは7つの代名詞を押さえます。',
    order: 543,
    studyPeriod: '小4',
    targetLevel: 'kiso',
    keyPoints: [
...
主語を代名詞に置きかえてから be動詞を選ぶと、まちがいがへる。`,
...

  {
    ...
    intro: "会話では I am を I'm、is not を isn't のように縮めます。まちがえやすいのが its と it's です。it's は it is の短縮形、its は「その」を表す別の語。アポストロフィの位置にも理由があります。",
    order: 544,
    studyPeriod: '小4',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：Yes, I\'m not. のような形も存在しない。否定で答えるときは No, I\'m not. または No, I am not. とする。`,
...

  {
    ...
    intro: '「机の上に本があります」を英語にするとき、have を使いたくなります。でも持ち主の話ではないので My book is on the desk. と be動詞を使います。be動詞には「＝」のほかに「ある・いる」の意味があるのです。',
    order: 545,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：日本語の「〜がある」につられて have を使うまちがいが多い。have は「持っている」であって、場所を言う文には使えない。`,
  ...
  //  2. be動詞の否定文・疑問文・答え方（s046〜s049） 
  {
    ...
    intro: "I don't am a student. と書いてしまうのは、否定文には don't が要ると思いこんでいるからです。be動詞の文は not を後ろに置くだけで否定になります。do の出番はありません。位置を体で覚えましょう。",
    order: 546,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：not をどこに入れるか迷ったら、「be動詞をさがして、そのすぐ右に置く」と手順化する。主語の前や文の最後に置くことはない。`,
...

  {
    ...
    intro: 'Do you are a student? は動詞が2つになるので通じません。be動詞の文では、be動詞を主語の前に出すだけで疑問文になります。入れかえるだけ、というこの語順の操作を図で確かめましょう。',
    order: 547,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：疑問文にすると主語が be動詞のあとに来るので、be動詞をどれにするかを主語で決めるという順序は変わらない。先に主語を見つけてから、is か are かを決める。`,
...

  {
    ...
    intro: "Are you hungry? に Yes, I'm. と答えると、英語では尻切れに聞こえます。Yes, I am. と最後まで言うのがきまりです。しかもたずねられた you は、答えるときには I か we に変わります。",
    order: 548,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：Yes, this is. のように this をそのまま使うのはまちがい。答えではすでに何を指すか分かっているので、代名詞の it / they を使う。`,
  ...
  },
  {
    ...
    intro: '「トイレはどこですか」を Where is toilet? と言ってしまう人は多いのですが、the が抜けています。それ以前に語順の問題もあります。疑問詞は必ず文の先頭、そのあとに be動詞と主語。そして Yes・No では答えません。',
    order: 549,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：Whose（だれの）と Who\'s（＝Who is）は音が同じで、意味がまったくちがう。Whose bag is this?（これはだれのかばんですか）と Who\'s that man?（あの男の人はだれですか）を書き分ける。`,
      ...
      {
        heading: 'なぜ疑問詞は先頭で、なぜ Yes / No で答えないのか',
        mangaId: 'eigo_s049_manga',
        body: `疑問詞は「何・だれ・どこ」という**知りたいことそのもの**を表す語です。英語では、いちばん知りたいことを文の先頭に置いて相手に伝えます。だから What is your name? のように疑問詞が先頭に来て、そのあとはふつうの疑問文の語順（be動詞＋主語）が続きます。日本語の「あなたの名前は何ですか」の順のまま Your name is what? と置くと、英語では知りたいことが最後に来てしまい、疑問文になりません。

Yes / No で答えないのは、疑問詞の質問が「はい・いいえ」で答えられる質問ではなく、**中身（名前・人・場所）を聞いている**からです。What is this? に Yes, it is. と答えても、何なのかは伝わりません。答えは It is a dictionary. のように中身を言います。be動詞は主語の数で決まるので、Where are my keys? のように keys が複数なら are です。

■ 確かめのしかた
①作り方は二段階：**①ふつうの疑問文を作る（Is your bag 〜?）→②たずねたい部分を疑問詞にして先頭に出す（Where is your bag?）**。
②疑問詞のうしろが**be動詞＋主語**の順になっているか。Where your bag is? は×。
③答えを書く前に**文の先頭に疑問詞があるか**を見る。あれば Yes / No は使わず、中身を答える。
④be動詞は主語の数に合わせる（key→is、keys→are）。Whose（だれの）と Who's（＝Who is）を書き分ける。

★ ここがポイント：疑問詞は**知りたいことそのもの**なので先頭に置き、あとは**be動詞＋主語**の疑問文の語順。**中身を聞いている**ので Yes / No では答えない。作り方は「ふつうの疑問文→疑問詞を先頭に」の二段階。`,
      },
    ],
    trapExamples: [
      {
  ...
  //  3. 一般動詞の肯定文・三単現（s050〜s055） 
  {
    ...
    intro: '「私はテニスをします」を I am play tennis. と書く人はとても多いのです。「します」につられて am を足してしまうからです。英語の文の動詞は1つだけ。be動詞と一般動詞は同時には使えません。',
    order: 550,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：英語を書くときは、まず主語、次に動詞、最後に「何を」の順に組み立てる。日本語を一語ずつ置きかえるのではなく、順番を組みかえる意識をもつ。`,
...

  {
    ...
    intro: '日本語は「私は 毎週日曜に 公園で テニスを します」と、動詞が最後に来ます。英語は I play tennis と、動詞と「何を」が先。「いつ・どこで」は後回しです。この順番の逆転が英作文の第一関門です。',
    order: 551,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：主語の位置で使う形（he / she / they）と目的語の位置で使う形（him / her / them）を混同しない。動詞のうしろに来たら形がかわる、と覚える。`,
...

  {
    ...
    intro: 'He play soccer. は、日本語の感覚では何もおかしくありません。でも英語では、主語が「自分でも相手でもない1人」のときだけ動詞に -s が付きます。なぜ主語で動詞が変わるのか、ここで整理します。',
    order: 552,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
例）He has three dogs.（主語 He が単数なので has）`,
...

  {
    ...
    intro: 'go に -s を付けると gos ではなく goes です。watch も watchs ではなく watches。-es になるのは s・x・ch・sh・o で終わる5種類だけ。数が少ないので、まとめて覚えてしまえば迷いません。',
    order: 553,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：play は y で終わるが、直前が a（母音）なので plays でよい。y で終わる動詞をすべて -ies にするのは誤りである。くわしくは次のまとまりで扱う。`,
...

  {
    ...
    intro: 'study は studies なのに、play は plays。同じ y で終わるのに変化がちがいます。分かれ目は、y の直前が母音字かどうかです。そして have だけは has という特別な形になります。',
    order: 554,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
動詞と名詞で同じ規則が働くので、あわせて覚えると効率がよい。`,
...

  {
    ...
    intro: 'The boy with two dogs run fast. は、どこがまちがいでしょうか。走るのは boy 1人なので runs です。dogs につられて複数だと思ってしまうのです。動詞の形を決めるのは、いつでも主語の中心の語です。',
    order: 555,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：解き終わったら、①主語はどれか、②単数か複数か、③現在の文か、の三つを口の中で確かめる。この確認だけで失点が大きくへる。`,
  ...
  //  4. 一般動詞の否定文・疑問文（s056〜s060） 
  {
    ...
    intro: "I not like natto. と書きたくなりますが、英語では通じません。一般動詞の文を否定するには、do という語をわざわざ借りてきて don't を作ります。なぜそんな手間をかけるのか、形から見ていきましょう。",
    order: 556,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：Don\'t で始まる命令文と、I don\'t 〜 の否定文を混同しない。主語があるかないかで見分ける。`,
  ...
  },
  {
    ...
    intro: "He doesn't plays soccer. は最頻出のまちがいです。doesn't がすでに三単現を引き受けているので、動詞は原形の play にもどします。-s は文の中に1つだけ、と考えると迷いません。",
    order: 557,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：does not を短縮すると doesn\'t。does\'nt や dose\'nt と書くまちがいが多いので、つづりも正確に覚える。`,
...

  {
    ...
    intro: 'Do you like dogs? に Yes, I like. と答えると不自然です。答えは Yes, I do. と do でそろえます。たずねるときも答えるときも、借りてきた do がそのまま使われるのです。',
    order: 558,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：たずねる文が Do で始まっていたら答えも do、Are で始まっていたら答えも be動詞。「問いの最初の語と、答えに使う語をそろえる」と覚えると混乱しない。`,
...

  {
    ...
    intro: 'Does he plays tennis? と書いてしまう人が絶えません。Does がすでに三単現を表しているので、動詞は原形にもどします。has も have にもどります。答え方も does でそろえます。',
    order: 559,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：Does を使った疑問文を作ったあと、必ずうしろの動詞を見て -s が残っていないかを確かめる。ここは入試でもっとも多い失点の一つである。`,
...

  {
    ...
    intro: 'What do you like? の語順は、日本語の「あなたは何が好きですか」とはまるで逆です。疑問詞が先、次に do、そして主語。ところが Who plays the piano? のように、疑問詞が主語になると do が消えます。',
    order: 560,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：疑問詞が主語の文は上位校でよく問われる。「疑問詞のうしろに主語があるか」で判断する手順を身につけておく。`,
  ...
  //  5. be動詞と一般動詞の混同を防ぐ（s061〜s064） 
  {
    ...
    intro: 'I am play tennis. も He is like music. も、まちがいの正体は同じです。動詞を2つ並べていること。日本語の「です・ます」につられると、つい be動詞を足してしまいます。指さして確かめる習慣をつけましょう。',
    order: 561,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：うしろに来るのが「動作を表す語」なら一般動詞だけ、「名前・様子を表す語」なら be動詞、と切り分けて考える。`,
...

  {
    ...
    intro: "He isn't speak Japanese. と He doesn't a teacher. は、どちらも同じ迷いから生まれます。not だけでよいのか、do を借りるのか。決め手は、もとの文の動詞が be動詞かどうか、その一点です。",
    order: 562,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：「〜がいます／あります」を be動詞で表している文（There is a cat 〜）の否定は There isn\'t a cat 〜 で、be動詞の規則にしたがう。`,
      ...
      {
        heading: 'なぜ be動詞は not だけで、一般動詞は do を借りるのか',
        mangaId: 'eigo_s062_manga',
        body: `be動詞（am / is / are）は、そのものが「〜である」という意味を持ち、否定するには**うしろに not を置くだけ**で足ります（is not）。ところが一般動詞（speak・play・know）は、そのままでは not を付けられません。そこで英語は「do」という**手伝いの語**を借りて、do not（don't）speak と否定します。does は主語が三人称単数のときの do の形で、そのぶん動詞は原形に戻します。つまり否定文の作り方は、もとの文の動詞が be動詞かどうか、その一点で決まります。

「動詞を数える」と確かめられるのは、正しい文には**動詞が必ず一つ**あるからです。He doesn't a teacher. は動詞がゼロ（is が消えた）、He isn't speak Japanese. は動詞が二つ（is と speak）。どちらも数えれば気づけます。

■ 確かめのしかた
①もとの文の**動詞を探す**。am / is / are なら be動詞、それ以外なら一般動詞。
②be動詞なら、うしろに not（isn't / aren't / I'm not）。一般動詞なら、前に don't / doesn't を置き、動詞を**原形**に戻す。
③作った否定文の**動詞を数える**。ゼロや二つになっていたら×。
④have は一般動詞（I don't have a dog.）。There is 〜 の否定は There isn't 〜（be動詞の規則）。

★ ここがポイント：be動詞は**not だけで否定できる**が、一般動詞は**do を借りる**。決め手は**もとの文の動詞が be動詞か**の一点。作ったら**動詞が一つ**あるか数える。`,
      },
    ],
    trapExamples: [
      {
...

  {
    ...
    intro: 'Are you have a pen? と言ってしまうのは、have が「あります」に近く感じられるからでしょうか。have は一般動詞なので Do you have a pen? が正しい形です。見分け方をはっきりさせましょう。',
    order: 563,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
■ 確かめのしかた
①もとの文の動詞が be動詞なら**主語の前に出す**、一般動詞なら**Do / Does を先頭**に置いて動詞を原形にする。
②作った疑問文で、Do / Does をのぞいて**動詞が一つ**か数える。
③**問いの最初の語**を見てから答える。Are 〜?→Yes, I am. / No, I'm not.、Do 〜?→Yes, I do. / No, I don't.
④have は一般動詞（Do you have a pen?→Yes, I do.）。「〜にいますか」は be動詞（Are you at home?→Yes, I am.）。

★ ここがポイント：Do / Does は**疑問文の合図の語**で動詞に数えないので、「合図＋動詞一つ」か「be動詞＋主語」が正しい形。答えは**問いの最初の語をくり返す**（Do→do、Are→am）。`,
      },
    ],
    trapExamples: [
      {
...

  {
    ...
    intro: 'be動詞か一般動詞か、否定文か疑問文か。組み合わせはたった4つしかありません。それなのに混乱するのは、一つずつばらばらに覚えているからです。1枚の表にまとめると、自分がどこで迷っているのかが見えてきます。',
    order: 564,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：同じ「〜います」でも、〈場所〉が続けば be動詞、〈持っているもの〉が続けば have になる。うしろに何が来るかを見て決める。`,
      ...
      {
        heading: 'なぜ日本語の訳から入るとまちがえるのか',
        mangaId: 'eigo_s064_manga',
        body: `日本語の「です・ます」は、be動詞にも一般動詞にも付きます。「ねむいです」「サッカー選手です」はどちらも「です」ですが、英語では sleepy（形容詞）も a soccer player（名詞）も be動詞で結びます。「兄がいます」「大阪にいます」はどちらも「います」ですが、家族は have、場所は be動詞です。つまり**日本語の語尾は英語の動詞を決める手がかりにならない**ので、訳から入ると必ずどこかでまちがえます。

だから決め方は「まず英語の動詞を決める」です。①この文で使う動詞は何か、②am / is / are なら be動詞の規則、それ以外なら一般動詞の規則、③一般動詞なら主語を見て do / does。動詞が決まれば、否定文も疑問文も四つの型のどれかに自動的に決まります。四つの型を一枚の表にするのは、自分がどの型で迷っているかを見えるようにするためです。

■ 確かめのしかた
①日本語ではなく**うしろに来る語**で決める。形容詞（sleepy・hungry）→be動詞。名詞（a player）→be動詞。動作（play・live・like）→一般動詞。
②「〜います」は、うしろが**持っているもの・家族**なら have、**場所**なら be動詞。I have two sisters. ／ He is in Osaka.
③動詞を決めたら、四つの型のどれかを言う：be動詞の否定（isn't）／疑問（Is 〜?）、一般動詞の否定（doesn't）／疑問（Does 〜?）。
④I am like soccer. や He is live in Osaka. のように、be動詞と一般動詞を重ねていないか（動詞を数える）。

★ ここがポイント：日本語の「です・います」は**英語の動詞を決める手がかりにならない**。**うしろに来る語**（形容詞・名詞→be動詞、動作→一般動詞、持ち物→have）で動詞を決めれば、否定・疑問は四つの型に自動的に決まる。`,
      },
    ],
    trapExamples: [
      {
  ...
  //  6. 第1文型 SV・第2文型 SVC（s065〜s068） 
  {
    ...
    intro: '同じ「〜になる」でも、He became a doctor. と He got angry. では後ろに来る語の種類がちがいます。英語の文は S・V・O・C という部品でできていて、その組み合わせは5つだけ。部品の見分け方から始めます。',
    order: 565,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
■ 確かめのしかた
①**前置詞（in・on・at・with・to・for）から始まるかたまりと時の語句**を（　）でくくる。
②残った語に S・V・O・C を当てる。主語は「動詞の動作をする人・もの」で、先頭にあるかどうかでは決めない（Every morning my mother makes breakfast. の S は my mother）。
③動詞のうしろの語が**主語とイコール**なら C（SVC）、イコールでなければ O（SVO）。
④O のうしろにもう一語あれば、**O とイコール**なら C（SVOC：him＝Ken）、イコールでなければ二つ目の O（SVOO：me≠a book）。

★ ここがポイント：文型は**骨組み**なので、**修飾語を先に（　）で消す**。C は**イコールになる語**（He＝a doctor、him＝Ken）、O はならない語。この二つの作業で五つの文型は必ず決まる。`,
      },
    ],
    trapExamples: [
      {
...

  {
    ...
    intro: 'I go to school. の「学校に」は、日本語では目的語のように見えます。でも英語では to school は飾りにすぎず、文の骨組みは I go の2つだけ。この見分けができると、文型の問題が怖くなくなります。',
    order: 566,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：訳ではなく、英語の形を覚える。go to／arrive at／listen to は前置詞が要り、enter／reach／discuss は前置詞なしで目的語をとる。`,
...

  {
    ...
    intro: 'He is a doctor. の he と a doctor は同じ人です。I like dogs. の I と dogs は別ものです。後ろに来る語が主語とイコールになるかどうか。この一点で文型が決まります。実際に「＝」を書いて確かめましょう。',
    order: 567,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：You look happily. は誤り。happily は「幸せそうに」という副詞である。正しくは You look happy.（あなたは幸せそうに見える）。`,
...

  {
    ...
    intro: '「このスープはおいしそうなにおいがする」を This soup smells deliciously. と書くと誤りです。smell のあとには形容詞が来るので good を使います。感覚を表す動詞のうしろは、副詞ではないのです。',
    order: 568,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：good（形容詞）と well（副詞）を混同しない。This soup smells good.（○）／ This soup smells well.（✗）。ただし He plays tennis well.（上手にテニスをする）は一般動詞を修飾するので well が正しい。`,
  ...
  //  7. 第3文型 SVO・目的語（s069〜s072） 
  {
    ...
    intro: 'I like dogs. の I と dogs はイコールになりません。ここが He is a doctor. との決定的なちがいです。動詞のすぐうしろに前置詞なしで名詞が来ていれば、それが目的語。英語でいちばん多い形です。',
    order: 569,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：want のうしろは to＋原形、enjoy のうしろは ing 形と決まっている。× I want playing tennis. や × He enjoys to play soccer. は誤り。中学受験でも上位校ではここまで問われる。`,
...

  {
    ...
    intro: 'I like she. と書いてしまうのは、日本語の「彼女が好き」に引かれるからかもしれません。英語では、動詞のうしろに来た瞬間に her に変わります。同じ人でも位置で形が変わる、という感覚をつかみましょう。',
    order: 570,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：前置詞（of / to / for / with / at）のうしろは必ず目的格。ここは書き取り問題で頻出である。`,
...

  {
    ...
    intro: '「〜を訪ねる」は visit Kyoto と前置詞なしなのに、「〜を聞く」は listen to music と to が要ります。日本語ではどちらも「を」なので、助詞から判断すると必ず外れます。動詞ごとに覚えるしかありません。',
    order: 571,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：listen・look は前置詞が要り、hear・see は要らない。二組をセットで覚えると混同しない。`,
      ...
      {
        heading: 'なぜ日本語の「を」は手がかりにならないのか',
        mangaId: 'eigo_s071_manga',
        body: `英語の動詞には、目的語を**直接**うしろに置ける動詞（他動詞）と、置けない動詞（自動詞）があります。listen や look は自動詞で、「何を」を続けるには to や at という前置詞の橋が要ります。visit や enter は他動詞で、橋なしで直接続けます。この区別は**英語の動詞ごとに決まっていて、日本語の訳とは関係がありません**。「音楽を聞く」も「京都を訪ねる」も日本語では同じ「を」ですが、英語では listen to music と visit Kyoto です。だから助詞で判断すると必ず外れ、動詞ごとに覚えるしかありません。

同じ「聞く・見る」でも、listen to／look at は意識して聞く・見る、hear／see は自然に聞こえる・見える、という意味のちがいがあり、前置詞の有無も対になっています。二組をセットで覚えると混同しません。

■ 確かめのしかた
①**前置詞が要る動詞**を言えるか：listen to／look at／arrive at（in）／wait for／go to。
②**前置詞を入れたくなるが入れない動詞**を言えるか：enter／reach／visit／discuss／marry。× enter into、× reach to、× discuss about。
③文を書いたら、動詞のうしろを見る。I listen music→listen は自動詞→to が要る。We arrived the station→arrive は自動詞→at が要る。
④対で確かめる：listen to／hear、look at／see。run は自動詞（走る）にも他動詞（経営する）にもなる。

★ ここがポイント：目的語を直接置けるかは**英語の動詞ごとに決まっていて、日本語の「を・に」とは無関係**。前置詞が要る動詞（listen to・look at・arrive at・wait for）と要らない動詞（enter・reach・visit・discuss・marry）を、対（listen to／hear）で覚える。`,
      },
    ],
    trapExamples: [
      {
...

  {
    ...
    intro: 'He got angry.（怒った）と He got a letter.（手紙を受け取った）。同じ got なのに文型がちがいます。訳し方で悩むと迷路に入ります。判断はただ一つ、主語とうしろの語がイコールになるかどうかです。',
    order: 572,
    studyPeriod: '小6前半',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：動詞の意味を一つだけ覚えていると、文型の判断をまちがえる。文全体を読んで、主語とうしろの語がイコールかどうかを毎回確かめる習慣をつける。`,
  ...
  //  8. 第4文型 SVOO と書きかえ（s073〜s076） 
  {
    ...
    intro: 'He gave a book me. と書くと通じません。英語では「人に」が先、「ものを」が後ろです。日本語なら「私に本を」も「本を私に」も自然ですが、英語は順番が決まっています。なぜその順なのかを見ていきます。',
    order: 573,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：say と tell の使い分けは頻出である。「人に」を直接続けられるのは tell、say は say to 〜 の形になる。`,
      ...
      {
        heading: 'なぜ「人」が先で「もの」があとなのか',
        mangaId: 'eigo_s073_manga',
        body: `He gave me a book. のように動詞のうしろに二つの目的語を並べるとき、英語では**受け取る人を先、わたすものをあと**に置きます。give・tell・show・teach は「相手に向かって何かをわたす」動作なので、まず相手（だれに）を言い、次に中身（何を）を言う順が自然だからです。「もの」を先に言いたいときは、He gave a book to me. のように前置詞 to で「相手」を示す必要があります。前置詞なしで並べるなら、必ず人が先です。日本語は「私に本を」も「本を私に」も言えるので、この順番を知らないと入れかえてしまいます。

第4文型を作れる動詞が限られているのは、「人に・ものを」という**わたす動作**の動詞だけがこの形をとるからです。say は「言葉を発する」動作で相手を直接とれないので、He said me 〜 とは言えず、相手を直接とれる tell を使います（He told me the truth.）。say を使うなら say to me の形です。

■ 確かめのしかた
①動詞のうしろに二つの語を並べたら、**人→もの**の順か。He gave a book me. は×。
②二つの目的語が**イコールでない**ことを確かめる（me≠a book）。イコールなら第5文型（SVOC）。
③第4文型を作れる動詞か：give・send・show・teach・tell・lend・pass・buy・make・cook・get・ask。**say は不可**→tell に直す。
④「もの」を先にしたいときは前置詞を付ける：He gave a nice present to me.

★ ここがポイント：第4文型は**わたす動作**の動詞で、**受け取る人が先、ものがあと**。ものを先にするなら to が要る。二つの O はイコールにならず、**say は使えない（tell を使う）**。`,
      },
    ],
    trapExamples: [
      {
...

  {
    ...
    intro: 'He gave me a book. は He gave a book to me. とも言えます。同じ意味なのに形が2つあるのはなぜでしょう。しかも to を使える動詞と使えない動詞があります。まずは「相手にわたす」型からです。',
    order: 574,
    studyPeriod: '小6前半',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：to を for にしてはいけない。give / tell / show / teach / send はすべて to である。`,
...

  {
    ...
    intro: 'My mother made me a cake. を書きかえると、to ではなく for を使います。相手にわたすのではなく、相手のために作るからです。to 型と for 型は動詞ごとに決まっていて、訳し方では決まりません。',
    order: 575,
    studyPeriod: '小6前半',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：書きかえの問題では、動詞を見た瞬間に to か for かを決められるようにしておく。訳から考えると「〜のために」がどちらにも当てはまってしまい、判断できない。`,
...

  {
    ...
    intro: 'Does he gives you a present? と書いてしまうのは、目的語が2つあって文が長くなり、動詞を原形にもどすのを忘れるからです。「だれに」をたずねると、文末に to がぽつんと残る形も出てきます。',
    order: 576,
    studyPeriod: '小6前半',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：What does he give you? の does のうしろは原形 give である。gives と書いてしまう誤りが非常に多いので、書いたあとに必ず確かめる。`,
  ...
  //  9. 第5文型 SVOC（s077〜s080） 
  {
    ...
    intro: 'We call him Ken. の him と Ken は同じ人です。これが He gave me a book.（me と a book は別もの）とのちがいです。目的語のあとに、その目的語を説明する語が来る形をここで学びます。',
    order: 577,
    studyPeriod: '小6前半',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：第5文型を作れる動詞は限られている。call・name・make・keep・find・leave・elect などを覚えておけば、中学受験では十分である。`,
...

  {
    ...
    intro: '「これは英語で何と言いますか」を How do you call this? と言いたくなりますが、正しくは What do you call this in English? です。日本語の「どう」に引かれて How を使うのが、よくあるまちがいです。',
    order: 578,
    studyPeriod: '小6前半',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：日本語では「なんて呼ぶの」「どう呼ぶの」のどちらでも言えるが、英語では What しか使えない。ここは書きかえ・選択問題の定番である。`,
...

  {
    ...
    intro: 'The news made me happy. は、直訳すると「その知らせが私を幸せにした」。日本語なら「知らせを聞いてうれしかった」と言うところです。ものを主語にして人の気持ちを動かす、英語らしい言い方に慣れましょう。',
    order: 579,
    studyPeriod: '小6後半・直前',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：make・keep・find のうしろに二つの語が並んだら、まずイコールかどうかを確かめる。これだけで第4文型と第5文型を正しく分けられる。`,
...

  {
    ...
    intro: 'SVOO と SVOC は、どちらも動詞のうしろに語が2つ並びます。見た目はそっくりなのに、片方はイコールになり、もう片方はなりません。修飾語を消して数え、最後にイコールで判定する。この手順を固めます。',
    order: 580,
    studyPeriod: '小6後半・直前',
    targetLevel: 'nyushi',
    keyPoints: [
