...
export const lessonFigsEigoExt04: Record<string, Figure> = {
  ...
  lf_eigoext04_116: {
    ...
    steps: [
      ...
      "印がついているのは 先週も、昨日も、今、明日も。位置を目もりで確かめる。",
      "現在形「I play soccer every Sunday.」が指している時間。今この瞬間の動作ではなく、過去にもくり返してきて、これからもくり返す「いつものこと」を表す。今まさにしている動作は現在進行形で表す",
    ],
    buildSteps: 3,
  },
  ...
  lf_eigoext04_120: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-6から2まで、1きざみで目もりがふってある。",
      "印がついているのは yesterday（ここで完結）、今。位置を目もりで確かめる。",
      "過去形が指している時間。過去のある一点で起こって、そこで終わっている。今とは線がつながっていないので、yesterday・last week・three days ago のような「過去の時を表す語」といっしょに使える",
    ],
    buildSteps: 3,
  },
  ...
  lf_eigoext04_124: {
    ...
    steps: [
      ...
      "いちばん大きいのは「規則動詞」で、全体のおよそ95%。",
      "内わけは 規則動詞 95%、不規則動詞 5%。",
  ...
  lf_eigoext04_128: {
    ...
    steps: [
      "よこじくは「変化の型」、たてじくは「語数（およそ）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「A-B-B」で50（語数（およそ））。",
      "いちばん小さいのは「A-B-A」で8。差は42。",
      "大きい順にならべると A-B-B → A-B-C → A-A-A → A-B-A。棒の高さを見比べて確かめる。",
      "中学入試レベルで覚えたい不規則動詞およそ100語を、原形-過去形-過去分詞の変化の型で分けたときのおおよその内訳。A-B-B型（teach-taught-taught）が半分を占めるので、まずこの型からまとめて覚えると効率がよい。A-B-C型（go-went-gone）は数は少ないが、どれも最頻出の動詞ばかり",
    ],
    buildSteps: 4,
  },
  ...
  lf_eigoext04_129: {
    ...
    steps: [
      ...
      "印がついているのは 今（話している瞬間）。位置を目もりで確かめる。",
      "現在進行形 be＋~ing が指している時間。少し前に始まって、今まさに続いていて、もうすぐ終わる短い「幅」。この幅の真ん中に「今」がある。だから now・right now・Look!・Listen! と相性がよい",
    ],
    buildSteps: 4,
  },
  ...
  lf_eigoext04_130: {
    ...
    steps: [
      ...
      "この数直線は-4から4まで、1きざみで目もりがふってある。",
      "色のついた範囲は -1以上 かつ 1以下。●はその数をふくみ、○はふくまない。",
      "印がついているのは 毎日、毎日、毎日、毎日。位置を目もりで確かめる。",
      "同じ「〜しています」でも指している時間が違う。点＝現在形（I study English every day. くり返し起こること）、真ん中の帯＝現在進行形（I am studying English now. 今この瞬間の幅）。日本語の「〜ている」に引きずられず、どちらを指しているかで選ぶ",
    ],
    buildSteps: 4,
  },
  ...
  lf_eigoext04_133: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-8から2まで、2きざみで目もりがふってある。",
      "色のついた範囲は -6以上 かつ -2以下。●はその数をふくみ、○はふくまない。",
      "印がついているのは I came home.、今。位置を目もりで確かめる。",
      "When I came home, my mother was cooking dinner. の時間関係。帯＝過去進行形（ずっと続いていた動作の幅）、点＝過去形（その途中で起きた一回きりの動作）。長く続いていたほうを進行形にするのが見分け方",
    ],
    buildSteps: 4,
  },
  ...
  lf_eigoext04_135: {
    ...
    steps: [
      ...
      "色のついた範囲は -6以上 かつ 6以下。●はその数をふくみ、○はふくまない。",
  ...
  lf_eigoext04_137: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-4から6まで、2きざみで目もりがふってある。",
      "印がついているのは 今ここで決めた、I'll help you.（実行）。位置を目もりで確かめる。",
      "will が指している時間。決めたのは「今この瞬間」で、実行するのはこれから。その場の思いつき・申し出・今の予測に使う。決めた時点が今にあるのが will の特徴",
    ],
    buildSteps: 3,
  },
  ...
  lf_eigoext04_139: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-6から6まで、2きざみで目もりがふってある。",
      "印がついているのは 前に決めた、今（準備が進行中）、実行。位置を目もりで確かめる。",
      "be going to が指している時間。決めた時点が今よりも前にあり、今はもうその予定に向かって進んでいる。だから切符を買った・約束したなど、準備ずみの予定に使う。will（今決めた）との違いは「決めた時点がどこか」",
    ],
    buildSteps: 3,
  },
  ...
  lf_eigoext04_142: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-6から2まで、1きざみで目もりがふってある。",
      "色のついた範囲は -5以上 かつ 0以下。●はその数をふくみ、○はふくまない。",
      "印がついているのは 今。位置を目もりで確かめる。",
      "現在完了 have/has＋過去分詞の基本イメージ。過去のある時点から今までがひとつながりの帯になっている。過去形が「点」なのに対して、現在完了は必ず今まで届く「幅」を持つ。この一本の線が三つの用法すべてに共通する",
    ],
    buildSteps: 4,
  ...
  lf_eigoext04_144: {
    ...
    steps: [
      ...
      "この数直線は-6から2まで、1きざみで目もりがふってある。",
      "色のついた範囲は -5以上 かつ 0以下。●はその数をふくみ、○はふくまない。",
      "印がついているのは since 2021（起点）、今。位置を目もりで確かめる。",
      "for と since の違い。since は「いつから」＝帯の左はしの一点を指し、for は左はしから今までの「長さ」全体を指す。今が2026年なら、for five years と since 2021 は同じ帯を別の角度から言っているだけ。「〜前から」は for 〜 か since 〜 ago になる",
    ],
    buildSteps: 4,
  },
  ...
  lf_eigoext04_146: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-6から2まで、1きざみで目もりがふってある。",
      "色のついた範囲は -1以上 かつ 0以下。●はその数をふくみ、○はふくまない。",
      "印がついているのは 動作はここで終わった、今（その結果が残る）。位置を目もりで確かめる。",
      "完了・結果の現在完了。I have just finished my homework. は、終えたのは少し前でも、「今は宿題が残っていない」という結果が今につながっている。帯が短く、右はしが今にぴったりくっついているのが完了・結果のイメージ",
    ],
    buildSteps: 4,
  },
  ...
  lf_eigoext04_150: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-10から2まで、2きざみで目もりがふってある。",
      "色のついた範囲は -9以上 かつ 0以下。●はその数をふくみ、○はふくまない。",
  ...
  lf_eigoext04_153: {
    ...
    steps: [
      ...
      "この数直線は-8から2まで、2きざみで目もりがふってある。",
      "色のついた範囲は -5以上 かつ 0以下。●はその数をふくみ、○はふくまない。",
      "印がついているのは なくした（過去形はここで終わり）、今（現在完了はここまで届く）。位置を目もりで確かめる。",
      "同じ出来事でも、指す範囲が違う。I lost my key yesterday.＝点だけを言うので、今見つかっているかどうかには触れない。I have lost my key.＝帯が今まで届くので、「今も見つかっていない」まで表す",
    ],
    buildSteps: 4,
  },
  ...
  lf_eigoext04_155: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-8から6まで、2きざみで目もりがふってある。",
      "色のついた範囲は -4以上 かつ 0以下。●はその数をふくみ、○はふくまない。",
      "印がついているのは 過去形（点）、現在形・今、will（未来の点）。位置を目もりで確かめる。",
      "時制の全体像。過去形＝過去の一点、現在完了＝過去から今まで届く帯、現在形＝今を中心にくり返す、will／be going to＝これからのこと。迷ったら「点か、幅か」「今とつながっているか」の二つだけを確かめる",
    ],
    buildSteps: 4,
  },
