...
export const schoolKokoTodaijiFill: Question[] = [
  ...
  },
  {
    ...
    explanation:
      '【解説】\n「主観」は自分ひとりの見方や感じ方にもとづいて物事をとらえることを指す。これに対して「客観」は、だれが見ても同じだと言える立場から物事をとらえることを指し、両者は対義語の関係にある。',
    difficulty: 'standard',
    course: 'koko-todaiji',
    examType: 'koko',
  },
  ...
  },
  {
    ...
    explanation:
      '【解説】\n①実際の距離＝地図上の長さ×縮尺の分母＝4cm×25000=100000cm=1000m。\n②地図上の1cmは実際には25000cm=250mにあたる。面積は縦・横の両方に縮尺がかかるため、地図上の1cm²(1cm×1cm)にあたる実際の面積は250m×250m=62500m²になる。',
    difficulty: 'advanced',
    course: 'koko-todaiji',
    examType: 'koko',
  },
