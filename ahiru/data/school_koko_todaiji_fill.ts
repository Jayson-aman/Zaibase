...
export const schoolKokoTodaijiFill: Question[] = [
  ...
  },
  {
    ...
    subject: 'shakai',
    question:
      '縮尺25000分の1の地形図上で、2地点間の長さが4cmであった。①実際の距離は何mか求めなさい。②また、地形図上で1cm²の広さの土地の実際の面積は何㎡か求めなさい。',
    answer: '①1000m（1km）　②62500㎡',
    hint: '距離は縮尺をそのままかければよいが、面積は縮尺を2回（縦と横）かけることになる点に注意する',
    explanation:
      '【解説】\n①実際の距離＝地図上の長さ×縮尺の分母＝4cm×25000=100000cm=1000m。\n②地図上の1cmは実際には25000cm=250mにあたる。面積は縦・横の両方に縮尺がかかるため、地図上の1cm²(1cm×1cm)にあたる実際の面積は250m×250m=62500㎡になる。',
    difficulty: 'advanced',
    course: 'koko-todaiji',
    examType: 'koko',
  },
