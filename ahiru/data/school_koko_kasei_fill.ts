...
export const schoolKokoKaseiFill: Question[] = [
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】並列（12V）で R₁＝6Ω に流れる電流。\n【なぜその式なのか】並列は**どの抵抗にも電源と同じ12V**。電流＝12÷6。\n【ステップ1】12÷6＝2A。\n【答え】2A\n【確かめ】R₂ は 4A、2＋4＝6A。\n【よくあるまちがい】全体の6Aを2つに等分して3A。**抵抗の逆比**。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】標高のちがう2地点の柱状図から、かぎ層の傾き。\n【なぜその式なのか】地表からの深さだけでは比べられない。**地点の標高−深さ＝その層の標高**に直してから比べる。\n【ステップ1】A：50−10＝40m。\n【ステップ2】B：30−5＝25m。\n【ステップ3】A→B で15m低い → B の方向に低く傾いている。\n【答え】上面の標高は A で40m、B で25m。B に向かって低くなるように傾いている\n【確かめ】深さだけ見ると A のほうが深いが、標高に直すと逆になる。\n【よくあるまちがい】深さの10mと5mだけで判断する。**標高に直す**。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】石灰石を2倍にしたとき、CO₂ の発生が一定になる塩酸の体積。\n【なぜその式なのか】石灰石と塩酸は**決まった割合で過不足なく反応**する。40cm³で頭打ちになるのは石灰石がすべて反応し終えたから。石灰石が2倍なら必要な塩酸も2倍。\n【ステップ1】40×2＝80cm³。\n【答え】80cm³\n【確かめ】発生する CO₂ の最大量も2倍になる。\n【よくあるまちがい】塩酸が2倍でも CO₂ が増え続けると思う。**石灰石がなくなれば止まる**。',
    difficulty: 'standard',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】塩酸10cm³に15cm³必要なら、20cm³には何cm³か。\n【なぜその式なのか】同じ濃さなら、塩酸の中の H⁺ は**体積に比例**する。必要なアルカリも比例。\n【ステップ1】10：15＝20：x。\n【ステップ2】x＝30cm³。\n【答え】30cm³\n【確かめ】塩酸が2倍なので2倍。\n【よくあるまちがい】15＋10＝25 とたす。**倍にする**。',
    difficulty: 'standard',
    course: 'koko-kasei',
    examType: 'koko',
  },
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】焦点の内側に物体を置いたときに見える像。\n【なぜその式なのか】焦点の内側からの光はレンズを通っても**集まらずに広がる**ので実像はできない。レンズをのぞくと、光の来た方向をたどった先に**同じ向きで大きい像（虚像）**が見える。\n【ステップ1】正立の虚像。\n【ステップ2】物体より大きい。\n【答え】正立の虚像。物体より大きい\n【確かめ】虫めがねで文字を大きく見るのがこれ。\n【よくあるまちがい】虚像がスクリーンに映ると思う。**映らない**。',
    difficulty: 'standard',
    course: 'koko-kasei',
    examType: 'koko',
  },
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】肺で酸素をもらった血液が全身へ出るまでの経路。\n【なぜその式なのか】肺からもどる血液は**左心房**に入り、**左心室**から大動脈へ送り出される。\n【ステップ1】肺静脈→左心房。\n【ステップ2】左心室→大動脈→全身。\n【答え】肺静脈→左心房→左心室→大動脈\n【確かめ】全身からもどる血液は大静脈→右心房→右心室→肺動脈。\n【よくあるまちがい】右心房に入るとする。**肺からは左心房**。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】生産者100、1段階ごとに1/10のときの三次消費者の数量。\n【なぜその式なのか】食べる・食べられるで**段階が上がるごとにエネルギーの多くが失われる**ので、数量が減る。1/10を3回。\n【ステップ1】一次 10、二次 1。\n【ステップ2】三次 0.1。\n【答え】0.1\n【確かめ】100×(1/10)³＝0.1。\n【よくあるまちがい】三次消費者を1にする。**3回かける**。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】0.1秒ごとの移動距離が 2, 4, 6, 8, 10cm のときの速さの変化と、0.5秒の合計距離。\n【なぜその式なのか】0.1秒ごとの距離が**同じ2cmずつ増えている**ので、速さが時間に比例して増えている。合計は5区間をたす。\n【ステップ1】速さは 20, 40, 60, 80, 100cm/s と一定の割合で増加。\n【ステップ2】2＋4＋6＋8＋10＝30cm。\n【答え】速さは時間に比例して大きくなる。0.5秒で30cm\n【確かめ】平均の速さ 60cm/s×0.5秒＝30cm。\n【よくあるまちがい】最後の区間の10cmだけ答える。**合計**。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  ...
  // ============================================================
  {
    ...
    explanation:
      '【何を聞かれているか】大日本帝国憲法（明治憲法）と日本国憲法を比較したとき、主権の所在についてどのような違いがあるかである。\n\n【なぜそうなるのか】明治憲法では天皇が神聖不可侵の存在として統治権を握るという考え方が採られていたが、日本国憲法では国の政治のあり方を最終的に決める権限が国民にあるという原則に転換された。\n\n【ステップ1】明治憲法では、天皇が神聖不可侵の存在として統治権を一手に握る天皇主権の考え方が採られていた。\n\n【ステップ2】日本国憲法では、国の政治のあり方を最終的に決める権限（主権）は国民にあるとする国民主権の原則が採られ、天皇は政治的権限を持たない日本国・日本国民統合の象徴と定められている。\n\n【答え】明治憲法では主権は天皇にあり(天皇主権)、天皇が統治権を総攬した。日本国憲法では主権は国民にあり(国民主権)、天皇は日本国および日本国民統合の象徴と位置づけられている。\n\n【確かめ】「明治憲法＝天皇主権」「日本国憲法＝国民主権」を確認する。\n\n【よくあるまちがい】日本国憲法のもとでも天皇に政治的権限が残っていると誤解しないこと。天皇は象徴であり政治的権限を持たない。\n\n【ここが絶対】「天皇主権（明治憲法）と国民主権（日本国憲法）」は公民の最頻出事項。',
    difficulty: 'standard',
    course: 'koko-kasei',
    examType: 'koko',
  },
...
export const figuresKokoKaseiFill: Record<string, Figure> = {
  ...
  kasei_rika_04: {
    ...
    steps: [
      '横の軸が光の強さ（klx）、たての軸がCO₂の吸収速度。マイナスは放出を表す。',
      '光の強さ0のところを読むと −2。光が無くても呼吸は続いているので、CO₂を2放出している。これが呼吸の量。',
      '光を強くすると線は上がっていく。光合成で吸う量が増えるから。',
      '線が0の高さを横切るところが光補償点。吸う量と出す量がつり合い、見かけ上は出入りが0になる点。',
      'グラフを読むと、0をまたぐのは光の強さ4のところ。だから(1)の答えは4klx。',
      '光の強さ8をこえると線は水平になり、3のまま増えない。ここが光飽和点で、光以外の条件が上限を決めている。',
      '(2)の真の光合成速度は 見かけ ＋ 呼吸。水平になったところの見かけは3、呼吸は2なので 3 ＋ 2 ＝ 5。',
      'グラフから直接読めるのは「見かけ」だけ。真の値を聞かれたら必ず呼吸の分を足す、が合言葉。',
    ],
    buildSteps: 2,
  },
