...
export const schoolKokoKaseiFill: Question[] = [
  ...
  // ============================================================
  {
    ...
    explanation:
      '【何を聞かれているか】\n傍線部「初めて理解した」について、拓也が理解した内容を字数指定で説明する力が問われている。\n\n【なぜそうなるのか】\n本文最後の一文「多数決とは、単に数を数える作業ではなく、少数の声にどれだけ耳を傾けたかを問う手続きでもある」がそのまま拓也の理解した内容である。\n\n【ステップ1】\n「単に〜ではなく」という対比の形に注目する。\n\n【ステップ2】\n否定される考え（数を数えるだけ）と新たに得た考え（少数派への傾聴）の両方を確認する。\n\n【答え】\n多数決は単に票数を数える作業ではなく、少数派の意見にどれだけ丁寧に耳を傾けたかを問う手続きでもあるということ。\n\n【確かめ】\n字数指定（50字以内）に収まっているかを再確認する。\n\n【よくあるまちがい】\n否定される考えだけ、あるいは肯定される考えだけを書いて片方を落とさないこと。\n\n【ここが絶対】\n「単に〜ではなく」という対比表現を軸に両方の内容を過不足なく盛り込むことを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n傍線部「その提案の意味がわからなかった」について、拓也がこの時点で分かっていなかったことを字数指定で説明する力が問われている。\n\n【なぜそうなるのか】\n「その提案」は直前の先生の発言「多数決の前に、少数派の意見をもう一度聞いてみたらどうだ」を指し、拓也は結論が変わらないのになぜ手間をかけて少数派の話を聞く必要があるのか分かっていなかった。\n\n【ステップ1】\n「その提案」が先生のどの発言を指すかを確認する。\n\n【ステップ2】\n拓也が何を疑問に思っていたかを確認する。\n\n【答え】\n多数決で決める前に、なぜわざわざ少数派の意見を聞き直す必要があるのかという理由。\n\n【確かめ】\n字数指定（40字程度）に収まっているかを再確認する。\n\n【よくあるまちがい】\n「その提案」の内容そのものを説明するだけで、「わからなかった理由」まで書かないこと。\n\n【ここが絶対】\n指示語の内容をまず確認してから、その先の疑問の中身を説明することを押さえる。',
    difficulty: 'standard',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n本文における「先生」の発言が果たした役割として最も適切なものを選ぶ力が問われている。\n\n【なぜそうなるのか】\n先生は演劇案・展示案のどちらかを指示したり多数決の結果を覆すよう命じたりしているわけではなく、「少数派の意見をもう一度聞いてみたら」という提案を通じて拓也自身が気づく機会を作り出している。\n\n【ステップ1】\n先生が結論そのものを指示しているかどうかを確認する。\n\n【ステップ2】\n先生が拓也の「行動」を促している点を確認する。\n\n【答え】\n拓也に少数派の思いに気づかせるきっかけを与える。\n\n【確かめ】\n他の選択肢がいずれも先生が結論を直接指示する内容であることを再確認する。\n\n【よくあるまちがい】\n先生が結論（演劇案の採用など）を指示していると誤読しないこと。\n\n【ここが絶対】\n先生は結論を指示せず、拓也自身の気づきを促していることを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
    choices: [
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n傍線部「反証可能性」とはどのようなことかを字数指定で説明する力が問われている。\n\n【なぜそうなるのか】\n「反証可能性」は、ある仮説が実験や観察によって「誤りである」と示されうる性質のことを指す。\n\n【ステップ1】\n「反証」を「反対の証拠によって誤りだと示すこと」と分解して考える。\n\n【ステップ2】\n「正しいと証明される」ことではなく「誤りだと示されうる」ことがポイントであることを確認する。\n\n【答え】\nある仮説が、実験や観察によって誤りであると示される可能性を持っていること。\n\n【確かめ】\n字数指定（40字以内）に収まっているかを再確認する。\n\n【よくあるまちがい】\n「正しいと証明される可能性」のように逆の意味で説明しないこと。\n\n【ここが絶対】\n反証可能性は「誤りだと示されうる」性質であることを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n本文で述べられている、科学的方法における実験の役割を字数指定で説明する力が問われている。\n\n【なぜそうなるのか】\n本文2文目「重要なのは、実験によって仮説が『正しい』と証明されることではなく、反証される可能性に開かれている点である」が実験の役割についての筆者の主張である。\n\n【ステップ1】\n「重要なのは〜ではなく、〜点である」という対比の構造を確認する。\n\n【ステップ2】\n証明のためではなく反証可能性の検証のために実験が行われるという対比を確認する。\n\n【答え】\n実験は仮説が正しいと証明するためではなく、仮説が誤っている可能性(反証の可能性)を検証するために行われるという役割。\n\n【確かめ】\n字数指定（60字程度）に収まっているかを再確認する。\n\n【よくあるまちがい】\n「実験は仮説の正しさを証明するために行われる」と逆の内容を書かないこと。\n\n【ここが絶対】\n対比の構造をそのまま利用してまとめることを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n本文の内容と合うものを選ぶ力が問われている。\n\n【なぜそうなるのか】\n本文最後の一文「この『反証可能性』を持たない主張は、科学の対象にはなりえない」がそのまま選択肢の内容と一致する。\n\n【ステップ1】\n本文最後の一文を確認する。\n\n【ステップ2】\n他の選択肢が「実験を何度重ねても仮説が確定するわけではない」という本文の主張と矛盾することを確認する。\n\n【答え】\n反証可能性を持たない主張は科学の対象にはならない。\n\n【確かめ】\n他の選択肢がそれぞれ本文と矛盾する内容であることを再確認する。\n\n【よくあるまちがい】\n「実験で何度も支持された仮説は絶対に誤りではないと確定する」のような、本文の主張と反対の内容を選ばないこと。\n\n【ここが絶対】\n本文最後の一文にそのまま書かれている内容を選ぶことを押さえる。',
    difficulty: 'standard',
    course: 'koko-kasei',
    examType: 'koko',
    choices: [
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n「明日は晴れるそうだ。」（A）と「明日は晴れそうだ。」（B）の「そうだ」の文法的意味の違いを、伝聞と様態という語を用いて説明する力が問われている。\n\n【なぜそうなるのか】\nAは終止形に「そうだ」が付いており人から聞いた情報を伝える伝聞、Bは連用形（語幹）に「そうだ」が付いており自分の目で見た様子から判断する様態である。\n\n【ステップ1】\n「そうだ」の直前が終止形（A）か連用形・語幹（B）かを確認する。\n\n【ステップ2】\nそれぞれの意味（伝聞・様態）を対応させる。\n\n【答え】\nAは終止形に「そうだ」が付いており、人から聞いた情報をそのまま伝える伝聞の意味。Bは連用形(語幹)に「そうだ」が付いており、自分の目で見た様子から判断する様態の意味。\n\n【確かめ】\n同じ形の助動詞でも接続の違いによって意味が変わることを再確認する。\n\n【よくあるまちがい】\n接続の違い（終止形か連用形か）を確認せずに感覚だけで判断しないこと。\n\n【ここが絶対】\n「そうだ」の直前の活用形によって伝聞と様態を見分けることを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n「校長先生がおっしゃられました。」の二重敬語の誤りを正しい表現に直す力が問われている。\n\n【なぜそうなるのか】\n「おっしゃる」は「言う」の尊敬語であり、それ自体で敬意を表せるので、さらに尊敬の助動詞「られる」を付けると二重敬語になる。\n\n【ステップ1】\n「おっしゃる」自体がすでに尊敬語であることを確認する。\n\n【ステップ2】\n「られる」を重ねる必要がないことを確認する。\n\n【答え】\n校長先生がおっしゃいました。\n\n【確かめ】\n「おっしゃいました」が正しい形であることを再確認する。\n\n【よくあるまちがい】\nすでに尊敬語である動詞にさらに尊敬の助動詞を重ねる二重敬語のミスに注意する。\n\n【ここが絶対】\n同じ働きの敬語を二重に使わないことを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n四字熟語「一石二鳥」の意味を説明し、同じ意味を持つ四字熟語を1つ挙げる力が問われている。\n\n【なぜそうなるのか】\n「一石二鳥」は、一つの石を投げて二羽の鳥を同時に落とすという比喩から、一つの行動で二つの利益を同時に得ることを表し、同じ意味の四字熟語に「一挙両得」がある。\n\n【ステップ1】\n「一つの石で二羽の鳥を落とす」という直訳のイメージを確認する。\n\n【ステップ2】\n同じ意味を持つ「一挙両得」を挙げる。\n\n【答え】\n一つの行為によって同時に二つの利益を得ること。同じ意味の四字熟語として「一挙両得」がある。\n\n【確かめ】\n「一挙両得」の意味も同じであることを再確認する。\n\n【よくあるまちがい】\n「一石二鳥」の意味を単なる「一度に多くのことを行うこと」のように利益の面を落とさないこと。\n\n【ここが絶対】\n両方から利益を得るという点が重要であることを押さえる。',
    difficulty: 'standard',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n「具体」の対義語を答える力が問われている。\n\n【なぜそうなるのか】\n「具体」は実際の形や実例をともなってはっきり示されることを指し、「抽象」は個々の実例から共通する要素だけを取り出し一般化してとらえることを指す。\n\n【ステップ1】\n「具体」が個別の実例に即した考え方であることを確認する。\n\n【ステップ2】\n反対に実例から離れて一般化した考え方が「抽象」であることを確認する。\n\n【答え】\n抽象\n\n【確かめ】\n両者が対義語の関係にあることを再確認する。\n\n【よくあるまちがい】\n「抽象」を「概念」など別の語と混同しないこと。\n\n【ここが絶対】\n「具体」＝実例をともなう、「抽象」＝一般化する、という対比を押さえる。',
    difficulty: 'standard',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n「風が僕の頬を優しくなでた。」で使われている比喩表現の種類を答える力が問われている。\n\n【なぜそうなるのか】\n「なでる」は本来人（や動物）が行う動作を表す言葉であり、それを「風」という人でないものの動きに用いることで擬人法（活喩）にあたる。\n\n【ステップ1】\n「なでる」が本来人間の動作であることを確認する。\n\n【ステップ2】\n「風」が人間ではないことを確認する。\n\n【答え】\n擬人法(活喩)。人でないもの(風)を、人間の動作(なでる)を用いて表現している。\n\n【確かめ】\n「〜のように」を使っていないため直喩ではないことを再確認する。\n\n【よくあるまちがい】\n直喩・隠喩と混同しないこと。\n\n【ここが絶対】\n人でないものを人間に見立てる技法が擬人法（活喩）であることを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n古文単語「いとほし」の意味を現代語で説明する力が問われている。\n\n【なぜそうなるのか】\n古語「いとほし」は、現代語の「いとおしい（かわいい・愛おしい）」とは意味が異なり、「かわいそうだ・気の毒だ」という同情の気持ちを表す。\n\n【ステップ1】\n現代語の「いとおしい」と意味が異なることを確認する。\n\n【ステップ2】\n同情の気持ちを表す語であることを確認する。\n\n【答え】\nかわいそうだ、気の毒だ、という意味。\n\n【確かめ】\n古今異義語（現代語と形が似ていても意味が違う語）であることを再確認する。\n\n【よくあるまちがい】\n現代語の「いとおしい（かわいい）」の意味で訳さないこと。\n\n【ここが絶対】\n古文単語には現代語と形が似ていても意味が違う古今異義語が多いことを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n傍線部「翻訳とは、単に単語を置き換える作業ではなく」について、筆者の考える翻訳とはどのような営みかを字数指定で説明する力が問われている。\n\n【なぜそうなるのか】\n本文最後の一文の後半「ある文化の中でしか育たなかった感覚を、別の文化の言葉で捉え直そうとする試みなのである」が筆者の考える翻訳の定義である。\n\n【ステップ1】\n本文最後の一文の後半部分を確認する。\n\n【ステップ2】\n「単に単語を置き換える作業ではない」という否定との対比を確認する。\n\n【答え】\nある文化の中でしか育たなかった感覚を、別の文化の言葉で捉え直そうとする試み。\n\n【確かめ】\n字数指定（50字以内）に収まっているかを再確認する。\n\n【よくあるまちがい】\n「単語を置き換える作業」という否定された内容を答えとして書かないこと。\n\n【ここが絶対】\n本文最後の一文に筆者の主張がまとめられていることを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n本文で例に挙げられている「もったいない」という語について、筆者がこの例を挙げた意図を字数指定で説明する力が問われている。\n\n【なぜそうなるのか】\n「もったいない」の例は、直前の一文「ある言語には存在するが、別の言語には対応する単語がない概念は数多い」という一般論を、読者に具体的にイメージさせるために挙げられている。\n\n【ステップ1】\n「もったいない」の前の一文（一般論）を確認する。\n\n【ステップ2】\n具体例が一般論を裏づける役割を果たしていることを確認する。\n\n【答え】\nある言語に固有の概念は、別の言語の一語では置き換えられない場合があることを具体的に示すため。\n\n【確かめ】\n字数指定（40字程度）に収まっているかを再確認する。\n\n【よくあるまちがい】\n「もったいない」という語の意味そのものを説明するだけで、「例を挙げた意図」を答えないこと。\n\n【ここが絶対】\n抽象的な主張を身近で分かりやすい具体例によって裏づける文章構成であることを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n熟語「着席」の構成（主語＋述語／修飾＋被修飾／述語＋目的語など）を説明する力が問われている。\n\n【なぜそうなるのか】\n「着席」は訓読みすると「席に着く」となり、「着（動作・述語）」が「席（目的語）」を受ける構成になっている。\n\n【ステップ1】\n「着」と「席」を訓読みし、「〜に〜する」という文の形に直す。\n\n【ステップ2】\n上の漢字が動作を表し、下の漢字がその対象（目的語）を表すことを確認する。\n\n【答え】\n下の漢字が上の漢字の目的語になっている構成(「席に着く」で、述語+目的語の関係)。\n\n【確かめ】\n「読書（書を読む）」「登山（山に登る）」など同じ構成の熟語を再確認する。\n\n【よくあるまちがい】\n主語＋述語型や修飾＋被修飾型と混同しないこと。\n\n【ここが絶対】\n熟語を訓読みして文の形に直すと構成が分かりやすくなることを押さえる。',
    difficulty: 'standard',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n「効率と丁寧さは両立できるか」というテーマについて、具体例を挙げながら字数指定で自分の意見を述べる力が問われている。\n\n【なぜそうなるのか】\nこれは唯一の正解がない自由記述問題であり、①「効率」と「丁寧さ」という2つの観点の理解②具体例の説得力③論理的なつながり、の3点が評価される。\n\n【ステップ1】\n「効率を優先すると丁寧さが失われる場面」を考える。\n\n【ステップ2】\n「工夫によって両立できた場面」を具体例として挙げる。\n\n【答え】\n(記述式・自由回答。模範解答例)たとえば手紙を書くとき、定型文をそのまま使えば効率的だが、相手への配慮が伝わりにくい。しかし短くても一言自分の言葉を添えれば、時間をかけすぎずに丁寧さを保てる。効率と丁寧さは、工夫次第である程度両立できると考える。\n\n【確かめ】\n模範解答はあくまで一例であり、両立できる・できないのどちらの立場でも論理が一貫していれば正答となり得ることを再確認する。\n\n【よくあるまちがい】\n具体例なしに抽象論だけで終わらせないこと。\n\n【ここが絶対】\n「効率」と「丁寧さ」という2つの観点を正しく理解し、具体例とともに論理的に説明することを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  ...
  // ============================================================
  {
    ...
    explanation:
      '【何を聞かれているか】\n体積120cm³・質量84gの物体を水に浮かべたとき水中に沈んでいる部分の体積を求める力が問われている。\n\n【なぜそうなるのか】\n物体が浮いて静止しているとき重力と浮力がつり合っており、浮力は押しのけた水の重さに等しい。\n\n【ステップ1】\n物体の質量(84g)と同じ重さの水を押しのけていることを確認する。\n\n【ステップ2】\n84÷1=84を計算する。\n\n【答え】\n84cm³\n\n【確かめ】\n物体全体の体積(120cm³)より小さいことも再確認する。\n\n【よくあるまちがい】\n物体全体の体積をそのまま答えにしないこと。\n\n【ここが絶対】\n浮いているときは重力と浮力がつり合うことを押さえる。',
    difficulty: 'standard',
    course: 'koko-kasei',
    examType: 'koko',
  },
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n光補償点における光の強さと、光の強さ10klxのときの真の光合成速度を求める力が問われている。\n\n【なぜそうなるのか】\n光補償点は見かけの光合成速度が0になる光の強さであり、真の光合成速度は見かけの光合成速度に呼吸速度を足して求める。\n\n【ステップ1】\n見かけの光合成速度が0になる光の強さ(4klx)を確認する。\n\n【ステップ2】\n10klxでの見かけの光合成速度(3)に呼吸速度(2)を足す。\n\n【答え】\n(1)4klx (2)5\n\n【確かめ】\n呼吸速度が光の強さによらず一定(2)であることも再確認する。\n\n【よくあるまちがい】\n真の光合成速度を見かけの光合成速度と同じにしないこと。\n\n【ここが絶対】\n真の光合成速度=見かけの光合成速度+呼吸速度であることを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\nAaBb×AaBbの交配で両方とも劣性形質を示す種子の数を求める力が問われている。\n\n【なぜそうなるのか】\n独立の法則が成り立つとき表現型の分離比は9:3:3:1になり、両方劣性の割合は16分の1になる。\n\n【ステップ1】\n分離比(9:3:3:1、合計16)を確認する。\n\n【ステップ2】\n400×1/16=25を計算する。\n\n【答え】\n25粒\n\n【確かめ】\nab(両方劣性)の割合が16分の1であることも再確認する。\n\n【よくあるまちがい】\n1組の対立形質の比(3:1)をそのまま使わないこと。\n\n【ここが絶対】\n2組の対立形質が独立して遺伝することを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n底面積20cm²・高さ15cm・密度0.8g/cm³の円柱を水に浮かべたとき水面から出ている高さを求める力が問われている。\n\n【なぜそうなるのか】\n浮いて静止しているとき押しのけた水の質量が物体の質量と等しくなる。\n\n【ステップ1】\n物体の質量20×15×0.8=240gを計算する。\n\n【ステップ2】\n沈んでいる体積240÷1=240cm³から沈んでいる高さ240÷20=12cmを計算する。\n\n【答え】\n3cm\n\n【確かめ】\n15-12=3で水面から出ている高さを確かめる。\n\n【よくあるまちがい】\n密度をそのまま高さの割合に使わないこと。\n\n【ここが絶対】\n浮力と重力がつり合う条件から沈んでいる部分を求めることを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n初期微動継続時間15秒とx=ktの関係から震源からの距離と、P波が届くまでの時間を求める力が問われている。\n\n【なぜそうなるのか】\nx=ktに数値を代入して距離を求め、距離÷速さでP波の到達時間を求める。\n\n【ステップ1】\nx=6×15=90を計算する。\n\n【ステップ2】\n90÷5=18を計算する。\n\n【答え】\n震源からの距離90km、P波が届くまでの時間18秒\n\n【確かめ】\n比例定数kが震源距離と初期微動継続時間の関係を表すことも再確認する。\n\n【よくあるまちがい】\nP波の速さでkを求めようとしないこと。\n\n【ここが絶対】\n距離÷速さで到達時間を求めることを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n月の公転周期(恒星月)と満ち欠けの周期(朔望月)がずれる理由を地球の公転と関連づけて答える力が問われている。\n\n【なぜそうなるのか】\n地球も太陽のまわりを公転しているため、月が地球を1周しても位置関係を元通りにするにはさらに月が多く回る必要がある。\n\n【ステップ1】\n恒星月(月が地球を1周する時間)を確認する。\n\n【ステップ2】\nその間に地球も動くため位置関係が変わることを確認する。\n\n【答え】\n地球も太陽の周りを公転しているため、月が地球の周りをちょうど1周(恒星月)しても、地球から見た太陽と月の位置関係(満ち欠けの周期)を元通りにするには、地球が公転した分だけ月がさらに少し多く回る必要があるから。\n\n【確かめ】\n朔望月が恒星月より約2.2日長いことも再確認する。\n\n【よくあるまちがい】\n月だけが動いていると考えないこと。\n\n【ここが絶対】\n太陽・地球・月の位置関係が同じ状態に戻るまでの時間が朔望月であることを押さえる。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n体細胞の染色体数が2n=8のときの生殖細胞と受精卵の染色体数を求める力が問われている。\n\n【なぜそうなるのか】\n減数分裂で染色体数が半分になり、受精でもとの数にもどる。\n\n【ステップ1】\n生殖細胞の染色体数8÷2=4を計算する。\n\n【ステップ2】\n受精卵の染色体数4+4=8を計算する。\n\n【答え】\n生殖細胞の染色体数は4本、受精卵の染色体数は8本。\n\n【確かめ】\n受精卵の染色体数がもとの体細胞と同じになることも再確認する。\n\n【よくあるまちがい】\n受精卵の染色体数を生殖細胞と同じにしないこと。\n\n【ここが絶対】\n減数分裂で半分になり受精でもとにもどることを押さえる。',
    difficulty: 'standard',
    course: 'koko-kasei',
    examType: 'koko',
  },
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】小選挙区比例代表並立制のしくみと、この制度が採用されている目的を1つである。\n\n【なぜそうなるのか】小選挙区制と比例代表制はそれぞれ逆向きの長所・短所をもつため、両者を組み合わせることで互いの短所を補い合うことができる。\n\n【ステップ1】小選挙区比例代表並立制は、1人だけを選ぶ小選挙区制と、政党の得票率に応じて議席を配分する比例代表制を組み合わせた選挙制度である。\n\n【ステップ2】小選挙区制は大政党に有利で死票（当選に結びつかない票）が多くなりやすい一方、比例代表制は少数意見も反映されやすいが政権が不安定になりやすいという、互いに逆の性質を持つ短所を補い合うことを目的として導入されている。\n\n【答え】小選挙区制(1つの選挙区から1人を選出)と比例代表制(政党の得票数に応じて議席を配分)を組み合わせた制度。小選挙区制の「大政党に有利で民意を反映しにくい」という短所と、比例代表制の「小政党の意見も反映されやすいが政権が不安定になりやすい」という短所を、互いに補い合うことを目的としている。\n\n【確かめ】「小選挙区＝政権安定・死票多い」「比例代表＝少数意見反映・政権不安定」を確認する。\n\n【よくあるまちがい】小選挙区制と比例代表制の長所・短所を逆に説明しないこと。\n\n【ここが絶対】「小選挙区比例代表並立制」は公民の最頻出事項。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】政府が生活必需品の価格に上限を設ける「価格統制（上限価格規制）」を行った場合、市場でどのような問題が起こりやすいかを需要と供給の関係から説明することである。\n\n【なぜそうなるのか】価格が均衡価格より低いと買いたい量が売りたい量を上回るため、市場では品不足が生じやすくなる。\n\n【ステップ1】市場では通常、価格が上がると需要量は減り供給量は増えることで、需要量と供給量が一致する均衡価格に落ち着く。\n\n【ステップ2】政府が均衡価格より低い上限価格を強制的に設定すると、その価格では買いたい量（需要量）の方が売りたい量（供給量）よりも多くなり、品不足（超過需要）が発生しやすくなる。\n\n【答え】上限価格が本来の均衡価格より低く設定されると、その価格では需要量が供給量を上回るため、品不足(超過需要)が生じやすくなる。\n\n【確かめ】「上限価格＜均衡価格→超過需要（品不足）」を確認する。\n\n【よくあるまちがい】超過需要と超過供給（価格が均衡価格より高い場合）を逆に覚えないこと。\n\n【ここが絶対】「価格統制と超過需要」は公民の最頻出事項。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】ステップ気候の特徴を降水量と植生の観点から説明することと、代表的な農牧業の形態を1つである。\n\n【なぜそうなるのか】砂漠気候よりやや降水量が多いため丈の短い草原は育つが樹木は育たず、この草原を利用した牧畜の形が発達した。\n\n【ステップ1】ステップ気候は、砂漠気候の周辺に分布し、樹木が育つほどの降水量はないが、丈の短い草原（ステップ）は育つ気候である。\n\n【ステップ2】この草原を利用して、家畜（羊・ヤギなど）とともに水や牧草を求めて移動する遊牧が伝統的に営まれてきた。\n\n【答え】年間降水量が少なく樹木は育たないが、丈の短い草原(ステップ)が広がる気候。代表的な農牧業として、家畜とともに水や牧草を求めて移動しながら生活する遊牧が行われる。\n\n【確かめ】「ステップ気候＝樹木は育たないが草原は育つ」を確認する。\n\n【よくあるまちがい】ステップ気候と砂漠気候を混同しないこと。砂漠気候は植生がほとんどない。\n\n【ここが絶対】「ステップ気候と遊牧」は地理の最頻出事項。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】日本の三大工業地帯（京浜・中京・阪神）の製造品出荷額等の内訳を比較したとき、中京工業地帯が機械工業の割合で他の2地帯を大きく上回っている理由を、代表的な企業の立地と関連づけて説明することである。\n\n【なぜそうなるのか】愛知県・三重県に大手自動車メーカーの本拠地や関連工場が集積しているため、この地域の機械工業の出荷額が突出して多くなっている。\n\n【ステップ1】中京工業地帯は愛知県・三重県などに広がり、大手自動車メーカーの本拠地や、部品を作る関連工場が数多く集積している。\n\n【ステップ2】このため、機械工業（特に自動車などの輸送用機械）の出荷額の割合が、京浜工業地帯や阪神工業地帯に比べて非常に高くなっている。\n\n【答え】中京工業地帯には大手自動車メーカーの本拠地・関連工場が集積しており、自動車を中心とする機械工業(輸送用機械)の出荷額が非常に大きいため。\n\n【確かめ】「中京工業地帯＝機械工業（自動車）の割合が三大工業地帯で最大」を確認する。\n\n【よくあるまちがい】京浜工業地帯や阪神工業地帯も機械工業中心だと誤解しないこと。自動車産業が突出して強いのは中京工業地帯である。\n\n【ここが絶対】「中京工業地帯（機械工業の割合）」は地理の最頻出事項。',
    difficulty: 'standard',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】発展途上国に多く見られる「富士山型」の人口ピラミッドの特徴と、この型の国が抱えやすい課題を1つである。\n\n【なぜそうなるのか】出生数が多く若い世代ほど人口が多いため、人口が急激に増加する一方で社会基盤の整備が追いつかなくなる。\n\n【ステップ1】富士山型の人口ピラミッドは、出生数が多く、若い世代ほど人口が多い形をしている。\n\n【ステップ2】多くの発展途上国でみられ、人口が急激に増加する一方で、雇用・教育・食料・医療などの社会基盤の整備が人口の増加スピードに追いつかず、生活水準の向上が難しくなるという課題を抱えやすい。\n\n【答え】富士山型は年少人口(子ども)の割合が高く、高齢者になるほど人口が少なくなる、裾野の広いピラミッド型の形をしている。人口増加が急激で、雇用・教育・食料などの整備が人口増加のスピードに追いつかないという課題を抱えやすい。\n\n【確かめ】「富士山型＝多産多死・裾野が広い」を確認する。\n\n【よくあるまちがい】「富士山型」と「つぼ型」（少子高齢化が進んだ形）を逆に覚えないこと。\n\n【ここが絶対】「富士山型の人口ピラミッド（発展途上国）」は地理の最頻出事項。',
    difficulty: 'standard',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】国際連盟と国際連合の意思決定のしくみを比較したとき、安全保障（平和維持）に関する最も大きな違いを「全会一致」「拒否権」という語を用いて説明することである。\n\n【なぜそうなるのか】国際連盟は全会一致制のため1か国でも反対すれば決議できなかったが、国際連合は多数決を採用しつつ常任理事国に拒否権を認める形に変わった。\n\n【ステップ1】国際連盟は、総会・理事会ともに全会一致を原則としていたため、1か国でも反対すれば決議できず、実効的な対応が難しいという弱点があった。\n\n【ステップ2】国際連合では、安全保障理事会において多数決の仕組みを取り入れつつ、常任理事国（米・英・仏・露・中）には拒否権を認めている。これにより大国の協調は得やすくなったが、逆に常任理事国のうち1か国でも反対すれば重要な決議ができないという課題は残っている。\n\n【答え】国際連盟は総会・理事会ともに全会一致を原則としており、1か国でも反対すると議決できず、迅速な対応が難しかった。一方、国際連合の安全保障理事会は多数決を採用しつつ、常任理事国5か国に拒否権を認めており、大国の意思を反映しやすい一方で、大国が反対すると重要な決議ができない点は今も課題として残っている。\n\n【確かめ】「国際連盟＝全会一致」「国際連合安保理＝多数決＋拒否権」を確認する。\n\n【よくあるまちがい】国際連合が完全に多数決制になったと誤解しないこと。常任理事国には依然として拒否権がある。\n\n【ここが絶対】「国際連盟の全会一致制と国際連合の拒否権」は歴史・公民の最頻出事項。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】日本国憲法の改正手続きが通常の法律の改正よりも厳格な手続きになっている理由を「硬性憲法」という語を用いて説明することである。\n\n【なぜそうなるのか】憲法は国の基本法であり、時の多数派の都合で簡単に変えられると国民の基本的人権や国の基本原則が不安定になるおそれがあるため、厳しい改正手続きが定められている。\n\n【ステップ1】憲法は国の基本的なあり方や国民の権利を定める最高法規であるため、時の政権の都合で簡単に変えられてしまうと、国民の基本的人権や国の基本原則が不安定になってしまう。\n\n【ステップ2】そのため日本国憲法では、通常の法律より厳しい手続き（各議院の総議員の3分の2以上の賛成による発議、国民投票による過半数の賛成）を経なければ改正できない、硬性憲法の仕組みが採られている。\n\n【答え】憲法は国の基本法であり、時の多数派の都合で簡単に変えられてしまうと、国民の基本的人権や国の基本原則が不安定になるおそれがある。そのため日本国憲法は、各議院の総議員の3分の2以上の賛成による発議と、国民投票の過半数の賛成を必要とする、通常の法律より改正が難しい「硬性憲法」となっている。\n\n【確かめ】「憲法改正＝各議院の総議員の3分の2以上の発議＋国民投票の過半数」を確認する。\n\n【よくあるまちがい】憲法改正の発議に必要な賛成を「出席議員の過半数」だと誤解しないこと。「総議員の3分の2以上」である。\n\n【ここが絶対】「硬性憲法（憲法改正手続き）」は公民の最頻出事項。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】東日本大震災（2011年）以降、日本では原子力発電の割合が大きく低下し火力発電への依存度が高まったこの状況が抱える課題を、資源とエネルギー安全保障の観点から説明することである。\n\n【なぜそうなるのか】火力発電の燃料である化石燃料の多くを海外からの輸入に頼っているため、火力発電への依存が高まるほど国際情勢や資源価格の変動の影響を受けやすくなる。\n\n【ステップ1】日本は石油・石炭・天然ガスなどの化石燃料の大部分を海外からの輸入に頼っている。東日本大震災以降、多くの原子力発電所が停止し、火力発電への依存度が大きく高まった。\n\n【ステップ2】化石燃料の輸入先の情勢や国際価格が変動すると、日本のエネルギー供給や電気料金に大きな影響が及ぶため、エネルギーを安定して確保する（エネルギー安全保障を確保する）ことが一層重要な課題となっている。\n\n【答え】火力発電で使われる石油・石炭・天然ガスなどの化石燃料は、その多くを海外からの輸入に頼っているため、火力発電への依存度が高まるほど、国際情勢や資源価格の変動の影響を受けやすくなり、エネルギーを安定して確保すること(エネルギー安全保障)が難しくなるという課題がある。\n\n【確かめ】「火力発電の依存増加→輸入依存の高まり→エネルギー安全保障の課題」の流れを確認する。\n\n【よくあるまちがい】原子力発電の停止と火力発電への依存度上昇を無関係な出来事だと考えないこと。\n\n【ここが絶対】「東日本大震災後のエネルギー構成の変化」は公民の最頻出事項。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】1962年に起きた、アメリカとソ連が核戦争の危機に直面した出来事の名称と、この出来事が冷戦下の国際関係に与えた影響である。\n\n【なぜそうなるのか】ソ連がキューバに核ミサイル基地を建設しようとしたことで米ソ間の緊張が核戦争一歩手前まで高まったが、この経験から両国は対話と軍備管理の必要性を認識するようになった。\n\n【ステップ1】1962年、ソ連がキューバに核ミサイル基地を建設しようとしたことをきっかけに、アメリカとソ連は核戦争の一歩手前まで対立した（キューバ危機）。\n\n【ステップ2】この危機を通じて両国は、偶発的な核戦争を避けるための直接対話の手段（ホットラインの設置）や、軍備管理交渉の必要性を強く認識するようになり、その後の緊張緩和（デタント）へ向かう一つのきっかけとなった。\n\n【答え】キューバ危機。米ソ両国が核戦争の一歩手前まで対立したことで、両国は直接対話(ホットラインの設置など)や軍備管理交渉の必要性を強く認識し、緊張緩和(デタント)に向かう一つのきっかけとなった。\n\n【確かめ】「キューバ危機（1962年）→ホットライン設置→デタントへ」の流れを確認する。\n\n【よくあるまちがい】キューバ危機とベルリンの壁建設（1961年）を混同しないこと。時期も内容も異なる出来事である。\n\n【ここが絶対】「キューバ危機（1962年）」は歴史の最頻出事項。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】亜寒帯（冷帯）気候の特徴を気温と植生の観点から説明することと、この気候帯に広がる針葉樹の純林の名称である。\n\n【なぜそうなるのか】夏と冬の気温差が非常に大きいという厳しい環境の中で、モミやトウヒなどの限られた樹種の針葉樹だけが広範囲に生育できる。\n\n【ステップ1】亜寒帯（冷帯）気候は、夏は比較的短く涼しいものの、冬の寒さが非常に厳しく、一年を通じた気温の変化（年較差）が非常に大きいことが特徴の気候である。\n\n【ステップ2】この気候帯にはシベリアなどを中心に、モミやトウヒなどの針葉樹が広範囲にわたって単一の樹種で広がる森林、タイガがみられる。\n\n【答え】夏は比較的短く涼しいが、冬の寒さが非常に厳しく、気温の年較差が大きい気候。この気候帯には針葉樹の純林であるタイガが広がる。\n\n【確かめ】「亜寒帯（冷帯）＝年較差が大きい、タイガ」を確認する。\n\n【よくあるまちがい】タイガと熱帯雨林を混同しないこと。タイガは単一樹種の針葉樹林である。\n\n【ここが絶対】「亜寒帯（冷帯）気候とタイガ」は地理の最頻出事項。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】第1次産業15%、第3次産業50%のある県の第2次産業の割合を求め、この県の産業構造の特徴を説明することである。\n\n【なぜそうなるのか】第1次・第2次・第3次産業の割合の合計は必ず100%になるため、100からわかっている2つの割合を引けば第2次産業の割合が求められる。\n\n【ステップ1】第1次・第2次・第3次産業の割合の合計は必ず100%になるので、X＝100−15−50＝35%。\n\n【ステップ2】第3次産業（商業・サービス業など）が50%と最も高い一方、第2次産業（製造業・建設業など）も35%とある程度の割合を占めており、都市型の商業・サービス業に加えて製造業もある程度発達した産業構造だと考えられる。\n\n【答え】第2次産業は35%。第3次産業の割合が最も高いものの、第2次産業の割合も比較的高く、農林水産業に加えて製造業もある程度発達した産業構造だと考えられる。\n\n【確かめ】15＋35＋50＝100となることを確認する。\n\n【よくあるまちがい】3つの産業の割合の合計が100%になることを忘れて、第2次産業の割合を別の方法で求めようとしないこと。\n\n【ここが絶対】「産業別人口構成（第1次・第2次・第3次産業）」は地理の最頻出事項。',
    difficulty: 'standard',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】豊臣秀吉が行った太閤検地と刀狩の目的をそれぞれ説明することである。\n\n【なぜそうなるのか】検地で収穫量を統一基準で把握することは年貢徴収の基盤となり、刀狩で武器を没収することは一揆を防ぎ身分を分ける効果をもたらした。\n\n【ステップ1】太閤検地は、ものさしや升の基準を統一したうえで全国の田畑を調査し、収穫量を石高という統一基準で表すことで、年貢を確実かつ公平に徴収できる基盤を整えた。\n\n【ステップ2】刀狩は、農民や寺社などから刀・鉄砲などの武器を没収する政策で、これにより農民が武力で抵抗すること（一揆）を防ぐとともに、武士と農民の身分を明確に区別する兵農分離が進んだ。\n\n【答え】太閤検地は、全国の田畑の面積や収穫量(石高)を統一的な基準で調査し、年貢を確実に徴収する基盤を作ることを目的とした。刀狩は、農民から刀などの武器を取り上げることで、農民の一揆を防ぎ、武士と農民の身分を明確に分ける(兵農分離)ことを目的とした。\n\n【確かめ】「太閤検地＝年貢徴収の基盤」「刀狩＝一揆防止・兵農分離」を確認する。\n\n【よくあるまちがい】太閤検地・刀狩それぞれ単独の説明にとどまり、「兵農分離」という結びつけるキーワードを書き忘れないよう注意する。\n\n【ここが絶対】「太閤検地と刀狩（兵農分離）」は歴史の最頻出事項。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】社会契約説を唱えた思想家のうち、政府が人民との契約に反した場合、人民には政府に抵抗する権利（抵抗権）があると主張した人物の名前とその主著である。\n\n【なぜそうなるのか】政府は人民の自然権を守るために人民との契約によって成立するという考えから、契約に反した場合は人民が抵抗できるという理論が導かれた。\n\n【ステップ1】イギリスの思想家ジョン・ロックは、著書『統治二論（市民政府二論）』の中で、人は生まれながらに生命・自由・財産などの自然権を持っており、政府はそれらの権利を守るために人民との契約（社会契約）によって成立するとした。\n\n【ステップ2】もし政府がこの契約に反して人民の権利を侵害した場合、人民には政府に抵抗する権利（抵抗権・革命権）があると主張し、後のアメリカ独立宣言などにも大きな影響を与えた。\n\n【答え】ジョン・ロック。主著は『統治二論(市民政府二論)』。\n\n【確かめ】「ロック＝自然権・抵抗権、アメリカ独立宣言に影響」を確認する。\n\n【よくあるまちがい】社会契約説の思想家（ホッブズ・ロック・ルソー）を混同しないこと。抵抗権を主張したのはロックである。\n\n【ここが絶対】「ジョン・ロックと抵抗権」は公民の最頻出事項。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】所得が多い人ほど税率が高くなる「累進課税」のしくみについて「公正（公平）」の観点からその意義を説明し、この仕組みが経済活動に与えうる影響（効率とのトレードオフ）を1つである。\n\n【なぜそうなるのか】負担できる能力に応じて税負担を分かち合うことで所得格差をやわらげる一方、税率が高くなりすぎると働く意欲を損なうおそれがある。\n\n【ステップ1】累進課税は、所得が多く負担できる余裕（担税力）がある人ほど、より高い税率を負担するという仕組みで、支払い能力に応じて公平に負担を分かち合う「垂直的公平」の考え方に基づいており、所得の格差を緩和する役割を果たす。\n\n【ステップ2】税率が高くなりすぎると、努力して多く稼いでもその分多くを税金として取られてしまうため、勤労意欲や投資意欲が損なわれ、経済全体の効率性（生産性）が下がってしまうおそれがある。公正（所得の再分配）と効率（経済活動の活発さ）はしばしばトレードオフの関係になる。\n\n【答え】累進課税は、負担できる能力(担税力)に応じて税負担を分かち合うという考え方(垂直的公平)に基づいており、所得格差を緩和する役割を持つ。一方で、税率が高くなりすぎると、多く働いて稼ごうとする意欲(勤労意欲)や投資意欲を損ない、経済全体の効率性を低下させるおそれがあるというトレードオフがある。\n\n【確かめ】「累進課税＝垂直的公平」「効率とのトレードオフ＝勤労意欲の低下」の両方が答えに入っているか確認する。\n\n【よくあるまちがい】累進課税の意義だけを述べて、効率とのトレードオフにふれないこと。\n\n【ここが絶対】「累進課税と垂直的公平」は公民の最頻出事項。',
    difficulty: 'advanced',
    course: 'koko-kasei',
    examType: 'koko',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】サンフランシスコ平和条約・日ソ共同宣言・日中共同声明・日韓基本条約を起こった順（古い順）に並べ替えることである。\n\n【なぜそうなるのか】日本の戦後外交は主権回復からソ連・韓国・中国との国交正常化へと段階的に進んでおり、それぞれの年号を押さえることで順序が決まる。\n\n【ステップ1】サンフランシスコ平和条約（1951年、日本が独立を回復）→日ソ共同宣言（1956年、ソ連との国交回復・日本の国連加盟実現）の順に起きている。\n\n【ステップ2】日韓基本条約（1965年、韓国との国交正常化）→日中共同声明（1972年、中国との国交正常化）の順に続く。\n\n【答え】①→②→④→③(サンフランシスコ平和条約1951年→日ソ共同宣言1956年→日韓基本条約1965年→日中共同声明1972年)\n\n【確かめ】「1951→1956→1965→1972」の年号を確認する。\n\n【よくあるまちがい】日韓基本条約と日中共同声明の順序を逆にしないこと。日韓基本条約（1965年）が先、日中共同声明（1972年）が後である。\n\n【ここが絶対】「サンフランシスコ平和条約・日ソ共同宣言・日韓基本条約・日中共同声明の年代順」は歴史の最頻出事項。',
    difficulty: 'standard',
    course: 'koko-kasei',
    examType: 'koko',
  },
