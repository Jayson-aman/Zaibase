...
export const lessonFigsRikaExt02: Record<string, Figure> = {
  ...
  rext02_038: {
    ...
    steps: [
      "よこじくは「こん虫の種類」、たてじくは「はねの数（枚）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「チョウ」で4（はねの数（枚））。",
      "いちばん小さいのは「ハエ」で2。差は2。",
      "大きい順にならべると チョウ → カブトムシ → ハエ → カ。棒の高さを見比べて確かめる。",
      "ハエ・カ（ハエのなかま）は後ろばねが「平均こん」に変化し、はねは2枚のみ",
    ],
    buildSteps: 4,
  },
  ...
  rext02_041: {
    ...
    steps: [
      "よこじくは「変態のタイプ」、たてじくは「育ち方の段階数」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「完全変態 (卵→幼虫→さなぎ→成虫)」で4（育ち方の段階数）。",
      "いちばん小さいのは「不完全変態 (卵→幼虫→成虫)」で3。差は1。",
      "2本を見比べて、どちらがどれだけ大きいかをつかむ。",
      "完全変態にはさなぎの段階があるため、段階数が1つ多い",
    ],
    buildSteps: 4,
  },
  ...
  rext02_045: {
    ...
    steps: [
      "よこじくは「冬ごしの姿」、たてじくは「代表例の数（このレッスンで扱った種）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「卵」で2（代表例の数（このレッスンで扱った種））。",
      "いちばん小さいのは「幼虫」で1。差は1。",
      "大きい順にならべると 卵 → さなぎ → 幼虫 → 成虫。棒の高さを見比べて確かめる。",
      "冬ごしの姿は種類によって決まっている（例：カマキリ＝卵、カブトムシ＝幼虫）",
    ],
    buildSteps: 4,
  },
  ...
  rext02_047: {
    ...
    steps: [
      "よこじくは「動物」、たてじくは「体温調節（0=変温, 1=恒温）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「ペンギン(鳥類)」で1（体温調節（0=変温, 1=恒温））。",
      "いちばん小さいのは「マグロ(魚類)」で0。差は1。",
      "大きい順にならべると ペンギン(鳥類) → マグロ(魚類) → カエル(両生類)。棒の高さを見比べて確かめる。",
      "魚類は活発に泳いでも変温動物。恒温動物は鳥類とほ乳類のみ",
    ],
    buildSteps: 4,
  },
  ...
  rext02_048: {
    ...
    steps: [
      "よこじくは「カエルの成長段階」、たてじくは「主な呼吸器官の数（えら・肺・皮膚のうち使う数）」を表している。まず何と何を比べた図かをつかむ。",
      "どの棒も同じ高さで、値はすべて2（主な呼吸器官の数（えら・肺・皮膚のうち使う数））。",
      "差がないことがこの図の要点。等しいことを読み取る。",
      "幼生はえらと皮膚、成体は肺と皮膚で呼吸する（呼吸器官の組み合わせが変わる）",
    ],
    buildSteps: 3,
  },
  ...
  rext02_049: {
    ...
    steps: [
      "よこじくは「動物のグループ」、たてじくは「卵に殻がある(1)/ない(0)」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「は虫類」で1（卵に殻がある(1)/ない(0)）。",
      "いちばん小さいのは「魚類」で0。差は1。",
      "大きい順にならべると は虫類 → 鳥類 → 魚類 → 両生類。棒の高さを見比べて確かめる。",
      "卵に殻があるのはは虫類・鳥類のみ。殻があることで陸上に産卵できる",
    ],
    buildSteps: 4,
  },
  ...
  rext02_050: {
    ...
    steps: [
      ...
      "いちばん大きいのは「胎生のほ乳類（多数派）」で、全体のおよそ95%。",
      "内わけは 胎生のほ乳類（多数派） 95%、カモノハシなど卵生のほ乳類（例外） 5%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "ほ乳類のほとんどは胎生だが、カモノハシのように卵生の例外もいる（イメージ図・実際の比率ではない）",
    ],
    buildSteps: 4,
  },
  ...
  rext02_051: {
    ...
    steps: [
      "よこじくは「グループ」、たてじくは「あしの数（本）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「甲殻類」で10（あしの数（本））。",
      "いちばん小さいのは「昆虫類」で6。差は4。",
      "大きい順にならべると 甲殻類 → クモ類 → 昆虫類。棒の高さを見比べて確かめる。",
      "あしの数のちがいで、こん虫・クモ類・甲殻類を見分けられる",
    ],
    buildSteps: 4,
  },
  ...
  rext02_058: {
    ...
    steps: [
      "よこじくは「状態」、たてじくは「呼吸数（回/分）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「運動直後」で32（呼吸数（回/分））。",
      "いちばん小さいのは「安静時」で18。差は14。",
      "2本を見比べて、どちらがどれだけ大きいかをつかむ。",
      "運動をすると筋肉が多くの酸素を必要とするため呼吸数が増える",
    ],
    buildSteps: 4,
  },
  ...
  rext02_059: {
    ...
    steps: [
      "よこじくは「肺のつくり（イメージ）」、たてじくは「表面積の相対的な大きさ」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「肺胞（小さな袋が無数）の場合」で9（表面積の相対的な大きさ）。",
      "いちばん小さいのは「大きな袋が1つの場合」で1。差は8。",
      "2本を見比べて、どちらがどれだけ大きいかをつかむ。",
      "同じ体積でも小さな袋に分けるほど表面積が大きくなる（イメージ図）",
    ],
    buildSteps: 4,
  },
  ...
  rext02_060: {
    ...
    steps: [
      "よこじくは「場所」、たてじくは「酸素の量（イメージ）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「えらに入る前の水」で8（酸素の量（イメージ））。",
      "いちばん小さいのは「えらを通った後の水」で3。差は5。",
      "2本を見比べて、どちらがどれだけ大きいかをつかむ。",
      "水がえらを通る間に、水に溶けていた酸素の多くが血液側に取り込まれる（イメージ図）",
    ],
    buildSteps: 4,
  },
  ...
  rext02_061: {
    ...
    steps: [
      "よこじくは「動物のグループ」、たてじくは「肺を持つ(1)/持たない(0)」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「は虫類・鳥類・ほ乳類」で1（肺を持つ(1)/持たない(0)）。",
      "いちばん小さいのは「魚類」で0。差は1。",
      "大きい順にならべると は虫類・鳥類・ほ乳類 → 魚類 → こん虫。棒の高さを見比べて確かめる。",
      "魚類はえら、こん虫は気門・気管で呼吸し、肺を持たない",
    ],
    buildSteps: 4,
  },
  ...
  rext02_066: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「血しょう」で、全体のおよそ55%。",
      "内わけは 血しょう 55%、赤血球 44%、白血球・血小板 1%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "血液の体積の割合の目安（成人の場合、赤血球はおよそ4〜5割程度を占める）",
    ],
    buildSteps: 4,
  },
  ...
  rext02_067: {
    ...
    steps: [
      "よこじくは「測定・換算」、たてじくは「回数」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「1分間に換算した値」で72（回数）。",
      "いちばん小さいのは「15秒間の測定値」で18。差は54。",
      "2本を見比べて、どちらがどれだけ大きいかをつかむ。",
      "15秒間の回数を1分あたりに直すには×4（60÷15）する",
    ],
    buildSteps: 4,
  },
  ...
  rext02_072: {
    ...
    steps: [
      "よこじくは「生き物」、たてじくは「あしの数（本）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「ダンゴムシ」で14（あしの数（本））。",
      "いちばん小さいのは「バッタ」で6。差は8。",
      "大きい順にならべると ダンゴムシ → カニ → クモ → バッタ。棒の高さを見比べて確かめる。",
      "あしの数のまとめ：昆虫類6本・クモ類8本・甲殻類10本前後（ダンゴムシは14本）",
    ],
    buildSteps: 4,
  },
  ...
  rext02_075: {
    ...
    steps: [
      "よこじくは「状態」、たてじくは「呼吸数（回/分）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「運動後」で30（呼吸数（回/分））。",
      "いちばん小さいのは「安静時」で16。差は14。",
      "2本を見比べて、どちらがどれだけ大きいかをつかむ。",
      "運動によって呼吸数・心拍数がともに増加する（総復習）",
    ],
    buildSteps: 4,
  },
};
