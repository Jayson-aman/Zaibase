...
export const lessonFigsShakaiExt05: Record<string, Figure> = {
  ...
  lf_sh05_151: {
    ...
    steps: [
      ...
      "いちばん大きいのは「ユーラシア」で、全体のおよそ36.9%。",
      "内わけは ユーラシア 36.9%、アフリカ 20.3%、北米 16.5%、南米 12% …。",
  ...
  lf_sh05_152: {
    ...
    steps: [
      ...
      "いちばん大きいのは「太平洋」で16600（面積（万km²））。",
      "いちばん小さいのは「北極海」で1400。差は15200。",
      "大きい順にならべると 太平洋 → 大西洋 → インド洋 → 北極海。棒の高さを見比べて確かめる。",
      "海の面積（万km²）。三大洋は太平洋・大西洋・インド洋の3つで、北極海は入らない。太平洋だけで陸地全体（約1億4900万km²）より広い",
    ],
    buildSteps: 4,
  },
  ...
  lf_sh05_153: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「アジア」で47.6（人口（億人））。",
      "いちばん小さいのは「大洋州」で0.45。差は47.15。",
      "大きい順にならべると アジア → アフリカ → 欧州 → 北米 → 南米 → 大洋州。棒の高さを見比べて確かめる。",
      "六大州の人口（億人・およその値）。欧州＝ヨーロッパ州、北米＝北アメリカ州、南米＝南アメリカ州、大洋州＝オセアニア州。合計およそ80億人で、アジア州だけで約6割",
    ],
    buildSteps: 4,
  },
  ...
  lf_sh05_155: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「乾燥帯」で、全体のおよそ26.3%。",
      "内わけは 乾燥帯 26.3%、冷帯 21.3%、熱帯 19.9%、寒帯 17.1% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "陸地に占める気候帯の割合（％）。いちばん広いのは乾燥帯（約26％）で、熱帯より広い。温帯は約13％しかない",
    ],
    buildSteps: 4,
  ...
  lf_sh05_157: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「東京」で1600（年降水量（mm））。",
      "いちばん小さいのは「カイロ」で25。差は1575。",
      "大きい順にならべると 東京 → ローマ → テヘラン → カイロ。棒の高さを見比べて確かめる。",
      "年降水量の比較（mm）。カイロ（砂漠気候）は約25mmで東京の約64分の1。テヘランはステップ気候で約230mm",
    ],
    buildSteps: 4,
  },
  ...
  lf_sh05_161: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「アメリカ」で20.3（輸出額（兆円））。",
      "いちばん小さいのは「香港」で3.7。差は16.6。",
      "大きい順にならべると アメリカ → 中国 → 韓国 → 台湾 → 香港。棒の高さを見比べて確かめる。",
      "日本の輸出相手（近年・兆円）。アメリカと中国の2つで日本の輸出の約4割を占める",
    ],
    buildSteps: 4,
  },
  ...
  lf_sh05_162: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「その他」で、全体のおよそ50%。",
      "内わけは その他 50%、中国 22%、アメリカ 10%、豪州 9% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "日本の輸入相手国の割合（近年・％）。1位は中国で約2割。豪州＝オーストラリア、UAE＝アラブ首長国連邦、サウジ＝サウジアラビア",
    ],
    buildSteps: 4,
  ...
  lf_sh05_163: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「中国」で14.1（人口（億人））。",
      "いちばん小さいのは「台湾」で0.23。差は13.87。",
      "大きい順にならべると 中国 → 日本 → 韓国 → 北朝鮮 → 台湾。棒の高さを見比べて確かめる。",
      "東アジアのおもな国・地域の人口（億人）。中国が飛びぬけて多く、韓国は約5100万人で日本の半分以下",
    ],
    buildSteps: 4,
  },
  ...
  lf_sh05_164: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「サウジ」で、全体のおよそ40%。",
      "内わけは サウジ 40%、UAE 38%、クウェート 8%、カタール 7% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "日本の原油の輸入先（近年・％）。1位サウジアラビア、2位アラブ首長国連邦（UAE）。上位はすべて中東の国で、中東依存度は9割を超える",
    ],
    buildSteps: 4,
  ...
  lf_sh05_165: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「豪州」で、全体のおよそ56%。",
      "内わけは 豪州 56%、ブラジル 27%、カナダ 7%、南ア 4% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "日本の鉄鉱石の輸入先（近年・％）。豪州（オーストラリア）が約6割、ブラジルが約3割で、この2国だけで8割を超える。南ア＝南アフリカ共和国",
    ],
    buildSteps: 4,
  ...
  lf_sh05_166: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「ブラジル」で317（生産量（万t））。",
      "いちばん小さいのは「エチオピア」で50。差は267。",
      "大きい順にならべると ブラジル → ベトナム → コロンビア → エチオピア。棒の高さを見比べて確かめる。",
      "コーヒー豆の生産量（万t・近年）。ブラジルが世界1位で世界のおよそ3割を占め、2位はベトナム",
    ],
    buildSteps: 4,
  },
  ...
  lf_sh05_167: {
    ...
    steps: [
      "よこじくは「年」、たてじくは「世界人口（億人）」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（1950, 25）、終わりは（2022, 80）。",
      "全体として55だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "線が2本あるので、同じよこじくの値どうしで上下を見比べる。",
      "世界人口の推移（億人）。1950年の約25億人から2022年に80億人を突破し、約70年で3倍以上。2050年には約97億人と予測されている",
    ],
    buildSteps: 4,
  ...
  lf_sh05_168: {
    ...
    steps: [
      ...
      "いちばん小さいのは「パキスタン」で2.4。差は11.9。",
      "大きい順にならべると インド → 中国 → アメリカ → インドネシア → パキスタン。棒の高さを見比べて確かめる。",
      "人口の多い国ベスト5（億人・近年）。2023年にインドが中国を抜いて世界1位になった。上位5か国のうち4か国がアジアの国",
    ],
    buildSteps: 4,
  },
  ...
  lf_sh05_169: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「ロシア」で1710（面積（万km²））。",
      "いちばん小さいのは「日本」で38。差は1672。",
      "大きい順にならべると ロシア → カナダ → アメリカ → 中国 → ブラジル → 日本。棒の高さを見比べて確かめる。",
      "面積の大きい国ベスト5と日本（万km²）。1位ロシアは2位カナダの約1.7倍。日本の約38万km²はロシアの約45分の1",
    ],
    buildSteps: 4,
  },
  ...
  lf_sh05_170: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「バングラ」で1170（人口密度（人/km²））。",
      "いちばん小さいのは「豪州」で3。差は1167。",
      "大きい順にならべると バングラ → 韓国 → 日本 → 中国 → アメリカ → 豪州。棒の高さを見比べて確かめる。",
      "人口密度（人/km²）。バングラ＝バングラデシュ、豪州＝オーストラリア。人口世界2位の中国は約147人/km²で、日本（約330）より低い",
    ],
    buildSteps: 4,
  },
  ...
  lf_sh05_171: {
    ...
    steps: [
      ...
      "印がついているのは 西経120°、本初子午線、東経135°。位置を目もりで確かめる。",
      "経度のものさし。0度の経線（本初子午線）はイギリスのロンドンを通り、そこから東へ180度が東経、西へ180度が西経。日本の標準時子午線は東経135度（兵庫県明石市）",
    ],
    buildSteps: 3,
  },
  ...
  lf_sh05_172: {
    ...
    steps: [
      ...
      "印がついているのは 南回帰線、赤道、北回帰線、北極圏。位置を目もりで確かめる。",
      "緯度のものさし。赤道が0度、北極点が北緯90度、南極点が南緯90度。北回帰線は北緯約23.4度、北極圏は北緯約66.6度。緯度1度はおよそ111km",
    ],
    buildSteps: 3,
  },
  ...
  lf_sh05_173: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から180まで、15きざみで目もりがふってある。",
      "印がついているのは 1時間、6時間、9時間、12時間。位置を目もりで確かめる。",
      "経度差（度）と時差（時間）の関係。360度÷24時間＝15度で1時間。経度差135度なら135÷15＝9時間、経度差180度なら180÷15＝12時間",
    ],
    buildSteps: 3,
  },
  ...
  lf_sh05_174: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-180から180まで、60きざみで目もりがふってある。",
      "印がついているのは ニューヨーク、ロンドン、東京。位置を目もりで確かめる。",
      "3都市の経度。ロンドン0度、東京は東経135度、ニューヨークは西経75度。東京とニューヨークの経度差は135＋75＝210度なので、210÷15＝14時間の時差",
    ],
    buildSteps: 3,
  },
  ...
  lf_sh05_175: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-12から12まで、6きざみで目もりがふってある。",
      "印がついているのは ニューヨーク、ロンドン、東京。位置を目もりで確かめる。",
      "ロンドン（世界標準時）とのずれ（時間）。＋は時刻が進んでいる、−はおくれている。東経側は＋、西経側は−になる。両はしの±12時間のあたりに日付変更線がある",
    ],
    buildSteps: 3,
  ...
  lf_sh05_177: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「中国」で13700（生産量（万t））。",
      "いちばん小さいのは「フランス」で3400。差は10300。",
      "大きい順にならべると 中国 → インド → ロシア → アメリカ → フランス。棒の高さを見比べて確かめる。",
      "小麦の生産量（万t・近年のおよその値）。1位中国・2位インドだが、この2国は人口が多く国内で消費するため輸出は多くない。輸出の中心はロシア・アメリカ・カナダなど",
    ],
    buildSteps: 4,
  },
  ...
  lf_sh05_178: {
    ...
    steps: [
      ...
      "色のついた範囲は 11以上 かつ 23以下。●はその数をふくみ、○はふくまない。",
      "印がついているのは 出発11時、到着23時。位置を目もりで確かめる。",
      "日本時間の目もり（時）。成田を1月1日午前11時に出発し12時間飛ぶと、日本時間では1月1日午後11時に到着。シカゴ（西経90度）との時差は（135＋90）÷15＝15時間なので、23時−15時間＝1月1日午前8時が現地時刻",
    ],
    buildSteps: 4,
  },
  ...
  lf_sh05_179: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「日本」で68（森林の割合（％））。",
      "いちばん小さいのは「豪州」で17。差は51。",
      "大きい順にならべると 日本 → ブラジル → アメリカ → 中国 → 豪州。棒の高さを見比べて確かめる。",
      "国土に占める森林の割合（％）。日本は約68％で世界的にも高い。ただし国土がせまいため森林「面積」ではロシア・ブラジル・カナダなどに遠くおよばない",
    ],
    buildSteps: 4,
  },
  ...
  lf_sh05_180: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から18まで、3きざみで目もりがふってある。",
      "印がついているのは ペキン、ロンドン、ニューヨーク、ロス。位置を目もりで確かめる。",
      "日本より何時間おくれているか（時間）。ペキン（東経120度）1時間、ロンドン（0度）9時間、ニューヨーク（西経75度）14時間、ロス＝ロサンゼルス（西経120度）17時間",
    ],
    buildSteps: 3,
  },
