...
export const lessonFigsKokoShakaiExt04: Record<string, Figure> = {
  ...
  lf_kokoshakaiext04_112: {
    ...
    steps: [
      ...
      "いちばん大きいのは「畜産 65%」で、全体のおよそ65%。",
      "内わけは 畜産 65% 65%、野菜 13% 13%、いも類・工芸農作物 11% 11%、米 4% 4% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "鹿児島県の農業産出額の約3分の2は畜産（豚・肉用牛・ブロイラー）。全国平均の畜産の割合は4割弱で、シラス台地の水はけのよさが畜産中心の農業を生んだ",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokoshakaiext04_116: {
    ...
    steps: [
      ...
      "いちばん大きいのは「高知(南四国)」で2670（年降水量(mm)）。",
      "いちばん小さいのは「高松(瀬戸内)」で1150。差は1520。",
      "大きい順にならべると 高知(南四国) → 鳥取(山陰) → 高松(瀬戸内)。棒の高さを見比べて確かめる。",
      "瀬戸内の高松は、冬の北西季節風を中国山地に、夏の南東季節風を四国山地にさえぎられるため、山陰・南四国より降水量が大幅に少ない",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokoshakaiext04_123: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「機械 37%」で、全体のおよそ37%。",
      "内わけは 機械 37% 37%、金属 21% 21%、化学 17% 17%、食料品 11% 11% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "阪神工業地帯は他の工業地帯にくらべ金属の割合が高く、せんいの割合もわずかに残る。中小工場の多さも特徴",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokoshakaiext04_127: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「中京」で60（製造品出荷額(兆円)）。",
      "いちばん小さいのは「京葉」で13。差は47。",
      "大きい順にならべると 中京 → 阪神 → 瀬戸内 → 京浜 → 京葉。棒の高さを見比べて確かめる。",
      "中京工業地帯は製造品出荷額が全国第1位で、第2位の阪神の2倍近い。自動車を中心とする機械工業が出荷額の半分以上を占める（金額は概数）",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokoshakaiext04_129: {
    ...
    steps: [
      "よこじくは「月」、たてじくは「出荷量(千t)」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（1, 0）、終わりは（12, 0）。",
      "はじめと終わりが同じ値。とちゅうの動きに注目する。",
      "線が2本あるので、同じよこじくの値どうしで上下を見比べる。",
      "暑さに弱いレタスは、夏は平地でつくれない。標高1,000m級の長野の高原が6〜9月を、茨城など平地の産地が春と秋〜冬を担い、産地が交代する（数値は概数）",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokoshakaiext04_132: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「東京都」で119（昼夜間人口比率(%)）。",
      "いちばん小さいのは「埼玉県」で88。差は31。",
      "大きい順にならべると 東京都 → 大阪府 → 神奈川県 → 千葉県 → 埼玉県。棒の高さを見比べて確かめる。",
      "100をこえると通勤・通学で流入する人が多い（東京都・大阪府）。100を下回る埼玉・千葉・神奈川は、東京へ通う人が多い住宅地としての性格が強い",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokoshakaiext04_133: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「化学 40%」で、全体のおよそ40%。",
      "内わけは 化学 40% 40%、金属 21% 21%、食料品 15% 15%、機械 13% 13% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "京葉工業地域は化学が約4割で、全国の工業地域の中でもきわだって高い。市原市の石油化学コンビナートと君津市の製鉄所が中心（数値は概数）",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokoshakaiext04_137: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「新潟」で63（米の収穫量(万t)）。",
      "いちばん小さいのは「宮城」で33。差は30。",
      "大きい順にならべると 新潟 → 北海道 → 秋田 → 山形 → 宮城。棒の高さを見比べて確かめる。",
      "上位5位のうち3県が東北地方。東北6県で全国の米の産出額のおよそ4分の1を占める。北海道は客土と寒さに強い品種の開発で第2位に（数値は概数）",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokoshakaiext04_141: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「北海道」で30（1戸あたりの耕地面積(ha)）。",
      "いちばん小さいのは「都府県」で2.3。差は27.7。",
      "大きい順にならべると 北海道 → 全国平均 → 都府県。棒の高さを見比べて確かめる。",
      "北海道の農家1戸あたりの耕地面積は約30haで、都府県平均（約2.3ha）の10倍以上。開拓期に大きな区画で土地が割り当てられたことが背景にある（数値は概数）",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokoshakaiext04_145: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「10万分の1」で4000（実際の距離(m)）。",
      "いちばん小さいのは「2万5千分の1」で1000。差は3000。",
      "大きい順にならべると 10万分の1 → 5万分の1 → 2万5千分の1。棒の高さを見比べて確かめる。",
      "図上4cm × 縮尺の分母 で実際の距離が求まる。4×25,000＝100,000cm＝1,000m、4×50,000＝200,000cm＝2,000m、4×100,000＝400,000cm＝4,000m",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokoshakaiext04_146: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「5万・計曲線」で100（等高線の間隔(m)）。",
      "いちばん小さいのは「2.5万・主曲線」で10。差は90。",
      "大きい順にならべると 5万・計曲線 → 2.5万・計曲線 → 5万・主曲線 → 2.5万・主曲線。棒の高さを見比べて確かめる。",
      "2万5千分の1は主曲線10m・計曲線50m、5万分の1は主曲線20m・計曲線100m。どちらも計曲線は主曲線5本ごと（10×5＝50、20×5＝100）",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokoshakaiext04_147: {
    ...
    steps: [
      "よこじくは「水平距離(m)」、たてじくは「標高(m)」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（0, 20）、終わりは（1000, 50）。",
      "全体として30だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "かたむきが急なところほど、変わり方が大きい。",
      "2万5千分の1の地形図で図上4cm（＝実際1,000m）の断面。A(20m)から500m進んで頂上150m、B(50m)へ下る。縦軸を強調して描いているので、実際よりも急に見える（垂直誇張）",
    ],
    buildSteps: 4,
  },
};
