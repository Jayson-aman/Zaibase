...
export const lessonFigsShakaiExt03: Record<string, Figure> = {
  ...
  sext03_s077a: {
    ...
    steps: [
      ...
      "中京工業地帯の製造品出荷額の内訳（およその割合）。機械が約7割を占めるのは自動車工業のため",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s078a: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「機械 約49%」で、全体のおよそ49%。",
      "内わけは 機械 約49% 49%、化学 約18% 18%、食料品 約11% 11%、金属 約9% 9% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "京浜工業地帯の内訳（およその割合）。大消費地をかかえるため食料品・印刷の割合が他より高い",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s079a: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「機械 約37%」で、全体のおよそ37%。",
      "内わけは 機械 約37% 37%、金属 約20% 20%、化学 約17% 17%、食料品 約11% 11% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "阪神工業地帯の内訳（およその割合）。四大工業地帯の中で金属の割合がもっとも高いのが特徴",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s080a: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「機械 約46%」で、全体のおよそ46%。",
      "内わけは 機械 約46% 46%、食料品 約17% 17%、金属 約16% 16%、化学 約6% 6% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "北九州工業地帯の内訳（およその割合）。かつての主役だった金属（鉄鋼）より機械の割合が大きくなっている",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s081a: {
    ...
    steps: [
      "よこじくは「工業地帯・工業地域」、たてじくは「出荷額（兆円）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「中京」で59（出荷額（兆円））。",
      "いちばん小さいのは「北九州」で10。差は49。",
      "大きいほうから 中京 → 阪神 → 瀬戸内 → 関東内陸 と続く。上位がどれかをおさえる。",
      "製造品出荷額のおよその比較。1位は中京で、北九州は工業「地域」よりも下位に沈んでいる",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s083a: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「その他 約48%」で、全体のおよそ48%。",
      "内わけは 機械類 約26% 26%、原油 約11% 11%、液化天然ガス 約6% 6%、医薬品 約5% 5% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "日本の輸入額の内訳（およその割合・年により変動）。原油・LNG・石炭など重くてかさばる資源は船で運ぶ",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s084a: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「化学 約41%」で、全体のおよそ41%。",
      "内わけは 化学 約41% 41%、金属 約21% 21%、食料品 約16% 16%、機械 約13% 13% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "京葉工業地域の内訳（およその割合）。日本でめずらしく「化学が機械より多い」のが最大の見分けポイント",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s084b: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「機械 約35%」で、全体のおよそ35%。",
      "内わけは 機械 約35% 35%、化学 約22% 22%、金属 約18% 18%、食料品 約8% 8% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "瀬戸内工業地域の内訳（およその割合）。化学の割合が全国平均より高いのは石油化学コンビナートがあるため",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s086a: {
    ...
    steps: [
      "よこじくは「県」、たてじくは「出荷額（兆円）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「（参考）京浜」で25（出荷額（兆円））。",
      "いちばん小さいのは「群馬」で9。差は16。",
      "大きい順にならべると （参考）京浜 → 埼玉 → 群馬 → 栃木。棒の高さを見比べて確かめる。",
      "関東内陸工業地域は埼玉・群馬・栃木の3県の合計で約29兆円となり、京浜工業地帯を上回る",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s091a: {
    ...
    steps: [
      "よこじくは「都道府県」、たてじくは「出荷額（兆円）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「愛知」で48（出荷額（兆円））。",
      "いちばん小さいのは「千葉」で13。差は35。",
      "大きいほうから 愛知 → 神奈川 → 静岡 → 大阪 と続く。上位がどれかをおさえる。",
      "製造品出荷額は愛知県が全国1位で2位以下を大きく引き離す。その半分以上が自動車などの輸送用機械",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s092a: {
    ...
    steps: [
      "よこじくは「国」、たてじくは「生産台数（万台）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「中国」で3000（生産台数（万台））。",
      "いちばん小さいのは「ドイツ」で410。差は2590。",
      "大きい順にならべると 中国 → アメリカ → 日本 → インド → 韓国 → ドイツ。棒の高さを見比べて確かめる。",
      "自動車生産台数のおよその比較。日本は世界有数だが1位ではなく、中国が圧倒的に多い",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s093a: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「ハイブリッド車 約49%」で、全体のおよそ49%。",
      "内わけは ハイブリッド車 約49% 49%、ガソリン車など 約48% 48%、電気自動車(EV) 約2% 2%、プラグインHV 約1% 1%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "日本国内の新車販売のおよその内訳。ハイブリッド車は多いが、EVの割合はまだ小さい",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s095a: {
    ...
    steps: [
      "よこじくは「国」、たてじくは「粗鋼生産量（百万トン）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「中国」で1019（粗鋼生産量（百万トン））。",
      "いちばん小さいのは「ロシア」で76。差は943。",
      "大きい順にならべると 中国 → インド → 日本 → アメリカ → ロシア。棒の高さを見比べて確かめる。",
      "粗鋼生産量のおよその比較。中国だけで世界のおよそ半分を占め、日本は上位だが差は非常に大きい",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s098a: {
    ...
    steps: [
      "よこじくは「項目」、たてじくは「中小企業の割合（%）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「事業所数」で99（中小企業の割合（%））。",
      "いちばん小さいのは「出荷額」で48。差は51。",
      "大きい順にならべると 事業所数 → 従業者数 → 出荷額。棒の高さを見比べて確かめる。",
      "製造業で中小企業がしめるおよその割合。数はほぼすべてだが、出荷額では約半分にとどまる",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s101a: {
    ...
    steps: [
      "よこじくは「国」、たてじくは「エネルギー自給率（%）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「カナダ」で179（エネルギー自給率（%））。",
      "いちばん小さいのは「日本」で13。差は166。",
      "大きい順にならべると カナダ → アメリカ → イギリス → フランス → ドイツ → 日本。棒の高さを見比べて確かめる。",
      "主な国のエネルギー自給率（およその値）。日本は1割あまりで、先進国の中でもきわめて低い",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s102a: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「サウジアラビア 約40%」で、全体のおよそ40%。",
      "内わけは サウジアラビア 約40% 40%、アラブ首長国連邦 約38% 38%、クウェート 約8% 8%、カタール 約5% 5% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "原油の輸入先（およその割合）。上位はすべて中東の国で、中東への依存度は9割をこえる",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s103a: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「オーストラリア 約42%」で、全体のおよそ42%。",
      "内わけは オーストラリア 約42% 42%、マレーシア 約17% 17%、ロシア 約9% 9%、アメリカ 約8% 8% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "LNGの輸入先（およその割合）。原油とちがい1位はオーストラリアで、輸入先が分散している",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s103b: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「オーストラリア 約65%」で、全体のおよそ65%。",
      "内わけは オーストラリア 約65% 65%、インドネシア 約12% 12%、ロシア 約9% 9%、アメリカ 約6% 6% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "石炭の輸入先（およその割合）。オーストラリアが群をぬいて多い",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s104a: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「オーストラリア 約58%」で、全体のおよそ58%。",
      "内わけは オーストラリア 約58% 58%、ブラジル 約27% 27%、カナダ 約7% 7%、南アフリカ 約3% 3% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "鉄鉱石の輸入先（およその割合）。オーストラリアとブラジルの2か国で8割以上を占める",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s105a: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「火力 約72%」で、全体のおよそ72%。",
      "内わけは 火力 約72% 72%、太陽光 約9% 9%、水力 約8% 8%、原子力 約6% 6% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "日本の発電電力量の内訳（およその割合）。火力が7割をこえ、再生可能エネルギーはまだ2割ほど",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s106a: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「液化天然ガス 約47%」で、全体のおよそ47%。",
      "内わけは 液化天然ガス 約47% 47%、石炭 約43% 43%、石油など 約10% 10%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "火力発電の燃料のおよその内訳。かつて中心だった石油はへり、LNGと石炭が二本柱になっている",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s108a: {
    ...
    steps: [
      "よこじくは「年度」、たてじくは「発電電力量にしめる割合（%）」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（1990, 64）、終わりは（2022, 72）。",
      "全体として8だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "線が4本あるので、同じよこじくの値どうしで上下を見比べる。",
      "発電構成の推移（およその値）。2011年の東日本大震災後に原子力が急減し、火力が急増した",
    ],
    buildSteps: 4,
  },
  ...
  sext03_s109a: {
    ...
    steps: [
      ...
      "内わけは 化学 約41% 41%、金属 約21% 21%、食料品 約16% 16%、機械 約13% 13% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "【資料A】ある工業地域の製造品出荷額の内訳。化学が最大という一点だけで産地を特定できる",
    ],
    buildSteps: 4,
  },
