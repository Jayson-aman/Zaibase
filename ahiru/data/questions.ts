...
export const questions: Question[] = [
  ...
  },
  {
    ...
    explanation: '【解説】\n正方形の2本の対角線は、長さが等しく、直角に交わり、たがいをまん中で2等分する。だから正方形は合同な三角形4つにきっちり分かれる。\n正方形全体の面積は 8 × 8 ＝ 64cm²。\n64 ÷ 4 ＝ 16cm²\n【別の見方】三角形1個は、底辺が正方形の1辺8cm、高さがその半分の4cm。8 × 4 ÷ 2 ＝ 16cm² となって一致する。\n【注意】対角線そのものの長さは、小学校の算数では求められない（中学以降の内容）。ただし「対角線×対角線÷2」で面積を出すことはできる。',
    difficulty: 'basic',
  },
  {
    id: 'sansu_08',
  ...
  },
  {
    ...
    question: '電流の単位は？',
    answer: 'アンペア（A）',
    explanation: '電流の強さを表す単位はアンペア（記号A）。1A＝1000mA。\n電流は導線を流れる電気の量を表し、電流計は回路に直列につないではかる。＋端子を電池の＋側につなぎ、−端子はまず5Aのいちばん大きい端子から使い、針のふれが小さければ500mA・50mAの端子に変える。\n中学受験の計算では、電池1個・豆電球1個に流れる電流を①として、電池の数と抵抗（豆電球何個分か）の比で考える。',
    difficulty: 'basic',
  },
  {
    id: 'rika_13',
  ...
  },
  {
    ...
    answer: '炭素',
    explanation: 'ダイヤモンドは炭素だけからできている。\n同じ炭素でできた黒鉛（えんぴつのしん）とは、炭素の粒のつながり方だけがちがう。\nダイヤモンドは炭素の粒がすき間なくがんじょうに結びついているため、天然の物質でいちばんかたい。\n炭素でできているので、強く熱すると燃えて二酸化炭素になる。',
    difficulty: 'basic',
  },
  {
    id: 'rika_15',
  ...
  },
  {
    ...
    explanation: '塩酸は酸性、水酸化ナトリウム水溶液はアルカリ性。\n混ぜると、酸の性質のもととアルカリの性質のもとが結びついて水ができ、たがいの性質を打ち消し合う。これが中和。\n残った部分が結びついて塩化ナトリウム（食塩）ができる。\n塩酸 ＋ 水酸化ナトリウム → 塩化ナトリウム ＋ 水。\nちょうど中和した液を蒸発させると、食塩の結晶が残る。',
    difficulty: 'standard',
  },
  {
    id: 'rika_24',
    ...
    answer: '9（直列は抵抗の足し算）',
    explanation: '直列つなぎでは電流の通り道が1本しかないので、抵抗はそのまま足し算になる。\n3＋6＝9。\n直列では電流の大きさはどこでも同じで、発熱（明るさ）は抵抗の大きさに比例して分かれる（3：6＝1：2）。\n抵抗をふやすほど全体の抵抗は大きくなり、流れる電流は小さくなる。電池1個なら電流は1÷9＝1/9。',
    difficulty: 'standard',
  },
  {
    id: 'rika_25',
    ...
    explanation: '並列つなぎでは電流の通り道が枝分かれするので、全体の抵抗は1本のときより小さくなる。\n電池1個をつないだとして考える。抵抗3の枝には1÷3＝1/3、抵抗6の枝には1÷6＝1/6の電流が流れる。\n電池から出る電流は 1/3＋1/6＝2/6＋1/6＝3/6＝1/2。\n全体の抵抗＝電池の数÷全体の電流＝1÷1/2＝2。\n答えの2が、いちばん小さい抵抗3よりさらに小さくなっていることを確かめよう（並列の全体の抵抗は、どの枝よりも小さい）。',
    difficulty: 'standard',
  },
  {
    id: 'rika_26',
  ...
  },
  {
    ...
    explanation: '電熱線の発熱は、流れる電流と、電気を押す力（電池の数）のかけ算で決まる。抵抗が決まっていれば押す力＝電流×抵抗なので、発熱は電流×電流×抵抗に比例する。時間にも比例する。\n例えば同じ電熱線で電流を2倍にすると、発熱は2×2＝4倍。水100gを5分あたためて5℃上がる条件なら、20℃上がる。\n電池を2個直列にすると電流が2倍になるので発熱は4倍。「電池2個で2倍」ではないところが最大のポイント。',
    difficulty: 'standard',
  },
  {
    id: 'rika_36',
  ...
  // ── 理科 最難関10問 ──
  {
    ...
    explanation: '光合成は、二酸化炭素＋水 →（光エネルギー）→ 有機物（デンプンなどの養分）＋酸素、と言葉で表せる。\n光を受け取るのは、葉緑体の中にある緑色の色素「葉緑素」で、葉が緑に見えるのはこの色素のため。\n葉緑素は赤や青の光をよく吸収し、緑の光は吸収せずにはね返すので緑色に見える。',
    difficulty: 'advanced',
  },
  {
    id: 'rika_yotsuya_02',
  ...
  },
  {
    ...
    explanation: '直列つなぎなので、全体の抵抗は 3＋6＝9。\n回路全体を流れる電流は 電池の数÷抵抗＝3÷9＝1/3。\n直列では電流はどこでも同じなので、どちらの電熱線にも1/3が流れる。\n発熱は電流×電流×抵抗に比例する。抵抗3：1/3×1/3×3＝1/3、抵抗6：1/3×1/3×6＝2/3。比は1：2で、抵抗の比と同じ。\n1/3＋2/3＝1 で、全体の発熱（1/3×1/3×9＝1）と一致するので、計算が正しいと確かめられる。抵抗が大きいほうが電池の押す力を多く受け取り、発熱も大きい。',
    difficulty: 'advanced',
  },
  {
    id: 'rika_ex_04',
