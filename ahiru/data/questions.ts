...
export const questions: Question[] = [
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】定価の2割引きで売っても、原価の2割増しの利益があるとき、定価は原価の何倍かを求める。\n【なぜその式なのか】原価を1として考えると、定価の2割引きの売値と、原価の2割増しの金額が等しいという式が立てられる。この式を解けば、定価が原価の何倍かがわかる。\n【ステップ1】原価を1とし、定価を□とする。定価の2割引きで売った値段は□×0.8。\n【ステップ2】これが原価の2割増し（1×1.2）と等しいので、□×0.8＝1.2という式が成り立つ。\n【ステップ3】□＝1.2÷0.8＝1.5。定価は原価の1.5倍。\n【答え】1.5倍\n【確かめ】原価100円のとき、定価150円の2割引きは150×0.8=120円で、原価の2割増し(100×1.2=120円)と一致する。\n【よくあるまちがい】「2割引き」と「2割増し」を、もとにする量（定価と原価）を区別せずに、単純に足し引きしてしまう。\n【ここが絶対】売買損益の問題では、「○割引き」は定価をもとにし、「○割増し」は原価をもとにするという、それぞれの「もとにする量」を必ず確認する。',
    difficulty: 'standard',
  },
  {
    id: 'sansu_25',
    ...
    hint: '40 × 3/5 = 24',
    explanation:
      '【何を聞かれているか】男子と女子の比が3:2のクラスで、全員が40人のとき、男子の人数を求める。\n【なぜその式なのか】比の合計が全体の割合を表すので、男子の比の数字が全体の何分のいくつにあたるかがわかれば、実際の人数が計算できる。\n【ステップ1】男子:女子＝3:2なので、クラス全体は3+2＝5の割合にあたる。\n【ステップ2】男子は全体の3/5にあたる。\n【ステップ3】40×3/5＝24人。\n【答え】24人\n【確かめ】女子は40×2/5=16人で、24+16=40人と全体の人数に一致する。\n【よくあるまちがい】男子の割合を、比の合計（5）ではなく比の数字（3）だけで40を割ってしまう。\n【ここが絶対】比の問題で「全体の中の割合」を求めるときは、必ず比の合計を分母にする。',
    difficulty: 'standard',
  },
  {
    id: 'sansu_26',
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】5人から3人を選ぶ組み合わせが何通りあるかを求める。\n【なぜその式なのか】まず順番を区別して選ぶ場合の数を求め、そのあとで選ぶだけ（組み合わせ）には順番の区別がないことを考えて、重なって数えた分を割って消す。\n【ステップ1】5人から3人を順番を区別して選ぶと5×4×3＝60通り。\n【ステップ2】同じ3人でも並べ方が3×2×1＝6通りあり、これらは重複して数えられている。\n【ステップ3】60÷6＝10通り。\n【答え】10通り\n【確かめ】5人をA〜Eとして、実際に組み合わせを書き出すと10組になることが確認できる。\n【よくあるまちがい】順序を区別したままの5×4×3=60通りを、そのまま答えにしてしまう。\n【ここが絶対】組み合わせ（順番を考えない選び方）は「並べる場合の数÷選んだ人数の並び方の数」で、順番の重なりを消して求める。',
    difficulty: 'standard',
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】濃度8%の食塩水200gと濃度12%の食塩水300gを混ぜたときの濃度を求める。\n【なぜその式なのか】混ぜる前にそれぞれの食塩水に溶けている食塩の重さを計算し、全体の食塩の重さを全体の食塩水の重さで割れば、混ぜたあとの濃度が求まる。\n【ステップ1】それぞれの食塩の重さを求める。200×0.08＝16g、300×0.12＝36g。\n【ステップ2】食塩の重さの合計と食塩水全体の重さを求める。食塩は16+36＝52g、食塩水は200+300＝500g。\n【ステップ3】濃度＝食塩の重さ÷食塩水全体の重さなので、52÷500＝0.104、つまり10.4%。\n【答え】10.4%\n【確かめ】8%と12%の単純な平均10%ではなく、量の違い（200gと300g）を考えた重み付きの計算になっていることを確認する。\n【よくあるまちがい】濃度どうしをそのまま平均（8%と12%の平均で10%など）してしまう。\n【ここが絶対】濃度の問題は、必ず「食塩の重さ」を先に計算してから、全体に対する割合を求める。',
    difficulty: 'standard',
  },
  {
    id: 'sansu_30',
    ...
    explanation:
      '【何を聞かれているか】時速72kmが秒速何mにあたるかを求める。\n【なぜその式なのか】時速72kmとは、1時間（3600秒）に72000m進むということ。この道のりを秒数で割れば、1秒あたりに進む距離（秒速）が求まる。\n【ステップ1】時速72kmをmに直す。72km＝72000m。\n【ステップ2】1時間は3600秒であることを確認する。\n【ステップ3】72000÷3600＝20。秒速20m。\n【答え】秒速20m\n【確かめ】時速から秒速へは÷3.6でも計算でき、72÷3.6=20と一致する。\n【よくあるまちがい】1時間を60秒だと勘違いして計算してしまう（正しくは3600秒）。\n【ここが絶対】時速から秒速に直すときは、kmをmに直したうえで、1時間＝3600秒で割る。',
    difficulty: 'standard',
  },
  {
    id: 'sansu_31',
    ...
    explanation:
      '【何を聞かれているか】時速4kmで歩くと10分遅れ、時速6kmで走ると5分早く着くとき、家から学校までの距離を求める。\n【なぜその式なのか】ちょうど間に合う時間をtとして、2つの歩き方それぞれで「道のり＝速さ×時間」の式を立てる。同じ道のりを表す2つの式が等しいことから、tの値を求め、そこから距離を計算する。\n【ステップ1】ちょうど間に合う時間をt時間とする。時速4kmだと10分（1/6時間）よけいにかかるので、距離＝4×(t+1/6)。時速6kmだと5分（1/12時間）早く着くので、距離＝6×(t-1/12)。\n【ステップ2】この2つの式は同じ距離を表すので、4×(t+1/6)＝6×(t-1/12)。展開すると4t+2/3＝6t-1/2。\n【ステップ3】整理すると2/3+1/2＝2t、つまり7/6＝2t、t＝7/12時間。距離＝4×(7/12+2/12)＝4×9/12＝3km。\n【答え】3km\n【確かめ】もう一方の式でも6×(7/12-1/12)=6×6/12=3kmと一致する。\n【よくあるまちがい】「遅れる」「早く着く」の時間の足し引きを逆にしてしまう。\n【ここが絶対】速さがちがう2通りの歩き方で同じ道のりを進む問題は、ちょうど間に合う時間を文字でおいて、2つの式が等しいという関係を利用する。',
    difficulty: 'standard',
  },
  {
    id: 'sansu_32',
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】1辺6cmの正方形の面積と等しい円の半径を求める。\n【なぜその式なのか】正方形の面積を求め、円の面積の公式「半径×半径×円周率」がこれと等しいという式を作れば、半径×半径の値がわかる。あとはその値に近い数を探せば、半径のおよその値が求まる。\n【ステップ1】正方形の面積を求める。6×6＝36cm²。\n【ステップ2】円の面積＝半径×半径×3.14がこれと等しいので、半径×半径＝36÷3.14＝約11.4650。\n【ステップ3】3.38×3.38＝11.4244、3.39×3.39＝11.4921なので、半径は3.38と3.39の間。くわしく計算すると3.3860…なので、小数第2位まで四捨五入して約3.39cm。\n【答え】約3.39cm\n【確かめ】3.39×3.39を計算すると11.4921で、目標の11.4650に近い値になっていることを確認する。\n【よくあるまちがい】半径×半径の値を求めたところで止まってしまい、そこから実際の半径の値まで絞り込まない。\n【ここが絶対】円の面積の公式から「半径×半径」の値を求めたら、近い2つの数を2乗して比べることで、半径のおよその値を絞り込む。',
    difficulty: 'standard',
  },
  {
    id: 'sansu_35',
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】長さ200mの列車が時速90kmで走り、長さ1000mのトンネルを完全に通過するのにかかる時間を求める。\n【なぜその式なのか】「完全に通過する」とは、先頭が入り口に入ってから最後尾が出口を出るまでのことなので、進む距離はトンネルの長さと列車の長さの合計になる。\n【ステップ1】速さを秒速に直す。90×1000÷3600＝25。秒速25m。\n【ステップ2】通過する距離を求める。トンネルの長さ1000mに列車の長さ200mを足して1200m。\n【ステップ3】かかる時間は1200÷25＝48秒。\n【答え】48秒\n【確かめ】列車の先頭がトンネルに入ってから、最後尾がトンネルを出るまでに進む距離が「トンネルの長さ＋列車の長さ」になることをイメージして確認する。\n【よくあるまちがい】トンネルの長さ1000mだけで計算し、列車自身の長さ200mを足し忘れてしまう。\n【ここが絶対】通過算では「進む道のり＝トンネル（橋）の長さ＋列車の長さ」であることを必ず確認する。',
    difficulty: 'standard',
  },
  {
    id: 'sansu_37',
    ...
    explanation:
      '【何を聞かれているか】3%の食塩水200gを煮詰めて5%にするには、何gの水を蒸発させればよいかを求める。\n【なぜその式なのか】水を蒸発させても食塩の重さは変わらない。この一定の食塩の重さが、5%になったときの食塩水全体の重さの何%にあたるかを考えれば、蒸発後の食塩水の重さがわかり、そこからもとの重さとの差で蒸発させた水の量が求まる。\n【ステップ1】もとの食塩の重さを求める。200×0.03＝6g。\n【ステップ2】この6gが5%にあたるような食塩水の重さを求める。6÷0.05＝120g。\n【ステップ3】もとの重さ200gから、蒸発後の重さ120gを引く。200−120＝80g。\n【答え】80g\n【確かめ】120gの食塩水に食塩6gが含まれるとき、6÷120=0.05=5%となり、目標の濃度と一致する。\n【よくあるまちがい】水を蒸発させると食塩の重さまで変わると誤解してしまう（水を蒸発させても食塩そのものの量は変わらない）。\n【ここが絶対】水を蒸発させる問題では「食塩の重さは変わらない」ことを使い、目標の濃度になるために必要な食塩水全体の重さを先に求めてから、もとの重さとの差で蒸発させた水の量を出す。',
    difficulty: 'standard',
  },
  {
    id: 'sansu_38',
  ...
  // --- advanced (10問) ---
  {
    ...
    explanation:
      '【何を聞かれているか】半径10cmの円に内接する正六角形（1辺10cmの正三角形6個に分けられ、正三角形1個の面積が43.3cm²）の面積を求める。\n【なぜその式なのか】円の中心から正六角形の頂点へ線を引くと、合同な正三角形6個に分かれる。正三角形1個の面積がわかっていれば、それを6倍すれば正六角形全体の面積が求まる。\n【ステップ1】円の中心から正六角形の6つの頂点へ線を引くと、三角形が6個できる。中心から頂点までは円の半径なのでどれも10cm。中心のまわりの角は360÷6＝60°、残り2つの角も(180−60)÷2＝60°なので、3辺が10cmの正三角形になる。\n【ステップ2】つまり「円に内接する正六角形の1辺は、円の半径と同じ」という関係がわかる。\n【ステップ3】正三角形1個が43.3cm²なので、正六角形の面積は43.3×6＝259.8cm²。\n【答え】259.8cm²\n【確かめ】円に内接する正六角形の1辺が円の半径と同じ長さになる理由（中心角60°の二等辺三角形が正三角形になる）を確認する。\n【よくあるまちがい】正六角形の1辺の長さを、円の半径ではなく直径だと勘違いしてしまう。\n【ここが絶対】円と正六角形が出てきたら、まず中心から頂点へ線を引く。「半径＝1辺」という関係が見えれば、あとは正三角形6個ぶんの面積を計算するだけになる。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_42',
    ...
    explanation:
      '【何を聞かれているか】1辺6cmの正四面体（展開図は1辺6cmの正三角形4枚）で、正三角形1枚の面積が15.59cm²のとき、正四面体の表面積を求める。\n【なぜその式なのか】正四面体は合同な正三角形4枚で囲まれた立体なので、表面積はこの正三角形4枚分の面積の合計になる。\n【ステップ1】正四面体が合同な正三角形4枚で囲まれていることを確認する。\n【ステップ2】表面積は、正三角形1枚の面積を4倍すれば求まる。\n【ステップ3】15.59×4＝62.36cm²。\n【答え】約62.36cm²\n【確かめ】展開図（正三角形4枚がつながった形）の面積と、立体にしたときの表面積は同じ値になることを確認する。\n【よくあるまちがい】正四面体の体積を求めようとして、表面積の計算とは別の複雑な方法を使おうとしてしまう（表面積は面の枚数を数えるだけで求まる）。\n【ここが絶対】正四面体の表面積は「1つの面の面積×4」で求められる。体積を求めるには中学以上の内容が必要だが、表面積は小学校の範囲で求められる。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_43',
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】等差数列2,5,8,11,…の第100項と、第1項から第100項までの和を求める。\n【なぜその式なのか】この数列は最初の数から一定の数（3）ずつ増えていく等差数列なので、「最初の数＋公差×(番目-1)」の式で何番目の数でも求まる。和は「(最初+最後)×個数÷2」の公式で計算できる。\n【ステップ1】この数列の最初の数は2、公差は3であることを確認する。\n【ステップ2】第n項＝2+(n-1)×3＝3n-1という式に当てはめると、第100項＝3×100-1＝299。\n【ステップ3】和＝(初めの数+終わりの数)×個数÷2＝(2+299)×100÷2＝301×50＝15050。\n【答え】第100項: 299、和: 15050\n【確かめ】小さい例(第1項から第3項まで:2,5,8)の和は15で、公式(2+8)×3÷2=15と一致する。\n【よくあるまちがい】第n項を求める式で、公差をかける回数を「n回」としてしまい、正しくは「n-1回」であることを忘れてしまう。\n【ここが絶対】等差数列のn番目の数は「最初の数＋公差×(n-1)」、和は「(最初+最後)×個数÷2」の公式で求める。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_45',
    ...
    explanation:
      '【何を聞かれているか】Aの管で12分、Bの管で18分かかる水そうに、排水管Cで9分かかる速さで水を出しながら、A・B・Cを同時に動かすと空の水そうが満水になるまで何分かかるかを求める。\n【なぜその式なのか】水そう全体を1として、1分あたりに増える量と減る量を分数で表す。増える量の合計から減る量を引けば、実際に1分あたりどれだけたまるかがわかる。\n【ステップ1】1分あたり、Aは1/12ふやし、Bは1/18ふやし、Cは1/9へらす。\n【ステップ2】分母を36にそろえると、ふえる分は3/36+2/36＝5/36、へる分は4/36。実際に1分間でたまる量は5/36-4/36＝1/36。\n【ステップ3】1分で1/36ずつたまるので、満水になるまでの時間は1÷(1/36)＝36分。\n【答え】36分\n【確かめ】36分間でAは36×1/12=3ぶん、Bは36×1/18=2ぶんためて合計5ぶん、Cは36×1/9=4ぶん出すので、実際にたまるのは5-4=1、つまり満水（1）になることが確認できる。\n【よくあるまちがい】排水管Cの分を「ふえる分」として足してしまい、引き算するのを忘れてしまう。\n【ここが絶対】水を入れる管と出す管が同時にある問題は、入れる分の合計から出す分を引いて、実際にたまる速さを求める。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_46',
    ...
    explanation:
      '【何を聞かれているか】1辺10cmの正方形ABCDの辺BC上にBE:EC=2:3の点Eをとり、AEの延長とDCの延長の交点をFとするとき、三角形DEFの面積を求める。\n【なぜその式なのか】ABとDCが平行なので、三角形ABEと三角形FCEは相似になる。この相似比から辺CFの長さが求まり、三角形DEFの底辺（DF）と高さが計算できる。\n【ステップ1】1辺10cm、BE:EC＝2:3なのでBE＝4cm、EC＝6cm。\n【ステップ2】AB∥DCより、三角形ABEと三角形FCEは相似で、相似比はEB:EC＝4:6＝2:3。よってCF＝AB×3/2＝10×1.5＝15cm。\n【ステップ3】底辺DF＝DC+CF＝10+15＝25cm、高さはEからDCまでの距離10−4＝6cm。三角形DEFの面積＝25×6÷2＝75cm²。\n【答え】75cm²\n【確かめ】座標を使って直接計算しても、D,E,Fの位置から同じ75cm²が得られる。\n【よくあるまちがい】A・E・Fが一直線上にあることに気づかず、「三角形AEF」の面積を求めようとしてしまう（この3点は一直線上にあるので三角形にならない）。\n【ここが絶対】平行な2辺（ABとDC）を利用して相似な三角形を見つけると、延長線の交点までの長さが計算できる。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_47',
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】半径6cmの円と半径4cmの円が外接しているとき、2つの円の中心を結んだ長さと、2つの円の面積の比を求める。\n【なぜその式なのか】2つの円が外側で接するとき、接点は2つの中心を結ぶ直線の上にある。中心から接点までがそれぞれの半径なので、中心間の長さはこの2つの半径をたせば求まる。面積の比は、円周率が共通なので「半径×半径」の比になる。\n【ステップ1】2つの円が外接するとき、接点は2つの中心を結ぶ線の上にあり、中心から接点までがそれぞれの半径になる。中心間の長さは6+4＝10cm。\n【ステップ2】円の面積は半径×半径×円周率で、円周率はどちらも同じなので、面積の比は「半径×半径」の比になる。\n【ステップ3】6×6:4×4＝36:16＝9:4。\n【答え】中心間10cm、面積の比 9:4\n【確かめ】相似な図形（円はすべて相似）では長さの比a:bのとき面積の比はa×a:b×bになることを確認する。\n【よくあるまちがい】面積の比を、半径の比（6:4=3:2）のままにしてしまう。\n【ここが絶対】外接する2つの円の中心間の長さは「半径の和」、面積の比は「半径の比を2回かけたもの」になる。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_49',
  ...
  // ── 算数 最難関10問 ──
  {
    ...
    explanation:
      '【何を聞かれているか】A君（分速70m）とB君（分速90m）が同時に出発し、B君が学校についた3分後にA君が着いたとき、学校までの道のりを求める。\n【なぜその式なのか】速い方（B君）が先に着くので、A君がかかる時間はB君より3分長い。A君の時間を文字でおき、同じ道のりを表す2つの式が等しいという関係から時間を求める。\n【ステップ1】速い方が先に着くので、B君の方が3分短い時間で着く。A君の時間をt分とすると、B君の時間は(t−3)分。\n【ステップ2】同じ道のりを表すので、70×t＝90×(t−3)という式が成り立つ。展開すると70t＝90t−270。\n【ステップ3】整理すると20t＝270、t＝13.5分。道のり＝70×13.5＝945m。\n【答え】945m\n【確かめ】B君の時間は13.5-3=10.5分で、90×10.5=945mと同じ道のりになることを確認する。\n【よくあるまちがい】どちらが先に着くかを確認せずに、3分の差をどちらの時間に足すべきか（または引くべきか）を逆にしてしまう。\n【ここが絶対】速さがちがう2人が同じ道のりを進む問題では、まず「どちらが先に着くか」を見きわめてから、時間の差をどちらの式に反映させるかを決める。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_yotsuya_02',
    ...
    explanation:
      '【何を聞かれているか】1辺12cmの正方形を縦横3等分して9つの小正方形に分け、四隅の4つと中央の1つを切り取ったとき、残った図形の周りの長さを求める。\n【なぜその式なのか】四隅4個と中央1個を切り取ると、残るのは上下左右の4個の小正方形で、これらはたがいに角でふれるだけでバラバラになる。それぞれの小正方形の周りの長さをそのまま合計すればよい。\n【ステップ1】小正方形の1辺は12÷3＝4cm。\n【ステップ2】四すみ4個と中央1個を切り取ると、残るのは上・下・左・右の4個で、たがいに角でふれるだけのバラバラの4枚になる。\n【ステップ3】小正方形1個の周りの長さは4×4＝16cm。これが4枚あるので16×4＝64cm。\n【答え】64cm\n【確かめ】残った4個の小正方形が、辺で隣り合わずに角だけでふれていることを図でイメージして確認する。\n【よくあるまちがい】残った4個の小正方形が辺でつながっていると勘違いして、共有する辺の長さを引いてしまう（実際にはつながっていないので引く必要がない）。\n【ここが絶対】図形を切り取ってできる残りの部分の周りの長さを求めるときは、残った部分がひとつながりなのか、バラバラになっているのかを最初に確認する。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_yotsuya_03',
    ...
    explanation:
      '【何を聞かれているか】濃度8%の食塩水A200gと濃度12%の食塩水B300gを混ぜたあと、水を100g蒸発させたときの濃度を求める。\n【なぜその式なのか】水を蒸発させても食塩の重さは変わらないので、まず混ぜた時点での食塩の重さと食塩水全体の重さを求め、蒸発させた分だけ食塩水全体の重さを減らして濃度を計算し直す。\n【ステップ1】食塩の重さを求める。200×0.08＝16g、300×0.12＝36g、合わせて52g。\n【ステップ2】混ぜた食塩水は200+300＝500g。水を100g蒸発させると500−100＝400g（食塩の量は変わらない）。\n【ステップ3】濃度＝52÷400＝0.13、つまり13%。\n【答え】13%\n【確かめ】400gの食塩水に食塩52gが含まれるとき、52÷400=0.13=13%となり計算と一致する。\n【よくあるまちがい】水を蒸発させると食塩の量まで減ると誤解してしまう（食塩は蒸発しないので量は変わらない）。\n【ここが絶対】食塩水を蒸発させる問題では「食塩の重さは変わらない」ことを利用し、蒸発後の食塩水全体の重さで割り直して濃度を計算する。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_yotsuya_04',
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】周囲の長さが36cmの長方形で、面積が最大になるときの縦と横の長さを求める。\n【なぜその式なのか】まわりの長さが一定のとき、たてとよこの和も一定になる。この和を保ったまま、たてとよこの長さをいろいろ変えて面積を比べると、たてとよこが等しい（正方形になる）ときに面積が最大になる。\n【ステップ1】まわりが36cmなので、たて＋よこ＝36÷2＝18cm。\n【ステップ2】たてをxとするとよこは18−x、面積はx×(18−x)。1×17=17、5×13=65、8×10=80、9×9=81、10×8=80のようにいくつか試して比べる。\n【ステップ3】たてとよこが等しい（9cmと9cm）ときに面積が最大の81cm²になる。\n【答え】縦9cm・横9cm（正方形）、面積81cm²\n【確かめ】8×10=80、10×8=80のように、9cmから離れるほど面積が小さくなっていくことを確認する。\n【よくあるまちがい】たてとよこの長さを大きく離せば離すほど面積が大きくなると勘違いしてしまう（実際には和が一定のとき、等しく分けたときに積が最大になる）。\n【ここが絶対】まわりの長さ（たてとよこの和）が一定のとき、面積が最大になるのはたてとよこが等しい（正方形になる）ときである。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_yotsuya_06',
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】底辺8cm、高さ6cmの三角形ABCで、辺ABの中点M、辺ACの中点Nを結んでできる台形MBCNの面積が、三角形ABCの面積の何分のいくつかを求める。\n【なぜその式なのか】MとNが中点なので、中点連結定理よりMN∥BCで、三角形AMNと三角形ABCは相似になる。相似な図形の面積比は相似比の2乗になるので、そこから台形の面積の割合が求まる。\n【ステップ1】MとNは辺の中点なので、中点連結定理よりMN∥BC、MN＝BC÷2。\n【ステップ2】三角形AMNと三角形ABCは相似で、相似比は1:2。面積比は相似比の2乗なので1×1:2×2＝1:4。つまり三角形AMNは三角形ABCの1/4。\n【ステップ3】台形MBCN＝三角形ABC−三角形AMN＝1−1/4＝3/4。\n【答え】3/4\n【確かめ】三角形ABC全体を1としたとき、三角形AMN(1/4)と台形MBCN(3/4)を足すと1/4+3/4=1になり、全体と一致する。\n【よくあるまちがい】相似比（1:2）をそのまま面積比として使ってしまう。\n【ここが絶対】中点を結んでできる三角形は、もとの三角形と相似比1:2の相似な図形になり、面積比は2乗した1:4になることを覚えておく。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_yotsuya_08',
    ...
    explanation:
      '【何を聞かれているか】Aは6日、Bは12日で終わる仕事を、最初2人で作業し途中からAが休んでBだけで続け、全部で8日かかったとき、Aが働いた日数を求める。\n【なぜその式なのか】Bは8日間ずっと働いたので、その仕事量がまず計算できる。残りの仕事量をAがやったことになるので、Aの1日の仕事量で割れば、Aが働いた日数がわかる。\n【ステップ1】仕事全体を1とすると、1日にできる量はAが1/6、Bが1/12。\n【ステップ2】Bは8日間ずっと働いたので、8×1/12＝2/3の仕事を終わらせた。\n【ステップ3】残りの1−2/3＝1/3をAがやったので、Aが働いた日数は(1/3)÷(1/6)＝2日。\n【答え】2日\n【確かめ】Aの2日分1/6×2=1/3とBの8日分2/3をたすと1/3+2/3=1で、全体の仕事が終わることが確認できる。\n【よくあるまちがい】Aが働いた日数を求めるのに、8日全体の中でAとBが同時に働いた日数を先に決めようとして計算が複雑になってしまう。\n【ここが絶対】「ずっと働いた人」の仕事量を先に確定させ、残りを「途中でやめた人」の仕事量として計算すると見通しがよくなる。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_yotsuya_09',
    ...
    hint: '正六角形は正三角形6個ぶん。',
    explanation:
      '【何を聞かれているか】1辺6cmの正六角形を中心から6つの合同な正三角形に分けたとき、正三角形1個の面積が15.6cm²であれば、正六角形の面積を求める。\n【なぜその式なのか】正六角形は、中心と6つの頂点を結ぶと合同な正三角形6個に分かれる。正三角形1個の面積がわかっていれば、それを6倍すれば正六角形全体の面積が求まる。\n【ステップ1】正六角形の中心から6つの頂点へ線を引くと、合同な三角形が6個できる。中心から頂点までの長さは正六角形の1辺と等しいので、どれも3辺が6cmの正三角形になる。\n【ステップ2】正六角形の面積は、正三角形1個の面積の6倍になる。\n【ステップ3】15.6×6＝93.6cm²。\n【答え】93.6cm²\n【確かめ】正六角形の1つの内角が120°、中心のまわりの角が360÷6=60°であることから、三角形の残り2つの角も(180-60)÷2=60°になり、正三角形になることを確認する。\n【よくあるまちがい】正六角形の中の三角形が、正三角形ではなく別の形になると勘違いしてしまう。\n【ここが絶対】正六角形は「正三角形6個のかたまり」と見るのが基本。面積はこの分け方ですべて片づく。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_yotsuya_10',
    ...
    explanation:
      '【何を聞かれているか】2桁の整数で、十の位と一の位を入れ替えると元の数より27大きくなるような整数をすべて求める。\n【なぜその式なのか】十の位と一の位を文字でおいて、もとの数と入れ替えた数をそれぞれ式で表す。入れ替えた数からもとの数を引いた式を整理すると、十の位と一の位の関係がわかる。\n【ステップ1】十の位をa、一の位をbとすると、もとの数は10a+b、入れ替えた数は10b+a。\n【ステップ2】入れ替えた数からもとの数を引くと、(10b+a)−(10a+b)＝9×(b−a)。これが27に等しいので、b−a＝3。\n【ステップ3】一の位が十の位より3大きい2桁の数を探す。bは9以下なのでaは6まで。14,25,36,47,58,69の6個。\n【答え】14, 25, 36, 47, 58, 69（十の位より一の位が3大きい数）\n【確かめ】25の場合、入れ替えると52で、52-25=27と条件に一致する。\n【よくあるまちがい】十の位aの範囲を決めるときに、一の位b=a+3が9を超えないようにする条件（aは6まで）を確認せずに、a=1〜9のすべてを答えにしてしまう。\n【ここが絶対】桁の入れ替えに関する問題は、十の位・一の位を文字でおいて「10×文字+文字」の形で数を表し、式を整理する。',
    difficulty: 'advanced',
  },
  ...
  // ── 算数 追加10問 ──
  {
    ...
    explanation:
      '【何を聞かれているか】池の周り2400mを、AとBが同じ地点から反対方向に歩き始めたとき、2人が最初に出会うのは何分後かを求める。\n【なぜその式なのか】反対方向に進む2人の間の距離は、1分ごとに2人の速さの和だけ縮まっていく。この「1分あたりに縮まる距離」で池1周分の距離を割れば、出会うまでの時間がわかる。\n【ステップ1】反対方向に進むので、2人の間は1分間に80+40＝120mずつ縮まる。\n【ステップ2】1周分の2400mだけ縮まれば出会う。\n【ステップ3】2400÷120＝20。20分後。\n【答え】20分後（2400÷(80+40)=20分）\n【確かめ】20分間にAは80×20=1600m、Bは40×20=800m進み、合計1600+800=2400mで1周分と一致する。\n【よくあるまちがい】反対方向に進んでいるのに、速さの和ではなく差を使ってしまう。\n【ここが絶対】反対方向に進む2人が出会うまでの時間は「1周分の距離÷2人の速さの和」で求める。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_ex_02',
    ...
    explanation:
      '【何を聞かれているか】100円硬貨と500円硬貨が合わせて20枚あり、合計4400円のとき、500円硬貨の枚数を求める。\n【なぜその式なのか】20枚すべて100円だったと仮定して合計を計算し、実際との差を求める。この差は、100円玉を500円玉に置きかえるたびに増える金額で割り切れるはずなので、置きかえた枚数（500円玉の枚数）がわかる。\n【ステップ1】20枚すべて100円玉だったと仮定した合計金額を求める。100×20＝2000円。\n【ステップ2】実際の金額との差を求める。4400−2000＝2400円。\n【ステップ3】100円玉1枚を500円玉に置きかえるたびに500−100＝400円ずつ増える。2400÷400＝6。500円玉は6枚。\n【答え】6枚\n【確かめ】500円6枚＝3000円、100円14枚＝1400円で合計4400円と一致する。\n【よくあるまちがい】差の2400円を、500円と100円の差（400円）ではなく、500円そのもので割ってしまう。\n【ここが絶対】つるかめ算は「全部一方だったと仮定する→実際との差を求める→1枚あたりの差で割る」という手順で解く。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_ex_03',
    ...
    hint: '最大辺=最大公約数',
    explanation:
      '【何を聞かれているか】縦100m・横150mの長方形の土地を、同じ大きさの正方形で余りなく分割するとき、最大の正方形の1辺の長さと、できる正方形の個数を求める。\n【なぜその式なのか】たてもよこもぴったり分けられる正方形の1辺の長さは、100と150の公約数でなければならない。いちばん大きい正方形にするには、最大公約数を選べばよい。\n【ステップ1】100と150の最大公約数を求める。100＝2²×5²、150＝2×3×5²なので、最大公約数は2×5²＝50。\n【ステップ2】1辺50mの正方形なら、たては100÷50＝2列、よこは150÷50＝3列に分けられる。\n【ステップ3】正方形の個数は2×3＝6個。\n【答え】1辺50m・6個\n【確かめ】50mの正方形6個の面積の合計は50×50×6=15000m²で、もとの土地の面積100×150=15000m²と一致する。\n【よくあるまちがい】100と150の公約数のうち、最大公約数ではない小さい数（例えば25や10）を使ってしまい、「最大」の正方形にならない。\n【ここが絶対】長方形を余りなく同じ大きさの正方形に分けるとき、最大の正方形の1辺は、たてとよこの長さの最大公約数になる。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_ex_04',
    ...
    explanation:
      '【何を聞かれているか】4で割ると3余り、5で割ると4余る最小の正の整数を求める。\n【なぜその式なのか】「4で割ると3余る」は「あと1あれば4の倍数」、「5で割ると4余る」は「あと1あれば5の倍数」と言いかえられる。つまり「その数+1」が4と5の公倍数になるので、最小公倍数を使えば求まる。\n【ステップ1】4で割ると3余る数は、1を足せば4の倍数になる。5で割ると4余る数は、1を足せば5の倍数になる。\n【ステップ2】つまり「その数+1」は4と5の公倍数。最小公倍数は20なので、いちばん小さい場合はその数+1＝20。\n【ステップ3】その数＝20−1＝19。\n【答え】19\n【確かめ】19÷4=4余り3、19÷5=3余り4で、どちらの条件にも一致する。\n【よくあるまちがい】「4で割ると3余る」を、そのまま4の倍数に3を足した数として考え、5の条件との関係を見つけられずに、1つずつ試して時間がかかってしまう。\n【ここが絶対】「割る数からその余りを引いた数だけ足りない」という形の余りの条件は、「その数に何かを足すと割り切れる」という形に言いかえると、最小公倍数が使える。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_ex_05',
    ...
    hint: '5-12-13はピタゴラス数',
    explanation:
      '【何を聞かれているか】斜辺13cm、1辺5cmの直角三角形の残りの辺の長さと面積を求める。\n【なぜその式なのか】三平方の定理（直角をはさむ2辺の2乗の和が斜辺の2乗に等しい）を使えば、残りの辺の長さが求まる。面積は、直角をはさむ2辺をそのまま底辺と高さとして使える。\n【ステップ1】三平方の定理a²+b²＝c²（cは斜辺）を使う。13×13−5×5＝169−25＝144。\n【ステップ2】144＝12×12なので、残りの辺は12cm。\n【ステップ3】直角をはさむ2辺が5cmと12cmなので、面積＝5×12÷2＝30cm²。\n【答え】残辺12cm（13²-5²=144=12²）・面積30cm²（5×12÷2）\n【確かめ】5²+12²=25+144=169=13²で、三平方の定理の関係が成り立っていることを確認する。\n【よくあるまちがい】面積を求めるときに、斜辺（13cm）を底辺として使おうとして、別に高さを求める必要が出てきてしまう。\n【ここが絶対】3:4:5や5:12:13のような、辺がすべて整数になる直角三角形の組み合わせを覚えておくと、計算せずに残りの辺がわかる。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_ex_06',
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】面積93.6cm²の正六角形を中心から6つの合同な正三角形に分けたとき、正三角形1個の面積を求める。\n【なぜその式なのか】正六角形は6個の合同な正三角形に分けられるので、全体の面積を6等分すれば、正三角形1個の面積が求まる。\n【ステップ1】正六角形が中心から6つの頂点へ線を引くと、合同な正三角形6個に分けられることを確認する。\n【ステップ2】正六角形全体の面積を6で割れば、正三角形1個の面積が求まる。\n【ステップ3】93.6÷6＝15.6cm²。\n【答え】15.6cm²\n【確かめ】15.6×6=93.6cm²で、もとの正六角形の面積と一致する。\n【よくあるまちがい】全体の面積を6等分せずに、別の分け方（4等分や3等分など）で計算しようとしてしまう。\n【ここが絶対】正六角形の問題は「正三角形6個ぶん」と置きかえると、かけ算とわり算だけで行き来できる。面積から1個ぶんを出すときは6でわり、1個ぶんから全体を出すときは6をかける。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_ex_08',
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】食塩水A（8%・200g）とB（12%・300g）を混ぜ、水を100g蒸発させたときの濃度を求める。\n【なぜその式なのか】水を蒸発させても食塩の重さは変わらないので、まず混ぜた時点での食塩の重さを求め、蒸発させた分だけ食塩水全体の重さを減らして濃度を計算し直す。\n【ステップ1】食塩の重さを求める。200×0.08＝16g、300×0.12＝36g、合わせて52g。\n【ステップ2】混ぜた食塩水は200+300＝500g。水を100g蒸発させると500−100＝400g（食塩の量は変わらない）。\n【ステップ3】濃度＝52÷400＝0.13、つまり13%。\n【答え】13%（食塩52g÷水400g=0.13）\n【確かめ】400gの食塩水に食塩52gが含まれるとき、52÷400=0.13=13%となり計算と一致する。\n【よくあるまちがい】水を蒸発させると食塩の量まで減ると誤解してしまう（食塩は蒸発しないので量は変わらない）。\n【ここが絶対】食塩水を蒸発させる問題では「食塩の重さは変わらない」ことを利用し、蒸発後の食塩水全体の重さで割り直して濃度を計算する。',
    difficulty: 'advanced',
  },
  {
    id: 'sansu_ex_10',
