...
export const figuresGradeJ1Sansu: Record<string, Figure> = {
  ...
  grade_j1_sansu_26: {
    ...
    steps: [
      '反比例の式 y = a/x に、x = 3、y = 8を代入する',
      '8 = a÷3 という式になる',
      '両辺に3をかける: a = 8×3',
      'a = 24',
      '比例定数が24なので、式は y = 24/x',
    ],
  },
  ...
  grade_j1_sansu_32: {
    ...
    steps: [
      '交点では2つの式のy座標が等しくなる',
      'y = 3x と y = 48/x を等号でつなぐ: 3x = 48/x',
      '両辺にxをかける: 3x² = 48',
      '両辺を3でわる: x² = 16',
      'x² = 16を満たすxは x = 4 または x = －4',
      'x＞0の範囲なので x = 4',
      'y = 3x にx = 4を代入する: y = 3×4',
      'y = 12なので、交点は(4, 12)',
    ],
  },
  ...
  grade_j1_sansu_35: {
    ...
    steps: [
      '弧の長さの式 弧の長さ = 2×π×半径×(中心角/360) を使う',
      '半径4cm、弧の長さ2πcmを代入する: 2π = 2×π×4×(中心角/360)',
      '右辺を計算する: 2π = 8π×(中心角/360)',
      '両辺を8πでわる: 中心角/360 = 1/4',
      '両辺に360をかける: 中心角 = 360×1/4',
      '中心角 = 90°',
    ],
  },
  ...
  grade_j1_sansu_36: {
    ...
    steps: [
      '原点中心の反時計回り90°回転では、点(x, y)は(－y, x)に移る',
      '点A(3, 0)なので x = 3、y = 0',
      '規則にあてはめる: (－y, x) = (－0, 3)',
      '－0 = 0なので、移った点は(0, 3)',
    ],
  ...
  grade_j1_sansu_38: {
    ...
    steps: [
      'まず平行移動を考える。x軸方向に4、y軸方向に－2移動する',
      'x座標に4を加える: －1＋4 = 3',
      'y座標に－2を加える: 3＋（－2） = 1',
      '平行移動後の点は(3, 1)',
      '次に、この点をx軸について対称移動する。x座標はそのまま、y座標の符号を変える',
      '(3, 1) → (3, －1)',
    ],
  },
  ...
  grade_j1_sansu_41: {
    ...
    steps: [
      '円柱の表面積 = 側面積 + 底面積×2 という式を使う',
      '側面積 = 底面の円周×高さ で求める',
      '底面の円周 = 2×π×2 = 4π cm',
      '側面積 = 4π×7 = 28π cm²',
      '底面積(1つ分) = π×2² = 4π cm²',
      '底面は2つ分あるので: 4π×2 = 8π cm²',
      '表面積 = 28π + 8π',
      '表面積 = 36π cm²',
    ],
  },
  ...
  grade_j1_sansu_42: {
    ...
    steps: [
      '円すいの体積 = (1/3)×底面積×高さ という式を使う',
      '底面積 = π×6² = 36π cm²',
      '式に底面積36π、高さ9を代入する: 体積 = (1/3)×36π×9',
      '(1/3)×36π = 12π と計算する',
      '体積 = 12π×9 = 108π cm³',
    ],
  },
  ...
  grade_j1_sansu_44: {
    ...
    steps: [
      '円すいの表面積 = 底面積 + 側面積 という式を使う',
      '底面積 = π×5² = 25π cm²',
      '側面積 = π×半径×母線 で求める',
      '半径5cm、母線13cmを代入する: 側面積 = π×5×13',
      '側面積 = 65π cm²',
      '表面積 = 25π + 65π',
      '表面積 = 90π cm²',
    ],
  ...
  grade_j1_sansu_45: {
    ...
    caption: '5人のテストの得点',
    steps: [
      '平均値 = データの合計÷個数 という式を使う',
      '5人の得点を合計する: 60+75+80+65+70',
      '合計 = 350点',
      '合計を人数5でわる: 350÷5',
      '平均 = 70点',
    ],
  ...
  grade_j1_sansu_47: {
    ...
    steps: [
      '相対度数 = その階級の度数÷度数の合計 という式を使う',
      '度数の合計を求める: 6+14+12+8',
      '度数の合計 = 40人',
      '10〜20分の階級の度数は14人。14÷40を計算する',
      '相対度数 = 0.35',
    ],
  },
  ...
  grade_j1_sansu_48: {
    ...
    steps: [
      '各階級の階級値(まん中の値)を求める: 25, 35, 45, 55回',
      '階級値×度数を階級ごとに計算する',
      '25×4 = 100、35×9 = 315',
      '45×8 = 360、55×4 = 220',
      'これらを合計する: 100+315+360+220 = 995',
      '度数の合計を求める: 4+9+8+4 = 25人',
      '平均 = 995÷25',
      '平均 = 39.8回',
    ],
  },
  ...
  grade_j1_sansu_49: {
    ...
    caption: '生徒50人の握力の分布',
    steps: [
      '30kg以上の階級は「30〜40kg」と「40〜50kg」の2つ',
      'この2つの階級の人数を合計する: 20+10',
      '30kg以上の人数 = 30人',
      '全体の人数を求める: 6+14+20+10 = 50人',
      '割合 = 30÷50 を計算する',
      '割合 = 0.6',
      '百分率に直す: 0.6 = 60%',
    ],
  ...
  grade_j1_sansu_50: {
    ...
    steps: [
      '四分位範囲 = 第3四分位数(Q3) － 第1四分位数(Q1) という式を使う',
      '箱ひげ図からQ3 = 46、Q1 = 34を読み取る',
      '46 － 34 を計算する',
      '四分位範囲 = 12回',
    ],
  },
