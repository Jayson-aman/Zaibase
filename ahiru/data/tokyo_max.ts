...
export const tokyoChugakuMaxQuestions: Question[] = [
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】竹取物語の一節について、問1〜問3の小問（「なよ竹」の意味・「うけきらはず」の現代語訳・「しがな」が表す気持ちと文全体の訳）に答えることである。\n\n【なぜそうなるのか】「なよ竹」はしなやかで細い竹をかぐや姫の美しさにたとえた表現であり、「うけきらはず」は「受け嫌わず」と漢字にすると意味が見え、「てしがな」は古文特有の強い願望を表す終助詞である。\n\n【ステップ1】問1について、なよ竹は「しなやかで弱々しい竹」を指し、かぐや姫の細く繊細な美しさを比喩している。問2について、「うけきらはず」＝「受け嫌わず」であり、男性を分け隔てなく呼び集めたという意味になる。\n\n【ステップ2】問3について、「てしがな」は「〜たいものだ」という強い願望の終助詞であり、「いかで」は「どうにかして・なんとかして」の副詞である。全体で「なんとかしてかぐや姫を手に入れたい、会って見たいものだ」という意味になる。\n\n【答え】問1. しなやかで細い柔らかな竹（のような）\n問2. 分け隔てなく（えり好みをせずに）\n問3. 「しがな」は願望を表す助詞（〜したいものだ）。訳：「なんとかしてこのかぐや姫を妻にしたいものだ、会って見たいものだ」\n\n【確かめ】問2の答えが「うけきらはず」を漢字化した「受け嫌わず」の意味と一致しているかを確認する。\n\n【よくあるまちがい】「てしがな」を単なる過去の助動詞だと誤解すること。実際は願望を表す終助詞である。\n\n【ここが絶対】「竹取物語（なよ竹・てしがな）」は古典の最頻出事項。',
  },
  {
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】金子みすゞ「星とたんぽぽ」について、問1〜問3の小問（「星みえぬ星」の意味・第1連と第2連の対比構造・最終連から読み取れる作者の伝えたいこと）に答えることである。\n\n【なぜそうなるのか】「見えない＝存在しない」ではないという考え方が詩全体を貫いており、空の星と地中の根という2つの「見えないもの」が対比されることで、目に見えない存在の強さというテーマが浮かび上がる。\n\n【ステップ1】問1について、昼は太陽の光で見えなくなるが、空の深いところで輝き続けている星のことであり、「見えない＝存在しない」ではないことを表している。問2について、第1連は空・星（昼に見えない）、第2連は土・根（人に見えない）が対比されており、どちらも「目に見えない」ものを詩っている。\n\n【ステップ2】問3について、人に知られず目立たない存在でも、見えないところで力強く生きており、そのような「さみしさ」の中にこそ真の強さがあると作者は伝えている。\n\n【答え】問1. 昼間は見えないが空の奥深くに存在している星のこと。\n問2. 昼間見えない星（空）と、地中の見えない根（土）が対比されている。\n問3. 人の目には見えない存在でも、静かに生き続ける力を持っており、そのような者こそが真に強いということ。\n\n【確かめ】問2の答えに「空・星」と「土・根」という2つの対比する要素が入っているかを確認する。\n\n【よくあるまちがい】問1を単に「見えない星」とだけ答え、「昼間は見えないが確かに存在している」という核心を書き落とすこと。\n\n【ここが絶対】「金子みすゞ『星とたんぽぽ』（見えないものの強さ）」は詩の鑑賞の最頻出事項。',
  },
  {
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】言葉と体温についての随筆文で、問1〜問3の小問（「言葉の体温」の意味・筆者のSNS・メッセージアプリへの見方・自分の考え）に答えることである。\n\n【なぜそうなるのか】「言葉の体温」は話す人の感情や気持ちが言葉に乗り移ったものを表しており、筆者はSNSなどの文字コミュニケーションを便利さと体温の喪失という両面から捉えている。\n\n【ステップ1】問1について、本文中の「話す人の体温」「受け取る側の心の動き」から、言葉に込められた人の感情・温かみを指すとまとめる。問2について、「便利な反面、体温が失われやすい」という筆者の見方を両面から捉える。\n\n【ステップ2】問3について、自分の立場（補える・補えない）を明確にし、理由を具体的に書く。模範解答は一例であり、論理の一貫性が重要である。\n\n【答え】問1. 話す人の感情や気持ちが言葉に乗り移ったもので、受け手の心を動かす力のこと。\n問2. 便利ではあるが、言葉を文字のみで伝えるため言葉の体温が失われやすいと考えている。\n問3. （例）完全には補えないと思う。絵文字は感情を示せても、声のトーンや視線など、対面でしか伝わらないものがあるから。\n\n【確かめ】問2の答えに「便利」と「体温が失われやすい」という両面の内容が入っているかを確認する。\n\n【よくあるまちがい】問2で「便利だ」または「体温が失われる」のどちらか一方だけを書き、筆者の両面的な見方を示さないこと。\n\n【ここが絶対】「筆者の見方は両面（長所と短所）から捉える」ことは随筆文読解の最頻出事項。',
  },
  {
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】AIと人間の関係についての説明文で、問1〜問3の小問（AIの得意なこと・「補完的」の意味・筆者の主張のまとめ）に答えることである。\n\n【なぜそうなるのか】筆者の主張（結論）は最後の文にまとめられることが多く、「補完」は不足しているものを補い合うという対立の反義語として使われている。\n\n【ステップ1】問1について、第2文「決められたルールの中での最適解を求めること」が筆者の言うAIの得意分野であり、これを20字以内に圧縮する。問2について、補完とは不足しているものを補い合うことであり、対立の反義語として使われている。\n\n【ステップ2】問3について、筆者の主張の核心は「対立ではなく補完・役割分担」であり、AIは最適化、人間は創造・本質的問いに集中するという構図をまとめる。\n\n【答え】問1. 決められたルール内で最適解を求めること。\n問2. お互いの不足を補い合うこと（互いに補い合う関係）。\n問3. AIと人間の関係は対立ではなく、AIが得意な最適化を人間が活用しながら、人間は創造や本質的思考に集中するという役割分担が望ましい。\n\n【確かめ】問3の答えに「対立ではなく補完」という筆者の主張の核心が入っているかを確認する。\n\n【よくあるまちがい】問1で「AIは人間の仕事を奪う」という冒頭の一般論を答えとして書いてしまうこと。実際に問われているのは筆者が定義する「AIの得意なこと」である。\n\n【ここが絶対】「筆者の主張は最後の文にまとめられることが多い」ことは説明文読解の最頻出事項。',
  },
  {
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】与謝野晶子の短歌と松尾芭蕉の俳句について、問1〜問3の小問（「道を説く君」への気持ち・俳句の季語と情景・短歌と俳句の音節数の違い）に答えることである。\n\n【なぜそうなるのか】与謝野晶子の短歌は禁欲的な道徳家への批判と哀れみを込めており、芭蕉の俳句は動と静の対比によって静けさを際立たせ、短歌と俳句はそれぞれ音節数の違いによって表現できる内容が異なる。\n\n【ステップ1】問1について、「道を説く君」とは禁欲的・道徳的な男性を指し、晶子は「肌の温かさに触れてみることもせず、さびしくないのか」と問いかけ、情熱を知らない相手を哀れむ・批判する強い感情が込められている。問2について、季語「蛙」は春であり、音が一瞬響いた後の静寂が主題で、動と静の対比で「もの寂しさ・深い静けさ」を表現している。\n\n【ステップ2】問3について、短歌（31音）は時間をかけて感情を展開でき、俳句（17音）は一瞬の情景を凝縮して表現するという特徴の違いをまとめる。\n\n【答え】問1. 女性（恋愛・情熱）を語ろうとしない男性（道徳家）に向けられており、情熱を持てないことへの批判と哀れみが込められている。\n問2. 季語：蛙（春）。静寂な古池に蛙が飛び込む音だけが響き、かえってその静けさと孤独を際立たせている句。\n問3. 短歌は5・7・5・7・7の31音節で感情を叙述し、俳句は5・7・5の17音節で瞬間の情景を切り取る。\n\n【確かめ】問3の答えに短歌（31音）と俳句（17音）それぞれの音節数と特徴が入っているかを確認する。\n\n【よくあるまちがい】問2で季語を「古池」だと誤解すること。季語は「蛙」であり、古池は場所を示す語である。\n\n【ここが絶対】「短歌と俳句の音節数の違い（31音と17音）」は古典・韻文の最頻出事項。',
  },
  {
