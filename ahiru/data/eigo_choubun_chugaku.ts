...
The turtle did not stop. It walked slowly, step by step, and finally passed the sleeping rabbit. When the rabbit woke up, the turtle was already at the goal. The slow turtle won the race.`,
    ...
    explanation:
      '【何を聞かれているか】\n物語（ウサギとカメ）全体から、作者が伝えたい教訓を選ぶ問題。\n\n【なぜ結末の理由から教訓を考えるのか】\n物語の教訓は、登場人物の行動とその結果（なぜ勝ち負けが決まったか）から読み取るものなので、一場面だけでなく全体の流れを見る必要がある。\n\n【ポイント1】ウサギの行動を確認する\n足の速いウサギは油断して昼寝をしてしまった。\n\n【ポイント2】カメの行動を確認する\n足のおそいカメは"did not stop"（止まらず）"step by step"（一歩一歩）進み続けて勝った。\n\n【ポイント3】他の選択肢を消去する\n「1」は結果と反対、「3」「4」は物語の一部の場面にすぎず、「4」はむしろウサギが負けた原因（休みすぎ）で伝えたいこととは逆。\n\n【答え】\nあきらめずにこつこつ続けることが大切だ。\n\n【確かめ】\n選んだ教訓が、カメの行動（あきらめず一歩一歩進む）と結びついているか確認する。\n\n【よくあるまちがい】\n物語の一場面（休むこと・速さ）だけを見て教訓を選んでしまうミス。\n\n【ここが絶対】\n教訓を問う物語は「勝った側の行動」と「負けた側の失敗」を対比して主旨をつかむ。',
...
Friday is my favorite day. I don't have any lessons, so I watch movies at home with my family. On weekends, I often go shopping with my mother or play tennis with my father.`,
    ...
    explanation:
      '【何を聞かれているか】\nソフィーの曜日ごとの予定についての英文を読み、英語を勉強する曜日を答える問題。\n\n【なぜ曜日と活動を対応させて読むのか】\n本文には複数の曜日と活動が並んでいるため、それぞれを対応づけて整理しないと、必要な情報だけを正確に取り出せない。\n\n【ポイント1】該当の一文を確認する\n"On Thursday, I study English with a teacher from Canada."（木曜日にカナダ出身の先生と英語を勉強する）。\n\n【ポイント2】他の曜日と区別する\n月・水はピアノ、火曜は水泳、金曜は映画というように、曜日ごとに予定が異なる。\n\n【ポイント3】質問がstudy Englishの曜日を問うていることを確認する\n"On which day does Sophie study English?"に対応する曜日はThursdayのみ。\n\n【答え】\nOn Thursday.\n\n【確かめ】\n選んだ曜日が、他の活動（ピアノ・水泳・映画）の曜日と混同していないか確認する。\n\n【よくあるまちがい】\n曜日と活動の対応を取りちがえ、別の曜日を選んでしまうミス。\n\n【ここが絶対】\n複数の予定が並ぶ英文は、曜日→活動の対応表を頭の中で作りながら読む。',
...
Ken: Sure! I'll bring it to school on Monday.`,
    ...
    explanation:
      '【何を聞かれているか】\nリサとケンの対話文を読み、内容と合う文を選ぶ問題。\n\n【なぜ発言者を区別するのか】\n対話文では、誰が何を言い、何をするのかを正確に区別しないと、行動の主体を取りちがえてしまう。\n\n【ポイント1】リサの発言を確認する\n"Can you lend it to me next week?"（来週貸してくれる？）と本を貸してほしいと頼んでいる。\n\n【ポイント2】ケンの返答を確認する\n"Sure! I\'ll bring it to school on Monday."（いいよ、月曜に持ってくる）と答えている。\n\n【ポイント3】他の選択肢を消去する\n野球をするのはケン（リサではない）、リサが訪ねる祖母は京都（大阪ではない）、ケンが本を読むのは日曜（土曜ではない）。\n\n【答え】\nKen will lend his book to Lisa.\n\n【確かめ】\n選んだ文の主語・動作が、対話の中の正しい発言者と対応しているか確認する。\n\n【よくあるまちがい】\n対話文で発言者を取りちがえ、リサとケンの行動を逆にしてしまうミス。\n\n【ここが絶対】\n対話文は、話し手ごとに「する予定のこと」を整理しながら読む。',
...
Finally, everyone sat down and ate the food together. Haruka was proud because she made the meal with her own hands. "I want to cook dinner for my family tonight," she thought happily.`,
    ...
    explanation:
      '【何を聞かれているか】\n料理体験についての英文を読み、米を洗った直後にしたことを答える問題。\n\n【なぜ順序を表す語に注目するのか】\n本文にはFirst, Then, After that, Finallyという順序を表す語が使われており、これらを手がかりに出来事の順番を正確に把握する必要がある。\n\n【ポイント1】Firstの内容を確認する\n"First, the teacher showed ... how to wash the rice."（まず米を洗う）。\n\n【ポイント2】Thenの内容を確認する\n"Then, they cut the vegetables"（次に野菜を切る）＝米を洗ったすぐ後の出来事。\n\n【ポイント3】その後の出来事と区別する\n"cooked everything in a big pot"（大きななべで料理する）はその後、"ate the food together"（いっしょに食べる）はFinally（最後）の出来事。\n\n【答え】\nThey cut the vegetables.\n\n【確かめ】\n選んだ答えが、米を洗った「直後」の出来事であり、それより後の出来事（料理・食事）ではないことを確認する。\n\n【よくあるまちがい】\n本文に出てくる出来事すべてを候補に入れて迷ってしまうミス。順序語で前後関係を確定させる。\n\n【ここが絶対】\nFirst / Then / After that / Finallyは出来事の順番を示す合図として丸をつけながら読む。',
