...
② He (She) practiced hard enough to make a perfect Japanese sweet by the time he (she) was twelve.`,
    ...
    explanation:
      '【何を聞かれているか】\n祖父から和菓子の作り方を教わった筆者についての英文を読み、下線部の訳と内容一致の設問に答える問題。\n\n【なぜteach+人+how to doの形に注目するのか】\n①の下線部は"teach+人+how to do"（人に〜の仕方を教える）という文構造なので、この型に沿って訳す必要がある。\n\n【ポイント1】①の構造を確認する\n"taught me how to make traditional Japanese sweets"＝「（祖父は）私に伝統的な和菓子の作り方を教えてくれた」。\n\n【ポイント2】②の該当箇所を確認する\n"I practiced hard enough to make a perfect one by the time I was twelve."（12歳までに完璧な和菓子を作れるくらい一生懸命練習した）から、12歳までにできるようになったことを読み取る。\n\n【ポイント3】too〜to doとの対比を確認する\n本文前半の"too difficult for me to make them well"（難しすぎてうまく作れなかった）と、後半の"practiced hard enough to make"（十分練習してできるようになった）という時間の経過による変化を区別する。\n\n【答え】\n① （祖父は）私に伝統的な和菓子の作り方を教えてくれた。\n② He (She) practiced hard enough to make a perfect Japanese sweet by the time he (she) was twelve.\n\n【確かめ】\n②の答えが、本文前半の「うまく作れなかった」状態ではなく、12歳までにできるようになった内容になっているか確認する。\n\n【よくあるまちがい】\n②を「最初はうまく作れなかった」という前半の内容で答えてしまうミス。設問は12歳までにできるようになったことを問うている。\n\n【ここが絶対】\nteach+人+how to do＝「人に〜の仕方を教える」、too〜to doと〜enough to doの対比で時間の変化を読み取る。',
