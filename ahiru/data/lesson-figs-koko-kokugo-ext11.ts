...
export const lessonFigsKokoKokugoExt11: Record<string, Figure> = {
  ...
  lf_kokokokugoext11_376: {
    ...
    steps: [
      "よこじくは「一日の読書時間」、たてじくは「割合（％）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「読まない」で38（割合（％））。",
      "いちばん小さいのは「2時間以上」で5。差は33。",
      "大きい順にならべると 読まない → 30分未満 → 30分〜1時間 → 1〜2時間 → 2時間以上。棒の高さを見比べて確かめる。",
      "中学生が一日に読書する時間（単位は％・合計100％）。最も多いのは「読まない」の38％だが、これは過半数ではない。読む生徒は24＋21＋12＋5＝62％で、読まない生徒より多い。最大の項目＝半数以上、と早合点しないこと",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext11_377: {
    ...
    steps: [
      "よこじくは「年」、たてじくは「貸出冊数（千冊）」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（2019, 52）、終わりは（2024, 63）。",
      "全体として11だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
  ...
  lf_kokokokugoext11_378: {
    ...
    steps: [
      ...
      "いちばん大きいのは「動画サイト・SNS 41%」で、全体のおよそ41%。",
      "内わけは 動画サイト・SNS 41% 41%、テレビ 33% 33%、ニュースアプリ 15% 15%、新聞 6% 6% …。",
  ...
  lf_kokokokugoext11_379: {
    ...
    steps: [
      "よこじくは「学校」、たてじくは「一人あたり年間貸出冊数（冊）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「C中 210人」で15.2（一人あたり年間貸出冊数（冊））。",
      "いちばん小さいのは「D中 500人」で7.6。差は7.6。",
      "大きい順にならべると C中 210人 → A中 320人 → B中 450人 → D中 500人。棒の高さを見比べて確かめる。",
      "4校の一人あたり年間貸出冊数。棒が最も高いのはC中(15.2冊)だが、生徒数をかけた合計はA3968冊・B4410冊・C3192冊・D3800冊でB中が最多。全体の一人あたりは15370÷1480＝約10.4冊で、単純平均11.25冊とは一致しない",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext11_380: {
    ...
    steps: [
      "よこじくは「年」、たてじくは「部活動加入率（％）」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（2020, 78）、終わりは（2024, 70）。",
  ...
  lf_kokokokugoext11_380b: {
    ...
    steps: [
      "よこじくは「年」、たてじくは「部員数（人）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「2024年」で350（部員数（人））。",
      "いちばん小さいのは「2020年」で312。差は38。",
      "大きい順にならべると 2024年 → 2023年 → 2022年 → 2021年 → 2020年。棒の高さを見比べて確かめる。",
      "同じ調査を「人数」で描き直したもの。全校生徒数が400→425→450→475→500人と増えたため、400×0.78＝312人から500×0.70＝350人へ38人増加している。割合は下がり、人数は増える。両方に触れて書けると満点",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext11_381: {
    ...
    steps: [
      "よこじくは「一週間の家庭学習時間（時間）」、たてじくは「人数（人）」を表している。まず何と何を比べた図かをつかむ。",
      "階級ごとの個数を表したヒストグラム。棒がとなり合っているのは、階級が連続しているため。",
      "いちばん度数が大きい階級は「4〜6」で14。ここが最頻値をふくむ階級になる。",
      "度数の合計は40。全体の中でどのあたりに集まっているかを見る。",
      "ある学級40人の一週間の家庭学習時間。4＋9＋14＋8＋4＋1＝40人で合計が合う。最頻値も中央値も4〜6時間の階級。右端の10〜12時間に1人いる（赤）ことを見落とすと「10時間以上はいない」と誤読する",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext11_382: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「1〜2時間 27%」で、全体のおよそ27%。",
      "内わけは 1時間未満 18% 18%、1〜2時間 27% 27%、2〜3時間 25% 25%、3〜4時間 17% 17% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "【資料A】中学生が一日にスマートフォンを使う時間（単一回答・合計100％）。2時間以上は25＋17＋13＝55％で、100－18－27＝55と検算しても一致する。この資料は「どれくらいの時間か」だけを示している",
    ],
    buildSteps: 4,
  ...
  lf_kokokokugoext11_382b: {
    ...
    steps: [
      "よこじくは「主な使い道（複数回答）」、たてじくは「その項目を挙げた人の割合（％）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「動画視聴」で68（その項目を挙げた人の割合（％））。",
      "いちばん小さいのは「通話」で22。差は46。",
      "大きい順にならべると 動画視聴 → SNS → ゲーム → 音楽 → 調べ物 → 通話。棒の高さを見比べて確かめる。",
      "【資料B】スマートフォンの主な使い道（複数回答）。合計は68＋61＋45＋39＋31＋22＝266％で100を超えるが誤植ではない。一人が複数に答えているため、項目を足して「〜割を占める」とは書けない。順位で述べること",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext11_383: {
    ...
    steps: [
      "よこじくは「年度」、たてじくは「食べ残し量（kg／日）」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（2019, 38）、終わりは（2024, 19）。",
      "全体として19だけ減っている。右下がりは減少を表す。",
      "かたむきが急なところほど、変わり方が大きい。",
      "【資料1】給食の食べ残し量（一日平均・kg）。38→19でちょうど半減。ただし前年度差は－3、－2、－3、－6、－5で一定ではなく、量を選べる制度が始まった2022年度の翌年から減り方が急になっている",
    ],
    buildSteps: 4,
  ...
  lf_kokokokugoext11_383b: {
    ...
    steps: [
      "よこじくは「食べ残しの理由（単一回答）」、たてじくは「割合（％）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「量が多い」で34（割合（％））。",
      "いちばん小さいのは「その他」で7。差は27。",
      "大きい順にならべると 量が多い → 苦手な食べ物 → 時間が足りない → 体調が悪い → その他。棒の高さを見比べて確かめる。",
      "【資料3】食べ残しの理由（34＋29＋21＋9＋7＝100％）。最多の「量が多い」34％には量を選べる制度が対応するが、「時間が足りない」21％は制度では解決しない。制度と数値の減少が同時でも、原因だと断定はできない",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext11_384: {
    ...
    steps: [
      "よこじくは「年」、たてじくは「参加したことがある生徒の割合（％）」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（2020, 62）、終わりは（2024, 55）。",
  ...
  lf_kokokokugoext11_384b: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「まあ思う 39%」で、全体のおよそ39%。",
      "内わけは とても思う 22% 22%、まあ思う 39% 39%、あまり思わない 27% 27%、思わない 12% 12%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "【資料2】「地域の行事に参加したいと思うか」（2024年・単一回答）。前向きな回答は22＋39＝61％で6割を超える。行動（55％）と意識（61％）はそろえて述べるだけにし、61－55＝6％を「参加できなかった人」と読んではいけない",
    ],
    buildSteps: 4,
  ...
  lf_kokokokugoext11_385: {
    ...
    steps: [
      "よこじくは「読書量」、たてじくは「一日のスマートフォン使用時間（時間）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「ほとんど読まない」で3.3（一日のスマートフォン使用時間（時間））。",
      "いちばん小さいのは「週に3冊以上」で1.4。差は1.9。",
      "大きい順にならべると ほとんど読まない → 月に数冊 → 週に1〜2冊 → 週に3冊以上。棒の高さを見比べて確かめる。",
      "読書量別に見たスマートフォン使用時間。読む量が多い生徒ほど使用時間が短いという「関係」は読み取れる。しかしどちらが原因かは決められない（読書好きだから使わない／自由時間の量が両方に影響、なども考えられる）",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext11_387: {
    ...
    steps: [
      "よこじくは「学年」、たてじくは「参加した経験がある生徒の割合（％）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「3年生」で44（参加した経験がある生徒の割合（％））。",
      "いちばん小さいのは「1年生」で31。差は13。",
      "大きい順にならべると 3年生 → 2年生 → 1年生。棒の高さを見比べて確かめる。",
      "【資料1】ボランティア活動に参加した経験がある生徒の割合（令和6年度）。学年が上がるほど増え、1年生31％から3年生44％へ13ポイント高い。数値を並べるだけでなく「学年が上がるほど増えている」と変化にまとめる",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext11_387b: {
    ...
    steps: [
      "よこじくは「年度」、たてじくは「紹介した活動の件数（件）」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（2020, 8）、終わりは（2024, 24）。",
  ...
  lf_kokokokugoext11_390: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「A案（劇）14人」で、全体のおよそ35%。",
      "内わけは A案（劇）14人 35%、B案（模擬店）11人 27.5%、C案（展示）7人 17.5%、決めかねている 8人 20%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "文化祭の出し物についての意見（40人）。最多のA案も14÷40＝35％で過半数に届かず、他の案と保留を合わせると26人になる。「いちばん多いから決定」とせず、共通する目的を探し、保留の8人に理由をたずねる",
    ],
    buildSteps: 4,
  ...
  lf_kokokokugoext11_397: {
    ...
    steps: [
      "よこじくは「地域のためにできること（単一回答）」、たてじくは「割合（％）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「あいさつ」で31（割合（％））。",
      "いちばん小さいのは「防災訓練」で9。差は22。",
      "大きい順にならべると あいさつ → ごみ拾い → 行事の手伝い → 高齢者との交流 → 防災訓練。棒の高さを見比べて確かめる。",
      "中学生が「地域のためにできること」として挙げたこと（31＋26＋21＋13＋9＝100％）。上位2つで57％。作文では「最も多い」だけでなく「あいさつが31％で最も多い」と数値を入れて引用する",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext11_398: {
    ...
    steps: [
      "よこじくは「年度」、たてじくは「一日平均利用者数（人）」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（2019, 42）、終わりは（2024, 58）。",
      "全体として16だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "かたむきが急なところほど、変わり方が大きい。",
      "学校図書館の一日平均利用者数。2020年度の31人が最少で、2024年度は58人。58÷31＝1.87なので「1.8倍以上に増えた」と言える。「年々増加」は2019→2020年度に減っているので誤り。「一日平均」の語も落とさない",
    ],
  ...
  lf_kokokokugoext11_399: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「どちらかといえば苦手 41%」で、全体のおよそ41%。",
      "内わけは 得意 9% 9%、どちらかといえば得意 26% 26%、どちらかといえば苦手 41% 41%、苦手 24% 24%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "「自分の考えを人に伝えるのが得意ですか」（単一回答・合計100％）。苦手側は41＋24＝65％、得意側は9＋26＝35％。第一段落ではこの合計を事実として書き、「問題だと思う」などの評価は第二段落に回す",
    ],
    buildSteps: 4,
  ...
  lf_kokokokugoext11_400: {
    ...
    steps: [
      "よこじくは「話し合いで困ること（単一回答）」、たてじくは「割合（％）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「意見が思いつかない」で33（割合（％））。",
      "いちばん小さいのは「その他」で7。差は26。",
      "大きい順にならべると 意見が思いつかない → 反対されるのがこわい → まとめ方がわからない → 時間が足りない → その他。棒の高さを見比べて確かめる。",
      "話し合いで困ること（33＋27＋21＋12＋7＝100％）。上位2つで60％を占める。この資料を引用したうえで、「いつ・何があった・どう変わった」の3点で体験を50〜70字にまとめると、180字の作文に収まる",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext11_401: {
    ...
    steps: [
      "よこじくは「スマートフォンの持ちこみへの賛否（単一回答）」、たてじくは「割合（％）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「どちらかといえば反対」で30（割合（％））。",
      "いちばん小さいのは「反対」で17。差は13。",
      "大きい順にならべると どちらかといえば反対 → どちらかといえば賛成 → 賛成 → 反対。棒の高さを見比べて確かめる。",
      "中学校へのスマートフォン持ちこみへの賛否（24＋29＋30＋17＝100％）。単独最多は「どちらかといえば反対」30％だが、合算すると賛成側53％・反対側47％で賛成側がわずかに多い。必ず2つずつ足してから判断する",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext11_402: {
    ...
    steps: [
      "よこじくは「年」、たてじくは「祭りの参加者数（人）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「2019年」で1200（祭りの参加者数（人））。",
      "いちばん小さいのは「2020年」で0。差は1200。",
      "大きい順にならべると 2019年 → 2024年 → 2023年 → 2022年 → 2020年 → 2021年。棒の高さを見比べて確かめる。",
      "ある地区の祭りの参加者数。2020年と2021年は中止で0人。2022年以降は640→880→1050人と回復し、2024年は1050÷1200＝0.875で中止前の8割以上にあたる。最初と最後だけを比べて「減少」と書かないこと",
    ],
    buildSteps: 4,
  },
