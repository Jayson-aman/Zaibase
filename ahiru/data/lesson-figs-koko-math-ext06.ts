...
export const lessonFigsKokoMathExt06: Record<string, Figure> = {
  ...
  lf_kokomathext06_200: {
    ...
    steps: [
      "頂点を順に P・A・B と結んだ三角形。まず形と頂点の名前をおさえる。",
      "同じ印のついた辺は長さが等しい。二等辺や正多角形の性質が使える。",
  ...
  lf_kokomathext06_201: {
    ...
    steps: [
      "頂点を順に O・A・C・B と結んだ四角形。まず形と頂点の名前をおさえる。",
      "同じ印のついた辺は長さが等しい。二等辺や正多角形の性質が使える。",
      "対角線を引くと、三角形に分けて考えられる。",
      "角の二等分線の作図。OA＝OB（同じ半径の弧）、AC＝BC（同じ半径の弧）なので四角形OACBはひし形。だから対角線OCは∠AOB（図では50°）を25°ずつに二等分する",
    ],
  ...
  lf_kokomathext06_202: {
    ...
    steps: [
      "頂点を順に P・A・Q・B と結んだ四角形。まず形と頂点の名前をおさえる。",
      "同じ印のついた辺は長さが等しい。二等辺や正多角形の性質が使える。",
      "対角線を引くと、三角形に分けて考えられる。",
      "点Pを通る直線ABの垂線の作図。PA＝PB、QA＝QB なので、PもQも線分ABの垂直二等分線上にある。よって直線PQ⊥AB",
    ],
  ...
  lf_kokomathext06_214: {
    ...
    steps: [
      ...
      "AB＝AC の二等辺三角形。底辺BCの両はしの角（底角）∠Bと∠Cは等しい",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext06_218: {
    ...
    steps: [
      "頂点を順に A・B・C と結んだ三角形。まず形と頂点の名前をおさえる。",
      "辺に書かれている長さは 4cm、斜辺 5cm、3cm。どの辺のことかを図で確かめる。",
  ...
  lf_kokomathext06_219: {
    ...
    steps: [
      "頂点を順に O・A・P・B と結んだ四角形。まず形と頂点の名前をおさえる。",
  ...
  lf_kokomathext06_229: {
    ...
    steps: [
      "頂点を順に A・D・C・B と結んだ四角形。まず形と頂点の名前をおさえる。",
      "対角線を引くと、三角形に分けて考えられる。",
      "四角形の内角の和は360°。角度を求めるときの手がかりになる。",
      "AD∥BC のとき、△ABCと△DBCは底辺BC＝6が共通で高さも3で等しい。よって面積はどちらも 6×3÷2＝9 で等しい",
    ],
