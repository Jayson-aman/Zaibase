...
export const kindaiExamV2: Question[] = [
  ...
  },
  {
    ...
    explanation:
      ...
      '半分の面積：21cm²\n\n' +
      '上からh cmの位置での平行線の長さxは、相似より\n' +
      'x = 4 + (10 - 4) × h/6 = 4 + h\n\n' +
      '上からh cmの台形（上底4、下底x）の面積が21になればよいので、\n' +
      '(4 + x) × h ÷ 2 = 21\n' +
      '(4 + 4 + h) × h ÷ 2 = 21\n' +
      '(8 + h) × h = 42\n' +
      'h² + 8h − 42 = 0\n\n' +
      '解の公式より h = (−8 + √(64+168)) ÷ 2 = (−8 + √232) ÷ 2 ≈ (−8 + 15.23) ÷ 2 ≈ 3.62cm\n\n' +
      '選択肢のうち最も近いのは 3.5cm（3.2cmとの差0.42に対し、3.5cmとの差は0.12）。\n\n' +
      '答え：3.5cm',
