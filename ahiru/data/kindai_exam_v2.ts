...
export const kindaiExamV2: Question[] = [
  ...
  },
  {
    ...
    explanation:
      '【解法】\n' +
      'まず引いた直線の長さを求める。上底4cmから下底10cmまで、高さ6cmのあいだに 10−4＝6cm 広がる。\n' +
      'つまり1cm下がるごとに1cmずつ長くなるので、上から2cmのところでは 4＋2＝6cm。\n\n' +
      '上側は、上底4cm・下底6cm・高さ2cmの台形。\n' +
      '　(4＋6)×2÷2 ＝ 10cm²\n\n' +
      '台形全体は (4＋10)×6÷2 ＝ 42cm² なので、下側は 42−10 ＝ 32cm²。\n\n' +
      '上側 : 下側 ＝ 10 : 32 ＝ 5 : 16。\n\n' +
      'なお「面積がちょうど半分になる高さ」を求める形にすると、(8＋h)×h＝42 という「かけて42になる2つの数（差が8）」を探す計算になり、答えも整数にならない（約3.62cm）。これは中学以降で習う内容なので、小学生向けにはこの形では出題されない。',
