...
ア. rains　イ. will rain　ウ. rained　エ. is rain`,
    ...
    explanation:
      '【何を聞かれているか】\n"If it (　) tomorrow, we will cancel the picnic."の空欄に入る、正しい動詞の形を選ぶ問題。\n\n【なぜif節の中で現在形を使うのか】\n英語では、if（もし〜なら）で始まる条件を表す副詞節の中では、たとえ未来のことを表していても現在形を使うという決まりがある。\n\n【ポイント1】条件文の公式を確認する\nIf＋主語＋現在形〜, 主語＋will＋動詞の原形〜。\n\n【ポイント2】if節を組み立てる\n「明日雨が降ったら」は未来の出来事だが、if節の中は現在形rainsを使う。\n\n【ポイント3】主節の形を確認する\n主節（we will cancel the picnic）には未来を表すwillを使う。\n\n【答え】\nア(rains)\n\n【確かめ】\nif節の動詞が現在形（rains）になっていて、willが使われていないことを確認する。\n\n【よくあるまちがい】\nif節の中にwill rainを入れてしまうミス。if節では未来のことでも現在形を使う。\n\n【ここが絶対】\n時・条件の副詞節（if, when, before, afterなど）の中は「現在形が未来を表す」と覚える。',
...
He is the (　) student in his class.`,
    ...
    explanation:
      '【何を聞かれているか】\n「彼はクラスで一番背が高い生徒だ。」という日本語に合うように、最上級を入れる問題。\n\n【なぜtallestという最上級を使うのか】\n「クラスで一番〜」という、3つ以上の中で一番であることを表すときは、最上級を使う。\n\n【ポイント1】最上級の公式を確認する\nthe＋形容詞の最上級＋in/of〜（〜の中で）。\n\n【ポイント2】tallの活用を確認する\ntallのような1音節の形容詞は、-estをつけて最上級を作る（tall→tallest）。\n\n【ポイント3】"the most tall"が誤りであることを確認する\n1音節の短い形容詞はmostを使わず、est形にする。\n\n【答え】\ntallest\n\n【確かめ】\n"the tallest"がtallの正しい最上級になっていることを確認する。\n\n【よくあるまちがい】\n"the most tall"としてしまうミス。1音節の形容詞なのでest形が正しい。\n\n【ここが絶対】\n短い形容詞（1音節）はer/est、長い形容詞（2音節以上）はmore/mostと語の長さで判断する。',
...
（その理論が宇宙の理解の仕方を変えた科学者は、ノーベル賞を受賞した）`,
    ...
    explanation:
      '【何を聞かれているか】\n「その理論が宇宙の理解の仕方を変えた科学者は、ノーベル賞を受賞した」という文の空欄に、正しい関係代名詞を入れる問題。\n\n【なぜwhoseを使うのか】\n「The scientist\'s theory changed〜」（その科学者の理論が〜を変えた）という所有の関係を、先行詞the scientistの直後で表すときは、所有格の関係代名詞whoseを使う。\n\n【ポイント1】whoseの形を確認する\nwhoseは「先行詞＋関係代名詞＋名詞」の語順で「〜の…」という所有関係を表す。\n\n【ポイント2】whoseの後ろが名詞であることを確認する\nwhoseの後には必ず名詞（ここではtheory）が続く。\n\n【ポイント3】whoseが人にも物にも使えることを確認する\nwhoseは先行詞が人でも物でも使える、唯一の所有格の関係代名詞。\n\n【答え】\nwhose\n\n【確かめ】\n"whose theory"が「その科学者の理論」という意味の所有関係を表しているか確認する。\n\n【よくあるまちがい】\nwhoやwhichを入れてしまうミス。後ろのtheoryとのつながりが不自然になり、所有関係を表すにはwhoseが必要。\n\n【ここが絶対】\nwhose＋名詞＝「〜の…」という所有のつながりを表すと覚える。',
...
→ The teacher told us (　) (　) our essays by Friday.`,
    ...
    explanation:
      '【何を聞かれているか】\n命令文の直接話法を、tellを使った間接話法に書き換える問題。\n\n【なぜtell＋人＋to doの形を使うのか】\n命令文を間接話法にするときは、sayではなくtellを使い、命令の内容をto不定詞（to＋動詞の原形）で表すという決まりがある。\n\n【ポイント1】命令文の間接話法の公式を確認する\ntell＋人＋to＋動詞の原形。\n\n【ポイント2】文を組み立てる\n"The teacher told us to submit our essays by Friday."＝「先生は私たちに金曜日までにレポートを提出するように言った」。\n\n【ポイント3】否定の命令文との違いを確認する\n否定の命令文を間接話法にするときは、not to doという形になる。\n\n【答え】\nto submit\n\n【確かめ】\n"told us"の後ろが"to submit"という不定詞になっているか確認する。\n\n【よくあるまちがい】\n"told us that we submit"のようにthat節を使ってしまうミス。命令文の間接話法はto doの形が基本。\n\n【ここが絶対】\n命令文の間接話法＝tell/ask/order＋人＋to do、否定はnot to doと覚える。',
...
ア. put off　イ. take off　ウ. give away　エ. bring up`,
    ...
    explanation:
      '【何を聞かれているか】\n"The committee will (　) the final decision until all opinions have been heard."の空欄に入る、正しい句動詞を選ぶ問題。\n\n【なぜput offが正解なのか】\n「すべての意見が聞かれるまで最終決定を延期する」という文脈から、put off（延期する）という意味の句動詞が合う。\n\n【ポイント1】put offの意味を確認する\nput off〜＝「〜を延期する」（＝postpone）。\n\n【ポイント2】他の選択肢を消去する\ntake off（脱ぐ・離陸する）、give away（与える・ばらす）、bring up（育てる・話題を持ち出す）は、いずれも「延期する」という意味にはならない。\n\n【ポイント3】類義語を確認する\npostpone、delayも「延期する」という同じ意味を表す。\n\n【答え】\nア(put off)\n\n【確かめ】\n"put off the final decision"が「最終決定を延期する」という意味になっているか確認する。\n\n【よくあるまちがい】\nbring upを選んでしまうミス。「話題として持ち出す」という意味になり、「延期する」とは異なる。\n\n【ここが絶対】\nput off＝postpone＝delay（すべて「延期する」の同意語）とまとめて覚える。',
...
It is (　) you (　) the truth.`,
    ...
    explanation:
      '【何を聞かれているか】\n「そろそろ本当のことを話す時間だ。」という日本語に合うように、"It is time+S+過去形"という表現を完成させる問題。\n\n【なぜ過去形を使うのか】\n「そろそろ〜すべき時間だ」という、実際にはまだ行われていないことを暗示する表現は、仮定法的なニュアンスを持ち、"It is time＋主語＋動詞の過去形"という形を取る。\n\n【ポイント1】"It is time+S+過去形"の公式を確認する\n「そろそろ〜する時間だ」という定型表現。\n\n【ポイント2】動詞を過去形にすることを確認する\ntellの過去形toldを使い、"you told the truth"とする。\n\n【ポイント3】他の形との違いを確認する\n"It is time to do"（不定詞）や"It is time for＋人＋to do"という形もあるが、"S+V"の節が続く場合は過去形を使う。\n\n【答え】\ntime, told\n\n【確かめ】\n"It is time you told the truth."が「そろそろ本当のことを話す時間だ」という意味になっているか確認する。\n\n【よくあるまちがい】\n"It is time you tell the truth"のように現在形にしてしまうミス。この構文では過去形を使う。\n\n【ここが絶対】\nIt is (high) time＋S＋過去形＝「そろそろ〜すべき時だ」という仮定法過去的な定型表現としてセットで覚える。',
...
It was (　) that my grandfather built this house.`,
    ...
    explanation:
      '【何を聞かれているか】\n"My grandfather built this house in 1965."という文を、"in 1965"を強調するit強調構文に書き換える問題。\n\n【なぜIt was〜thatで挟むのか】\n強調構文は、強調したい語句を"It is/was"と"that"の間に置き、残りの部分をthat以下に続けるという決まった形を取る。\n\n【ポイント1】強調構文の公式を確認する\nIt is/was＋強調したい語句＋that＋残りの文。\n\n【ポイント2】強調する語句を確認する\n"in 1965"（時を表す副詞句）を"It was"と"that"の間に置く。\n\n【ポイント3】残りの部分を確認する\n"my grandfather built this house"がthat以下に続く。\n\n【答え】\nin 1965\n\n【確かめ】\n"It was in 1965 that my grandfather built this house."が、元の文と同じ内容を伝えていて、in 1965が強調されているか確認する。\n\n【よくあるまちがい】\n"It was my grandfather that〜"のように人を強調してしまうミス。強調したい要素（in 1965）とずれてしまう。\n\n【ここが絶対】\n"It is/was＋強調したい語句＋that＋残りの文"という「サンドイッチ」構造で強調構文を覚える。',
...
I wish I (　) (　) his advice at that time.`,
    ...
    explanation:
      '【何を聞かれているか】\n「あの時、彼のアドバイスに従っていればよかったのに。」という日本語に合うように、I wish構文を完成させる問題。\n\n【なぜhad＋過去分詞を使うのか】\n「あの時〜していればよかった」という過去の事実に反する後悔・願望は、仮定法過去完了（I wish＋主語＋had＋過去分詞）で表す。\n\n【ポイント1】仮定法過去完了のI wish構文を確認する\nI wish＋主語＋had＋過去分詞＝「（あの時）〜していればよかったのに」。\n\n【ポイント2】followの過去分詞を確認する\nfollowの過去分詞followedを使い、had followedとする。\n\n【ポイント3】仮定法過去との違いを確認する\n"I wish I followed"（過去形のみ）は現在の事実に反する願望を表すが、過去の後悔にはhad+過去分詞が必要。\n\n【答え】\nhad followed\n\n【確かめ】\n"I wish I had followed his advice at that time."が、過去の後悔を正しく表しているか確認する。\n\n【よくあるまちがい】\n"I wish I followed his advice"としてしまうミス。時制がずれて過去の後悔を正しく表せない。\n\n【ここが絶対】\nI wish＋had＋過去分詞＝「（あの時）〜していればよかったのに」という過去の後悔を表すと覚える。',
