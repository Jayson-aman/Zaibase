...
export const lessonFigsSansu: Record<string, Figure> = {
  ...
  lf_sansu_01: {
    ...
    steps: [
      ...
      '答 840÷1,200＝0.7なので、全体の0.7、つまり7わり分にあたります。',
  ...
  lf_sansu_20: {
    ...
    steps: [
      ...
      '問 その数え方をすると、合計はどんな式で表されますか。',
      '答 1＋3＋5＋7＝16です。ちょうど4×4という正方形の点の数になります。',
      '問 たしている数には、どんな共通点があるでしょうか。',
  ...
  lf_sansu_22: {
    ...
    steps: [
      ...
      '問 直方体の体積を求める式は、どのように書けるでしょうか。',
      '答 たて×よこ×高さです。底面積×高さと考えても同じことになります。',
      '問 それでは、この直方体の体積はいくつになるでしょうか。',
      '答 4×5×6＝120cm³です。単位は立方センチメートルになります。',
      '問 底面積を先に計算すると、どのような式になるでしょうか。',
      '答 4×5＝20cm²が底面積で、20×6＝120cm³と求められます。',
      '問 高さだけを2倍にのばすと、体積はどうなるでしょうか。',
  ...
  lf_sansu_23: {
    ...
    steps: [
      ...
      '問 その底面の円周の長さは、いくつになるでしょうか。',
      '答 直径4cm×3.14＝12.56cmです。これが長方形のよこの長さです。',
      '問 それでは、側面の面積はいくつになるでしょうか。',
      '答 12.56×5＝62.8cm²です。長方形の面積として計算できます。',
      '問 表面積を求めるには、あと何をたせばよいでしょうか。',
  ...
  lf_sansu_24: {
    ...
    steps: [
      ...
      '問 それでは、1の向かい側の面はいくつになるでしょうか。',
      '答 6です。同じように2の向かいは5、3の向かいは4になります。',
      '問 展開図の上では、向かい合う面はどこに書かれていますか。',
