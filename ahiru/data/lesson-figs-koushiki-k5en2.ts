...
export const lessonFigsKoushikiK5En2: Record<string, Figure> = {
  ...
  lf_koushiki_k5en2_futatsu_no_en: {
    ...
    steps: [
      '中心O₁(半径5cm)と中心O₂(半径8cm)の2つの円が、2点P、Qで交わっているとする。中心間の距離をd=O₁O₂=9cmとする',
      'r₁+r₂=5+8=13、|r₁−r₂|=|5−8|=3なので、3<9<13(|r₁−r₂|<d<r₁+r₂)が成り立ち、確かに「2点で交わる」の条件を満たしている',
      '交点PはO₁から5cm(半径r₁)、O₂から8cm(半径r₂)の位置にある。同様に交点QもO₁から5cm、O₂から8cmの位置にある',
      '四角形O₁PO₂Qは、O₁P=O₁Q=5cm、O₂P=O₂Q=8cmとなり、2組の隣り合う辺がそれぞれ等しい「たこ形」になる',
      'この「2点で交わる」場合、共通接線(2つの円のどちらにも接する直線)は2本だけ引ける(円が重なっているため、間を横切る接線は引けない)',
      'もしdをどんどん大きくしていくとd=13(=r₁+r₂)で外接に切り替わり、逆にd=3(=|r₁−r₂|)まで小さくすると内接に切り替わる、という境目の関係も確認しておく',
    ],
  },
};
