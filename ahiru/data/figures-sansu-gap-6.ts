...
export const figuresSansuGap6: Record<string, Figure> = {
  ...
  sansu_data_ch_21: {
    ...
    steps: [
      'たての軸が来客数（人）、横の軸が月。点は月ごとの来客数を表している。',
      '聞かれているのは「どの月からどの月にかけていちばん増えたか」。人数そのものではなく、となり合う点の差を見る問題。',
      '1月から2月にかけては 2400 − 2000 ＝ 400人の増加。',
      '2月から3月にかけては 3000 − 2400 ＝ 600人の増加。',
      '2つをくらべると600人のほうが大きい。だから2月から3月にかけてがいちばん増えている。',
      'グラフの上では、線のかたむきが急な区間ほど増え方が大きい。2月から3月の線のほうが立って見えるのはこのため。',
      '「いちばん多い月」と「いちばん増えた月」はちがう。人数が最大なのは3月だが、増え方を聞かれたら差を見ること。',
    ],
    buildSteps: 2,
  },
