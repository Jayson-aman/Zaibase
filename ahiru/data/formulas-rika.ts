...
// やさしい説明・等幅テキストの図解・例題・チェックポイントまで
// 入れた濃い教材。図解（asciiFigure）は monospace で崩れない範囲で描く。
