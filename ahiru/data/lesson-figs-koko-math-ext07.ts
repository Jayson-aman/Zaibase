...
export const lessonFigsKokoMathExt07: Record<string, Figure> = {
  ...
  lf_kokomathext07_231: {
    ...
    steps: [
      ...
      "△ABC∽△DEF：AB=2, AC=1.5, BC=2.5 と DE=4, DF=3, EF=5。相似比1:2、対応する角は等しい",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext07_234: {
    ...
    steps: [
      ...
      "辺に書かれている長さは AD=4、DB=2、BC=9。どの辺のことかを図で確かめる。",
      "対角線を引くと、三角形に分けて考えられる。",
      "DE∥BC のとき △ADE∽△ABC。相似比は AD:AB=4:6=2:3 なので DE=9×2/3=6（AD:DBではない）",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext07_238: {
    ...
    steps: [
      ...
      "辺に書かれている長さは AB=3、BC=5、CA=4。どの辺のことかを図で確かめる。",
      "A のところが直角。直角があれば三平方の定理や面積の式が使える。",
      "点線は高さ。面積を出すときは、底辺に垂直な長さを使う。",
      "∠A=90°、AH⊥BC。△ABC∽△HBA∽△HAC。AH=3×4÷5=2.4、BH=9/5=1.8、CH=16/5=3.2、AH²=1.8×3.2=5.76",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokomathext07_240: {
    ...
    steps: [
      "図にある点は A・D・B・C・E。どの点がどこにあるかを最初におさえる。",
      "辺に書かれている長さは AD=3、DB=2、BC=10。どの辺のことかを図で確かめる。",
      "対角線を引くと、三角形に分けて考えられる。",
      "DE∥BC ⇒ AD:DB=AE:EC=3:2、AD:AB=DE:BC=3:5。よって DE=10×3/5=6",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext07_242: {
    ...
    steps: [
      "図にある点は A・B・C・F・E・D。どの点がどこにあるかを最初におさえる。",
      "辺に書かれている長さは AB=4、BC=6、FE=9、ED=6。どの辺のことかを図で確かめる。",
      "対角線を引くと、三角形に分けて考えられる。",
      "3本の平行線 l(AD)∥m(BE)∥n(CF) が2直線を切る。AB:BC=DE:EF すなわち 4:6=6:9（どちらも2:3）",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext07_244: {
    ...
    steps: [
      "図にある点は A・M・B・C・N。どの点がどこにあるかを最初におさえる。",
      "辺に書かれている長さは BC=12。どの辺のことかを図で確かめる。",
      "同じ印のついた辺は長さが等しい。二等辺や正多角形の性質が使える。",
      "対角線を引くと、三角形に分けて考えられる。",
      "M、Nが辺AB、ACの中点 ⇒ MN∥BC、MN=BC÷2=6（同じ印は長さが等しいことを表す）",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokomathext07_246: {
    ...
    steps: [
      "図にある点は A・M・B・C・N・D。どの点がどこにあるかを最初におさえる。",
      "辺に書かれている長さは BC=10、AD=6。どの辺のことかを図で確かめる。",
      "同じ印のついた辺は長さが等しい。二等辺や正多角形の性質が使える。",
      "対角線を引くと、三角形に分けて考えられる。",
      "台形（AD∥BC）の2脚の中点M、Nを結ぶと MN∥AD∥BC、MN=(6+10)÷2=8",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokomathext07_247: {
    ...
    steps: [
      ...
      "辺に書かれている長さは AB=6、BD=3、DC=2、CA=4。どの辺のことかを図で確かめる。",
      "対角線を引くと、三角形に分けて考えられる。",
      "ADが∠Aの二等分線 ⇒ BD:DC=AB:AC=6:4=3:2。BC=5なので BD=3、DC=2（Dは中点ではない）",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext07_252: {
    ...
    steps: [
      ...
      "図の点は A、B、C。",
      "交点を求めるときは、2つの式を連立方程式として解く。",
      "相似比1:2（3,4,5 と 6,8,10）。面積は 3×4÷2=6 と 6×8÷2=24 で 6:24=1:4＝1²:2²（長さは1乗、面積は2乗）",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext07_257: {
    ...
    steps: [
      "頂点を順に A・B・C と結んだ三角形。まず形と頂点の名前をおさえる。",
      "辺に書かれている長さは a=3、c=5、b=4。どの辺のことかを図で確かめる。",
      "A のところが直角。直角があれば三平方の定理や面積の式が使える。",
      "直角をはさむ2辺 a=3、b=4、斜辺 c=5。a²+b²=9+16=25=c²（斜辺は直角の向かい側の最長辺）",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext07_261: {
    ...
    steps: [
      "頂点を順に A・B・C と結んだ三角形。まず形と頂点の名前をおさえる。",
      "辺に書かれている長さは 1、√2、1。どの辺のことかを図で確かめる。",
      "A のところが直角。直角があれば三平方の定理や面積の式が使える。",
      "同じ印のついた辺は長さが等しい。二等辺や正多角形の性質が使える。",
      "45°-45°-90°の辺の比は 1:1:√2。斜辺=等辺×√2（√2≒1.41）。正方形を対角線で半分にした形",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokomathext07_262: {
    ...
    steps: [
      "頂点を順に A・B・C と結んだ三角形。まず形と頂点の名前をおさえる。",
      "辺に書かれている長さは 1、2、√3。どの辺のことかを図で確かめる。",
      "A のところが直角。直角があれば三平方の定理や面積の式が使える。",
      "正三角形の半分。∠C=30°の対辺AB=1、∠B=60°の対辺AC=√3、斜辺BC=2。比は 1:√3:2",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext07_264: {
    ...
    steps: [
      "頂点を順に A・B・C と結んだ三角形。まず形と頂点の名前をおさえる。",
      "辺に書かれている長さは 6、6、6。どの辺のことかを図で確かめる。",
      "同じ印のついた辺は長さが等しい。二等辺や正多角形の性質が使える。",
      "点線は高さ。面積を出すときは、底辺に垂直な長さを使う。",
      "1辺6の正三角形：底辺の半分が3、高さ=√(6²−3²)=3√3≒5.20、面積=(1/2)×6×3√3=9√3≒15.59",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokomathext07_268: {
    ...
    steps: [
      "よこじくが x、たてじくが y。点の位置は（x, y）の順で読む。",
      "図の点は A(1,2)、B(4,6)、C(4,2)。",
      "交点を求めるときは、2つの式を連立方程式として解く。",
      "横の差AC=4−1=3、縦の差CB=6−2=4。AB=√(3²+4²)=√25=5（座標そのものではなく差を2乗する）",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext07_269: {
    ...
    steps: [
      "よこじくが x、たてじくが y。点の位置は（x, y）の順で読む。",
      "図の点は A(0,0)、B(4,2)、C(2,6)。",
      "ぬられた部分の面積を出すときは、じくに平行な線を底辺にとると計算が楽になる。",
      "AB²=20、BC²=20、CA²=40。AB=BC かつ AB²+BC²=CA² ⇒ ∠B=90°の直角二等辺三角形、面積=(1/2)×20=10",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext07_273: {
    ...
    steps: [
      "頂点を順に A・C・T と結んだ三角形。まず形と頂点の名前をおさえる。",
      "辺に書かれている長さは AC=6√2≒8.49、6、6。どの辺のことかを図で確かめる。",
      "同じ印のついた辺は長さが等しい。二等辺や正多角形の性質が使える。",
      "点線は高さ。面積を出すときは、底辺に垂直な長さを使う。",
      "底面1辺6・側辺6の正四角錐の断面。対角線の半分は3√2 ⇒ h=√(6²−(3√2)²)=√18=3√2、体積=(1/3)×36×3√2=36√2",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokomathext07_275: {
    ...
    steps: [
      "頂点を順に A・B・G・E と結んだ四角形。まず形と頂点の名前をおさえる。",
      "辺に書かれている長さは 4+4=8、4。どの辺のことかを図で確かめる。",
      "A・B・G・E のところが直角。直角があれば三平方の定理や面積の式が使える。",
      "対角線を引くと、三角形に分けて考えられる。",
      "1辺4cmの立方体の側面2面を展開した長方形（8cm×4cm）。A→Gの最短経路は対角線 √(8²+4²)=√80=4√5≒8.94cm",
    ],
    buildSteps: 4,
  },
};
