...
export const lessonFigsKokoKokugoExt10: Record<string, Figure> = {
  ...
  lf_kokokokugoext10_336: {
    ...
    steps: [
      ...
      "いちばん大きいのは「選択肢が増える 2点」で、全体のおよそ33.3%。",
      "内わけは 選択肢が増える 2点 33.3%、比較に疲れる 2点 33.3%、選ぶのをやめる 1点 16.7%、語尾「〜から。」1点 16.7%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "6点の理由記述の配点内訳。合計6点。内容が3項目・語尾が1項目に分かれており、語尾は内容と独立して取れる。「なんとなく七割」ではなく、項目ごとの加点で決まる",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_338: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「理由「なぜか」」で、全体のおよそ35%。",
      "内わけは 理由「なぜか」 35%、内容説明「どういうことか」 30%、心情「どんな気持ちか」 25%、要約・その他 10%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "高校入試の記述問題を四大タイプで分けたときのおおよその出題割合。理由と内容説明で約65%を占める。タイプが決まれば語尾と骨組みが自動的に決まる",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_341: {
    ...
    steps: [
      "よこじくは「要素」、たてじくは「配点（点）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「社会全体の蓄積」で3（配点（点））。",
      "いちばん小さいのは「語尾」で1。差は2。",
      "大きい順にならべると 社会全体の蓄積 → 身体の進化ではない → 用具・練習法・栄養 → 語尾。棒の高さを見比べて確かめる。",
      "8点の理由記述の配点。核となる「社会全体の蓄積」に3点が集中しており、ここを落とすと上限5点になる。具体例（用具・練習法・栄養）は三つ挙げてもまとめて2点",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_342: {
    ...
    steps: [
      "よこじくは「指定字数」、たてじくは「入れるべき要素数」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「100字」で5（入れるべき要素数）。",
      "いちばん小さいのは「20字」で1。差は4。",
      "大きい順にならべると 100字 → 80字 → 60字 → 40字 → 20字。棒の高さを見比べて確かめる。",
      "指定字数から逆算した必要要素数。一要素はおよそ15〜20字なので、字数÷18が目安になる。字数制限は制限ではなく「要素をいくつ入れよ」という設計図である",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_343: {
    ...
    steps: [
      "よこじくは「答案の部分」、たてじくは「使う字数」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「前提・状況」で17（使う字数）。",
      "いちばん小さいのは「語尾」で5。差は12。",
      "大きい順にならべると 前提・状況 → 直接の原因 → 核となる内容 → 語尾。棒の高さを見比べて確かめる。",
      "六十字型（要素3つ）の字数配分。17×3＋語尾5＝56字で、指定60字の約93%に収まる。語尾が5字を占めることを設計の段階で差し引いておく",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_344: {
    ...
    steps: [
      ...
      "この数直線は30から70まで、5きざみで目もりがふってある。",
      "色のついた範囲は 51以上 かつ 60以下。●はその数をふくみ、○はふくまない。",
      "印がついているのは 85%、60字、程度の上限。位置を目もりで確かめる。",
      "「六十字」の指定に対する安全圏。上の帯＝「60字以内」で狙う51〜60字、下の帯＝「60字程度」の許容54〜66字。どちらの形式でも51〜60字に収めれば違反にならない",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_346: {
    ...
    steps: [
      "よこじくは「削る対象」、たてじくは「削る優先度（高いほど先に削る）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「冗長表現」で5（削る優先度（高いほど先に削る））。",
      "いちばん小さいのは「核の要素」で0。差は5。",
      "大きい順にならべると 冗長表現 → 程度副詞 → 具体例 → 対比の片側 → 核の要素。棒の高さを見比べて確かめる。",
      "字数超過時に削る順序。冗長表現から削れば要素を失わずに二〜三割減らせる。核の要素と語尾は優先度0＝絶対に削らない。末尾から機械的に消すと核と語尾を同時に失う",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_348: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「比較・選択の負担 3点」で、全体のおよそ37.5%。",
      "内わけは 情報量が増加 2点 25%、比較・選択の負担 3点 37.5%、選ぶのをやめる 2点 25%、語尾 1点 12.5%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "実際の採点基準表を円グラフにしたもの。合計8点。要素を一つ書けば必ずその分が加点される（減点法ではない）ので、白紙は必ず0点、一要素書けば2〜3点になる",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_350: {
    ...
    steps: [
      "よこじくは「要素の種類」、たてじくは「配点（点）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「必須（抽象語の言いかえ）」で3（配点（点））。",
      "いちばん小さいのは「加点（具体例）」で1。差は2。",
      "大きい順にならべると 必須（抽象語の言いかえ） → 必須（否定・対比） → 加点（具体例） → 加点（きっかけ） → 語尾。棒の高さを見比べて確かめる。",
      "8点問題における必須要素と加点要素の配点差。書きやすい具体例は1点、書きにくい抽象語の言いかえが3点。字数を具体例に使うと点が伸びない理由がここにある",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_351: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「核の要素 3点」で、全体のおよそ37.5%。",
      "内わけは 核の要素 3点 37.5%、補助の要素 2点 25%、補助の要素 2点 25%、語尾 1点 12.5%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "8点問題の標準構成。核が満点の約38%を占めるので、核を落とすと上限は5点になる。逆に「核＋語尾」だけの短い答案でも4点は確保できる",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_353: {
    ...
    steps: [
      "よこじくは「採点項目」、たてじくは「点（左＝配点／得点）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「②能力を失う 配点4」で4（点（左＝配点／得点））。",
      "いちばん小さいのは「②得点」で0。差は4。",
      "大きい順にならべると ②能力を失う 配点4 → ③自覚がない 配点2 → ③得点 → ①便利な道具 配点1 → ①得点 → ②得点。棒の高さを見比べて確かめる。",
      "自己採点の実例。配点（濃い青）と自分の得点を項目ごとに並べる。②だけが0点＝比喩「支払い」を「損」と置きかえて中身を書かなかったことが特定できる。8点満点中4点",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_355: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「方言＝出身を開く 3点」で、全体のおよそ37.5%。",
      "内わけは 標準語は背景を隠す 2点 25%、方言＝出身を開く 3点 37.5%、親しみでなく自己開示 2点 25%、語尾 1点 12.5%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "理由記述の配点。直接の原因（標準語が背景を隠す）は2点だが、橋渡しにあたる「方言を話すこと＝出身を開くこと」が3点で最も重い。直接の原因だけでは半分に届かない",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_357: {
    ...
    steps: [
      "よこじくは「答案に入れる要素」、たてじくは「配点（点）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「説明文：論理の核」で3（配点（点））。",
      "いちばん小さいのは「説明文：対比」で2。差は1。",
      "大きい順にならべると 説明文：論理の核 → 小説：心情 → 説明文：対比 → 説明文：主張 → 小説：出来事 → 小説：手がかり。棒の高さを見比べて確かめる。",
      "同じ8点の理由記述でも、説明文は論理の核に3点、小説は心情に3点が置かれる。説明文で心情語を使い、小説で心情語を落とすと、どちらも核の3点を失う",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_359: {
    ...
    steps: [
      "よこじくは「傍線部の部品」、たてじくは「配点（点）」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「②何を変えてはならないか」で3（配点（点））。",
      "いちばん小さいのは「④営みである」で1。差は2。",
      "大きい順にならべると ②何を変えてはならないか → ③毎回選び直す → ①変えないことではない → ④営みである → 語尾。棒の高さを見比べて確かめる。",
      "長い傍線部を部品に分けたときの配点（合計10点）。副詞「毎回」が示す継続性③にも3点が置かれている。部品を一つ落とすと2〜3点が丸ごと消えるので、切ってから訳す",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_362: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「心情語 3点」で、全体のおよそ37.5%。",
      "内わけは 孤独だった（対比）2点 25%、ノートを渡された 2点 25%、心情語 3点 37.5%、語尾「〜気持ち。」1点 12.5%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "心情記述8点の配点。きっかけ（出来事）で4点、心情そのもので3点。片方だけでは半分になる。心情語が一語も入っていなければ、3点が丸ごと付かない",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_364: {
    ...
    steps: [
      "よこじくは「答案の部分」、たてじくは「使う字数」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「後の心情」で26（使う字数）。",
      "いちばん小さいのは「語尾」で5。差は21。",
      "大きい順にならべると 後の心情 → きっかけ → 前の心情 → 語尾。棒の高さを見比べて確かめる。",
      "七十字で心情変化を書くときの字数配分（18＋21＋26＋5＝70字）。後の心情を最も厚くする。三要素はほぼ均等配点なので、一つ落とすと得点は三分の二になる",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_371: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から40まで、5きざみで目もりがふってある。",
      "色のついた範囲は 0以上 かつ 5以下。●はその数をふくみ、○はふくまない。",
      "印がついているのは 一語、一〜二文節、主語＋述語、一文の一部。位置を目もりで確かめる。",
      "抜き出しの指定字数から逆算する「探すべき長さの単位」。五字以内なら一語、十字前後なら一〜二文節、二十字前後なら主語＋述語のかたまり、二十五字以上なら一文の一部を切り取る",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokokokugoext10_373: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「主述のねじれ」で、全体のおよそ35%。",
      "内わけは 主述のねじれ 35%、指示語を残す 25%、冗長・重複 20%、語尾の不一致 15% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "記述で表現面の減点を受ける原因のおおよその割合。最多は主述のねじれで、六十字を超える答案で起きやすい。いずれも書いた直後の十五秒チェックで防げるものばかりである",
    ],
    buildSteps: 4,
  },
};
