...
export const gradeKoushikiOyoK1GodoQuestions: Question[] = [
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】長方形ABCDを対角線BDで折り返し頂点CがEに移るとき、辺ABと線分DEの交点Fについて△FBDが二等辺三角形であることの証明。\n【なぜその式なのか】折り返しは角の大きさを変えないので∠BDC=∠BDE。長方形のAB∥DCから錯角∠ABD=∠BDC。この2つを合わせると∠BDE=∠ABDとなり、FがAB上・DE上にあることからこれがそのまま∠FDB=∠FBDになる。2つの底角が等しいので二等辺三角形の性質の逆よりFB=FD。\n【ステップ1】折り返しより∠BDC=∠BDE。AB∥DCの錯角より∠ABD=∠BDC。\n【ステップ2】2つを合わせて∠BDE=∠ABD。Fの位置よりこれは∠FDB=∠FBD。\n【ステップ3】二等辺三角形の性質の逆より、等しい底角の向かいの辺FD=FB。\n【答え】折り返し（対称移動）は角の大きさを変えないから ∠BDC＝∠BDE …①　長方形なのでAB∥DCであり、BDを横断線とみると、錯角は等しいから ∠ABD＝∠BDC …②①、②より ∠BDE＝∠ABD …③　Fは辺AB上の点だから ∠FBD＝∠ABD …④　Fは線分DE上の点だから ∠FDB＝∠BDE …⑤③、④、⑤より ∠FDB＝∠FBD　2つの底角が等しいから、二等辺三角形の性質の逆より、FB＝FD。よって△FBDは二等辺三角形である。\n【確かめ】折り返し前後で△BCD≡△BEDが合同であり、対応する角がすべて等しいことを確認する。\n【よくあるまちがい】折り返しでできる角の等しさ（∠BDC=∠BDE）を使わずに証明を進めようとしてしまう。\n【ここが絶対】折り返し（対称移動）は角の大きさを変えない。この性質と平行線の錯角を組み合わせて角の等しさをつなげる。',
    rubricPoints: [
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】AB=ACの二等辺三角形（∠BAC=36°）で、辺AC上にBD=BCとなる点Dをとるときの∠ABD。\n【なぜその式なのか】まず二等辺三角形ABCの底角を求める。次にBD=BCの二等辺三角形BDCの底角∠BDCを求め、これが△ABDの外角にあたることから、外角の性質（外角＝となり合わない2つの内角の和）を使って∠ABDを逆算する。\n【ステップ1】∠ABC=∠ACB=(180−36)÷2=72°。△BDCも二等辺三角形なので∠BDC=∠BCD=72°。\n【ステップ2】△BDCの内角の和より∠DBC=180−72−72=36°。\n【ステップ3】∠BDCは△ABDの外角なので∠BDC=∠BAD+∠ABD。∠BAD=∠BAC=36°（DはAC上）。72=36+∠ABD、∠ABD=36°。\n【答え】36°\n【確かめ】△ABDの内角の和で確認すると∠BAD(36)+∠ABD(36)+∠ADB(108、180−72)=180で一致する。\n【よくあるまちがい】∠BDCが△ABDの外角であることに気づかず、遠回りな計算をしてしまう。\n【ここが絶対】直線上に並ぶ点で作られる角は、三角形の外角の性質（外角＝となり合わない2つの内角の和）を使うと素早く求まる。',
