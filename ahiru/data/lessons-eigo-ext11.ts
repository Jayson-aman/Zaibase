...
export const eigoExt11Lessons: Lesson[] = [
  //  1. 読解の基本姿勢（s386〜s388） 
  {
    ...
    intro: '長文を最初から丁寧に読み、読み終えてから設問を見る——多くの人がこの順で解いています。ところが本文の内容はもう頭から消えていて、結局もう一度読み直すことになります。先に設問を読むだけで、読む目的がはっきりします。',
    order: 886,
    studyPeriod: '小5後半',
    targetLevel: 'kiso',
    keyPoints: [
...
★ ポイント：(2)のように On Sunday と本文に書いてあるとき、その前後は「ふだんの日」ではなく「日曜日だけの行動」である。曜日・季節・時を表す語は、本文の内容が切りかわる合図になる。`,
...

  {
    ...
    intro: '英文を「わたしは 昨日 買った 本を 読んだ」と日本語の順に組み直して読んでいませんか。この読み方は時間が二倍かかり、長い文ほど途中で迷子になります。英語は前から順に、かたまりのまま理解できます。読み方を切りかえます。',
    order: 887,
    studyPeriod: '小5後半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：区切りすぎもよくない。a small restaurant を a ／ small ／ restaurant のように切ると、かえって意味がつながらない。「1つのまとまった意味」になる長さで切ること。`,
      ...
      {
        heading: 'なぜ前から読めるのか、なぜ切れ目が4か所なのか',
        mangaId: 'eigo_s387_manga',
        body: `英語は「中心の語を先に言い、説明をあとから足す」ことばです。The boy（少年は）→who is playing（弾いている）→under the tree（木の下で）→in the park（公園の）→is my brother（兄だ）と、**情報が出てくる順に足していけば意味がつながる**ようにできています。日本語の順に並べ直すと、右端から左へ戻る往復が必要になり、長文では数百回になります。返り読みは時間が二倍かかるだけでなく、戻っている間に前の内容を忘れて迷子になります。

切れ目が前置詞・関係代名詞・接続詞・カンマの前なのは、これらの語が**「ここから説明を足します」という合図**だからです。前置詞は場所や時の説明、関係代名詞は名詞の説明、接続詞（that・when・because）は新しい文の始まり。told me that の that を見たら「ここから別の主語と動詞が始まる」と考えれば、lived の主語が his grandmother だとすぐ分かります。

■ 確かめのしかた
①英文にスラッシュを入れる：**前置詞の前・関係代名詞の前・接続詞の前・カンマ**。My father told me ／ that his grandmother lived in a house ／ like that.
②切ったかたまりを**前から順に日本語で足す**。「父は私に言った→祖母が家に住んでいたと→そんな家に」。戻らない。
③that のあとに主語と動詞のセットがもう一つあるか。told の主語と lived の主語を分けて言えるか。
④切りすぎていないか。a small restaurant は一つのまとまり。Its のような代名詞は、直前の名詞のかたまりの中で「意味が通る語」を指す（Its roof→屋根があるのは farmhouse）。

★ ここがポイント：英語は**情報が出た順に足せばつながる**ので前から読む。切れ目は**前置詞・関係代名詞・接続詞・カンマ**という「ここから説明」の合図。that のあとは主語と動詞をもう一組数える。`,
      },
    ],
    trapExamples: [
      {
...

  {
    ...
    intro: '入試の長文には、知らない単語が必ず数個まぎれています。全部わかるようには作られていないのです。そこで止まってしまうと最後まで読めません。飛ばしてよい語と、飛ばしてはいけない語の見分け方を身につけます。',
    order: 888,
    studyPeriod: '小5後半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：hibernate（動詞）と hibernation（名詞）は形がちがうだけで同じ内容。-tion で終わる語は名詞だと知っておくと、品詞のちがいで混乱しなくなる。`,
  ...
  //  2. 主語と動詞を見つける（s389〜s392） 
  {
    ...
    intro: '一行以上ある長い文を前にすると、どこから手をつけてよいか分からなくなります。しかしどんな文にも「だれが・どうする」の骨組みが必ず一組あり、残りはすべて飾りです。まず二語を見つける——それだけで文は立ち上がります。',
    order: 889,
    studyPeriod: '小5後半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：③の works は who の動詞であって、文全体の動詞ではない。1つの文に動詞が2つ以上あるときは、接続詞や関係代名詞（who・which・that・when・because）が必ずそばにある。それが「おまけの文」の目印である。`,
...

  {
    ...
    intro: 'The boy playing the piano over there is my brother. どれが動詞か分かりますか。playing に見えて、実は is です。主語のうしろに説明がくっついて長くなっているだけ。かたまりを外して骨組みを取り出す練習をします。',
    order: 890,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
★ ポイント：どの型でも、外すべきかたまりは「名詞の直後から、文全体の動詞の直前まで」である。だから「次に出てくる動詞」をさがせば、主語の終わりが自動的に決まる。`,
...

  {
    ...
    intro: '一つの文の中に「主語＋動詞」が二組あることがあります。そんなときは、必ずどこかにつなぎ役の語がひそんでいます。and・because・when・who・which、そしてカンマ。この目印を見つければ、長い文も割って読めます。',
    order: 891,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：I think that … の that は省略されることが非常に多い。I think he is right. のように that がなくても、think のあとに主語＋動詞が続いていれば「〜ということ」だと判断する。`,
...

  {
    ...
    intro: '名詞のうしろに、前置詞句・ing・過去分詞・to不定詞・関係代名詞のどれかがくっついて説明する——英語の後ろからの修飾は、この五つに集約されます。形はちがって見えても、はたらきは全部同じ。まとめて処理できるようにします。',
    order: 892,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：a sleeping baby（眠っている赤ちゃん）のように、-ing が1語だけのときは名詞の前に置く。a baby sleeping in the bed のように2語以上になると後ろへ移る。位置は「語数」で決まる。`,
  ...
  //  3. 代名詞の指示内容をたどる（s393〜s396） 
  {
    ...
    intro: '英語は同じ名詞をくり返すのをきらい、二度目からは代名詞に変えます。そのぶん読み手のほうが「これは何を指すのか」をたどらなければなりません。入試で下線が引かれるのもここです。指示内容をたどる手順を作ります。',
    order: 893,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：she eats them の she を Yuki だと考えると「ユキがニンジンを毎朝食べる」になってしまう。直前が Coco likes carrots very much なので、and でつながれた後半の主語も Coco である。and でつながれた文は、前半と同じ主語のことを話し続けていることが多い。`,
...

  {
    ...
    intro: '下線の it が指すものをさがすとき、段落の最初まで戻っていませんか。答えはたいてい直前の一、二文の中にあります。しかも単数か複数か、人か物かで候補はさらにしぼれます。遠くを探す前に、確かめる順番を決めます。',
    order: 894,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：代名詞が後ろの名詞を指す形（When he came home, Ken was very tired.）もまれにあるが、中学入試ではほとんど出ない。まず前を探すこと。`,
...

  {
    ...
    intro: '指示語の答えが、名詞一語では書けないことがあります。this や that は、前の文まるごとの内容を指すことがあるからです。そのときの答えは「〜すること」の形でまとめます。内容を指す指示語の見分け方を学びます。',
    order: 895,
    studyPeriod: '小6前半',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：both sides（両方の側）とは「客と店」のこと。数を表す語（both／each／all）が出たら、何と何を指すのかを必ず確かめる。`,
...

  {
    ...
    intro: 'I lost my pen, so I bought a new one. の one を it に変えると、なくしたペンをもう一度買ったことになってしまいます。it は同じもの、one は同じ種類の別のもの。この一線を知らないと、細部を問う設問で落とします。',
    order: 896,
    studyPeriod: '小6前半',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：some … others … は「一部は〜、別の一部は〜」の意味。Some students like math, and others like English. の others は「（生徒のうちの）ほかの人たち」で、全員ではない。`,
  ...
  //  4. つなぎ語から展開を読む（s397〜s400） 
  {
    ...
    intro: '筆者がいちばん言いたいことは、どこに書かれているでしょうか。実は but や however の直後にあることがほとんどです。前の内容をわざわざひっくり返してまで書くのですから、そこが主張なのです。設問もそこから作られます。',
    order: 897,
    studyPeriod: '小6前半',
    targetLevel: 'moshi',
    keyPoints: [
...
★ ポイント：Of course（もちろん）／It is true that（たしかに〜だ）のあとには、必ず But や Still が続く。「いったん認めてから、しかし」と展開するのが説明文の定番である。`,
...

  {
    ...
    intro: 'for example のあとに続く長い部分を、必死に読み込んでいませんか。具体例は主張ではありません。読むべきなのは、その例が支えている前の一文のほうです。例のかたまりを見抜いて、素早く戻る読み方を身につけます。',
    order: 898,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：数字（about 100 yen a month）は例の中にあるが、設問ではよく問われる。「例は要旨には書かないが、細かい内容を問う設問では答えになる」という二面性を意識する。`,
...

  {
    ...
    intro: '「なぜですか」と問われて、見つけた文をそのまま抜き出したら不正解——よくある失敗です。because のうしろが原因、so のうしろが結果と、向きが正反対だからです。取りちがえない読み方をここで確かめます。',
    order: 899,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：日本語で答えるときは「〜から。」「〜ため。」で結ぶ。英語で答えるときは Because ＋主語＋動詞 の形にし、主語を代名詞に直す（Because he had a high fever.）。`,
...

  {
    ...
    intro: '「筆者があげている理由をすべて答えなさい」という設問では、数え落としが命取りになります。手がかりは first・second・finally・also といった語です。これらに印をつけていけば、いくつ並んでいるか一目で分かります。',
    order: 900,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：In short（要するに）／In conclusion（結論として）のあとは、それまでの内容をまとめた文である。要旨問題の答えがそのまま書かれていることが多いので、見つけたら必ず線を引く。`,
  ...
  //  5. 段落の主題文を見つける（s401〜s403） 
  {
    ...
    intro: '段落は文がたくさん並んでいるように見えますが、言いたいことは一つだけです。それを書いた一文を主題文といい、多くは段落の先頭にあります。残りの文は、その一文を支える材料。読む重さを変えると読解は速くなります。',
    order: 901,
    studyPeriod: '小6前半',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：この段落の要旨を「盲導犬は目の不自由な人を助ける」と書くと不正解。それは3つの例のうちの1つにすぎない。要旨は必ず「全部の例をふくむ広さ」でなければならない。`,
...

  {
    ...
    intro: '主題文を支える文には、理由・具体例・数字・体験の四種類があります。どれがいくつ並んでいるかを数えると、段落の作りがそのまま見えてきます。とくに数字は設問になりやすいので、見つけたら必ず印をつけます。',
    order: 902,
    studyPeriod: '小6後半・直前',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：instead of 〜ing（〜するかわりに）は入試頻出。go to bed early instead of studying until midnight は「夜中まで勉強するかわりに早く寝る」。instead of の後ろは名詞か -ing 形になる。`,
...

  {
    ...
    intro: '一文目を読んでも主張が見当たらない段落があります。具体例や問いかけから始めて、結論を最後に置く型だからです。So や Therefore で始まる最後の文が、その段落の中心になります。二つの型を見分けられるようにします。',
    order: 903,
    studyPeriod: '小6後半・直前',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：メモに具体例や数字を書かないこと。「①ペットボトルは年間4000億本作られる」のように数字を書くと、メモが段落の一部の情報になってしまい、全体像がわからなくなる。数字は本文に線を引くだけでよい。`,
      ...
      {
        heading: 'なぜ結論を最後に置く段落があり、なぜメモは日本語で短く書くのか',
        mangaId: 'eigo_s403_manga',
        body: `書き手が問いかけ・体験・意外な数字から段落を始めるのは、**読者を引きこんでから結論を言いたい**からです。「昆虫は何種類いるか知っていますか」と問い、100万種という数字で驚かせ、森が切られると消えると示したあとで、This means that 〜（これは〜を意味する）と主張を置く。だから1文目が例や問いかけなら、主題文は最後にあります。So・Therefore・In this way・This means that は「ここまでをまとめます」という合図です。

段落ごとのメモを日本語で10〜20字にするのは、メモの目的が**「その段落が何の話か」を思い出すこと**だからです。英語で書くと書くこと自体に時間を取られ、数字を入れると段落の一部の情報になって全体像がぼやけます。設問「海の生き物への影響はどの段落か」に一瞬で答えるには、段落全体をおおう広さのメモが要ります。数字は本文に線を引いておけば、メモで段落を特定してから見に行けます。

■ 確かめのしかた
①1文目が**問いかけ・体験・意外な事実・数字**なら、最後の1文を見る。So／Therefore／This means that／We should があれば主題文。
②見つからなければ However のあと。探す順は「1文目→最終文→However の後ろ」。
③段落を読み終えるたびに**日本語で10〜20字、主語と述語のある形、段落番号つき**でメモする。数字は書かず本文に線。
④設問に対応させる：内容一致→メモで段落を決めて読み返す。要旨・タイトル→メモをつないで一文に。段落の要旨→そのメモ。

★ ここがポイント：問いかけや例から始まる段落は**読者を引きこんでから結論を置く**ので、主題文は最後（So・This means that）。メモは**段落が何の話かを思い出すため**なので、日本語で短く、数字は入れない。`,
      },
    ],
    trapExamples: [
      {
  ...
  //  6. 物語文の読解（s404〜s407） 
  {
    ...
    intro: '物語文でまず起こる事故は、登場人物の取りちがえです。だれが何人いるのかを確定しないまま読み進めると、気持ちも行動も混ざってしまいます。人物・時・場所を最初の数文でおさえる読み方から始めます。',
    order: 904,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：英語では「〜と言った」の部分がせりふの前に来ることも後ろに来ることもある。Ken said, "Let's go." と "Let's go," said Ken. はどちらも正しく、意味は同じである。said Ken のように動詞が主語より前に来ても、主語は Ken である。`,
      ...
      {
        heading: 'なぜ最初の3文で人物・時・場所を確定するのか、なぜ said Ken の主語が Ken なのか',
        mangaId: 'eigo_s404_manga',
        body: `英語の物語文は、最初の2〜3文に「だれが・いつ・どこで」をまとめて書くのがふつうです。ここで登場人物の数と関係（my sister Yuki・her friend Ken）を確定しておかないと、あとで he・she が出たときにだれを指すか決められず、気持ちも行動も混ざります。説明文の「主題文を探す」読み方が物語文に使えないのは、物語には主張がなく、**出来事の流れそのものが内容**だからです。

"Let's go," said Ken. で主語が Ken なのは、これがせりふのあとに「〜と言った」を置くときの**決まった語順の入れかえ**だからです。意味は Ken said, "Let's go." と同じです。代名詞のときは入れかえず he said とします。he・she が出たら、**性別**と**会話が交互に入れかわるリズム**の二つで話し手を決めます。

■ 確かめのしかた
①最初の3文で、**人名に○、時を表す語に□、場所に下線**を引く。人物が何人いるかを言えるか。
②人物の関係を表す語（my sister 〇〇、her friend 〇〇、a boy named 〇〇）から関係をつかむ。
③せりふのあとの asked Ken／Mika answered／said Ken で話し手を決める。代名詞なら性別（he＝男性）と交互のリズムで確かめる。
④shouted・whispered・cried は気持ちの手がかり。せりふの横に話し手の頭文字を書きこむ。

★ ここがポイント：物語文は**出来事の流れが内容**なので、最初の3文で**人物・時・場所を確定**してから追う。said Ken は**語順を入れかえた決まった形**で主語は Ken、代名詞は性別と交互のリズムで決める。`,
      },
    ],
    trapExamples: [
      {
...

  {
    ...
    intro: '物語は、出来事が順に並んでいるだけではありません。ある出来事が次の出来事を引き起こす、という「だから」の関係でつながっています。過去形の動詞を追いかけながら、その原因と結果のつながりをつかむ練習をします。',
    order: 905,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
★ ポイント：Since that day（あの日以来）／From that time on（そのときから）は、物語の締めくくりの決まり文句。見つけたら必ず線を引く。`,
...

  {
    ...
    intro: '書かれている順と、実際に起こった順がちがう文章があります。今の場面から始めて過去を思い出す、回想という書き方です。three years ago や later といった時のことばを全部ぬき出して、正しい順に並べ直します。',
    order: 906,
    studyPeriod: '小6後半・直前',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：過去のさらに前の出来事は had ＋過去分詞（過去完了）で表す。難関校では出るので、had left＝「（そのときより前に）出てしまっていた」と読めるようにしておく。`,
...

  {
    ...
    intro: '物語文の設問は、結局「どう思ったか」と「なぜそう思ったか」の二つに集まります。しかも気持ちは、glad や sad と直接書かれるとはかぎりません。泣いた、笑った、眠れなかった——行動から読み取る練習をします。',
    order: 907,
    studyPeriod: '小6後半・直前',
    targetLevel: 'nyushi',
    keyPoints: [
...
⚠ 注意：最後の I have never been so glad. は現在完了で「今までに一度もこんなにうれしかったことはない」＝「今がいちばんうれしい」という意味。never を見て「うれしくない」と読まないこと。`,
      ...
      {
        heading: 'なぜ気持ちは行動から読み、なぜ never so がいちばんうれしいになるのか',
        mangaId: 'eigo_s407_manga',
        body: `物語の書き手は、気持ちを glad・sad と直接書くより、**手がふるえた・みんながほほえんだ**という行動や体の様子で示すことを好みます。そのほうが読者が場面を思いうかべられるからです。だから気持ちを問う設問では、気持ちの語を○で囲むだけでなく、行動から気持ちを読み取ります。気持ちが変わった**直前の出来事**がきっかけなのは、心が動くには必ず原因があり、書き手はそれを変化の直前に置くからです。「優勝したから前向きになった」と想像で答えると、本文の did not win と矛盾します。

I have never been so glad. が「これまででいちばんうれしい」になるのは、「こんなにうれしかったことは一度もない」＝「今がいちばん」という**最上級の言いかえ**だからです。never だけを見て「うれしくない」と読むと、結末が逆になります。-ed（surprised）は人がその気持ちになる、-ing（surprising）は物事がその気持ちにさせる、という区別も、主語が人か物事かで決めます。

■ 確かめのしかた
①気持ちの語（glad・sad・worried・nervous・proud・surprised）を○で囲み、**行動や体の様子**（hands were shaking・smiled・could not sleep）も気持ちとして読む。
②気持ちの流れを①→②→③と番号で追い、変わった**直前の文**をきっかけとする。想像（優勝した）で答えていないか、本文と矛盾しないか。
③never＋so／such は**最上級の言いかえ**：I have never seen such a beautiful sunset.＝これまででいちばん美しい。
④-ed は人（I was excited.）、-ing は物事（The game was exciting.）。be surprised at・be interested in・be worried about は前置詞とセット。

★ ここがポイント：書き手は気持ちを**行動や体の様子で示す**ので、行動から読む。きっかけは**変化の直前の出来事**。never so／such は**最上級の言いかえ**（今がいちばん）。`,
      },
    ],
    trapExamples: [
      {
  ...
  //  7. 説明文の読解（s408〜s411） 
  {
    ...
    intro: '「日本の首都は東京だ」と「日本はもっと外国語を教えるべきだ」。前者はだれが調べても同じですが、後者は書き手の考えです。この二つを混ぜて読むと、筆者の主張がぼやけます。見分けるための目印を覚えます。',
    order: 908,
    studyPeriod: '小6後半・直前',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：Of course, paper is useful, and we cannot live without it. は、いったん相手の言い分を認める文（ゆずり）である。この文だけを取り出して「筆者は紙をどんどん使うべきだと考えている」とするのは誤り。次の However を必ず見ること。`,
...

  {
    ...
    intro: '説明文でよく出るのは、二つのものを並べて比べる型です。ところが「AはBより大きい」を読みまちがえ、逆に取ってしまう答案が後を絶ちません。than のうしろが比べる相手——この一点をここで確実にします。',
    order: 909,
    studyPeriod: '小6後半・直前',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：human（8時間）は基準として先に出されているだけで、どちらのグループでもない。基準になるものと、比べられるものを混同しないこと。`,
...

  {
    ...
    intro: '「〜には三種類ある」と書かれていたら、そのあと必ず三つ並びます。一つ目、二つ目までは拾えても、三つ目を落とす答案が目立ちます。one・another・the other の使い分けもあわせて整理します。',
    order: 910,
    studyPeriod: '小6後半・直前',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：日本語の「〜以上」は、その数をふくむ。英語の more than 6,000 は 6,000 をふくまない（6,000より多い）。細かい違いだが、算数と組み合わせた問題では差が出る。`,
...

  {
    ...
    intro: '文章全体で筆者が言いたいことは、たいてい最後の段落にあります。とくに In conclusion や We should で始まる文が目印です。問題提起から提案へ、という説明文の流れを知っておくと、探す場所が決まります。',
    order: 911,
    studyPeriod: '小6後半・直前',
    targetLevel: 'nyushi',
    keyPoints: [
...
⚠ 注意：最後の文の not only for us but also for the people who will live after us（私たちのためだけでなく、これから後に生きる人々のためでもある）は、主張に「未来の人のため」という広がりを与えている部分である。要旨をまとめるときは入れなくてもよいが、内容一致問題ではここが選択肢になりやすい。`,
  ...
  //  8. 図表・グラフつき読解（s412〜s415） 
  {
    ...
    intro: 'グラフつきの英文で、いきなり本文から読み始めていませんか。先に表題とたて軸・よこ軸・単位を確かめるほうが速く解けます。the most popular はいちばん高い棒、came second は二番目。表現と棒を対応させます。',
    order: 912,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：Mr. Tanaka がおどろいた理由は、グラフではなく英文にしか書かれていない。グラフだけ見て答えを出そうとすると必ず落とす。`,
...

  {
    ...
    intro: '「増えた」を表す英語は go up・rise・increase といくつもあり、「減った」も同じだけあります。折れ線の山と谷を、この語群と結びつけて読むのが図表読解です。変化のはげしさを表す語まで押さえておきます。',
    order: 913,
    studyPeriod: '小6後半・直前',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：In fact,（実際に）は前の文を補強する語。tests are held in July and in September が、7月と9月に利用が多い理由を裏づけている。「9月に増えた理由」を問われたらこの文を使う。`,
...

  {
    ...
    intro: '円グラフの割合は、足すと必ず百パーセントになります。合わなければどこかで読みちがえています。しかも入試では「では何人か」と人数に直させる問題がよく出ます。half や twice といった割合の表現も確かめます。',
    order: 914,
    studyPeriod: '小6後半・直前',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：most of them の them は train を使う10パーセントの生徒を指す。「生徒の大部分」ではなく「電車通学の生徒の大部分」である。この取りちがえは頻出。`,
...

  {
    ...
    intro: '時刻表の問題を頭の中だけで計算して、待ち時間を数え落とす——よくある失点です。乗車時間、歩く時間、待ち時間をすべて足す必要があります。料金表では大人と子ども、平日と週末といった条件の行も見落とせません。',
    order: 915,
    studyPeriod: '小6後半・直前',
    targetLevel: 'nyushi',
    keyPoints: [
...
⚠ 注意：The museum opens at ten. という情報も条件の1つ。もし 9:20 に着いてしまうと博物館はまだ開いていない。この一文があるおかげで、8:30 の便がさらに不適切だとわかる。図表つき読解では、一見関係なさそうな1文が条件になっていることが多い。`,
  ...
  //  9. 会話文の読解（s416〜s420） 
  {
    ...
    intro: '電話の会話文では、まず話しているのがだれとだれかを確定します。This is Ken speaking. のように、電話でしか使わない決まった言い方があるからです。取り次ぎや伝言の場面も同じ。定型を知れば一気に読みやすくなります。',
    order: 916,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：会話の中に2つの時刻（six／nine／nine thirty）が出てくる。それぞれ何の時刻かを区別する。six はミカが帰る時刻で、待ち合わせとは関係ない。`,
...

  {
    ...
    intro: '買い物の会話では、店員と客のどちらのせりふかを取りちがえると、答えが全部ずれます。May I help you? は店員、I am looking for … は客です。値段と個数の計算も出るので、数字にも印をつけながら読みます。',
    order: 917,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：The price is the same.（値段は同じ）という一文があるので、大きいサイズにしても1,200円のままである。この一文がないと、大きいサイズは高いのではないかと迷うことになる。会話文の細かい一文が計算の条件になっている。`,
...

  {
    ...
    intro: '道案内の会話文には、たいてい地図がついています。曲がるたびに指でたどらず頭の中だけで解くと、右と左が入れかわってしまいます。Turn right や on your left を地図の上で動かしながら、目的地を確定させます。',
    order: 918,
    studyPeriod: '小6後半・直前',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：最後の If you walk past the post office 〜, you'll find the library. は「行きすぎた場合」の説明であって、目的地の道順ではない。But you don't need to go that far.（そこまで行く必要はない）という一文で、これが余分な情報だとわかる。`,
      ...
      {
        heading: 'なぜ地図に書きこみ、なぜ最初の発言に戻るのか',
        mangaId: 'eigo_s418_manga',
        body: `道案内の会話には Turn right・on your left のように向きの語が何度も出ます。向きは**歩く人から見たもの**なので、地図の上で進行方向が変わるたびに右と左の意味が変わります。頭の中で回転させると必ずどこかで入れかわるので、出発点から指でたどり、曲がるたびに印をつけます。block が「建物」ではなく「交差点から次の交差点までの区画」なのは、英語の block が町を道で区切ったひとつのかたまりを指す語だからです。two blocks は角を二つ通り過ぎた所です。

目的地を答えるときに最初の発言に戻るのは、会話文では**最初の1〜2文に話題が書かれる**からです。あとから出る the library は「行きすぎた場合」の説明で、But you don't need to go that far. がそれを示しています。最後に出た語を答えにするのは典型的な誤りです。

■ 確かめのしかた
①出発点と向きを確認し、Go straight for 〇 blocks で角を数え、Turn 〇 で向きを変え、on your 〇 で位置を決める。**曲がるたびに指でたどる**。
②block は**交差点の区画**。two blocks＝2つ目の角まで。
③「何を探しているか」は**最初の発言**（Could you tell me how to get to the post office?）に戻る。最後に出た建物を答えにしない。
④聞き手のくり返し（Two blocks. All right.）は大事な情報の目印。「〜する必要はない」と断られた情報は目的地の道順ではない。

★ ここがポイント：向きは**歩く人から見たもの**なので、地図の上で指でたどる。block は**交差点の区画**。目的地は**最初の発言**にあり、最後に出た語で答えない。`,
      },
    ],
    trapExamples: [
      {
...

  {
    ...
    intro: 'レストランの会話には、決まったやりとりの順序があります。注文を聞かれ、選び、追加をたずねられ、最後に会計です。For here or to go? のような、その場面にしか出ない表現も多いので、型ごと覚えてしまいます。',
    order: 919,
    studyPeriod: '小6後半・直前',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：The last order is at eight thirty. は「注文できる最後の時刻」であって閉店時刻ではない。閉店は9時。似た2つの時刻が出てきたら、それぞれ何の時刻かを書き分ける。`,
...

  {
    ...
    intro: '空所に入る発言を選ぶ問題で、前のせりふだけを見て決めると必ず外します。手がかりは、空所のうしろにもあるからです。返事が Yes なら空所は疑問文、Sure. なら依頼か提案。後ろから決める解き方を身につけます。',
    order: 920,
    studyPeriod: '小6後半・直前',
    targetLevel: 'nyushi',
    keyPoints: [
...
⚠ 注意：選び終わったら、必ず空所に入れて最初から読み直すこと。1か所だけ見て決めると、残りの選択肢が入らなくなることがある。`,
  ...
  //  10. 未知語の意味を文脈から推測する（s421〜s423） 
  {
    ...
    intro: '知らない単語 unhappy に出会っても、happy が分かれば意味は見当がつきます。un- が反対の意味を作るからです。英語の単語は部品の組み合わせでできていて、その部品を知っていれば初めて見る語も推測できます。',
    order: 921,
    studyPeriod: '小6後半・直前',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：接尾辞から品詞がわかると、その語を飛ばしても文の構造がつかめる。The invention changed the world. の invention を知らなくても、-tion なので名詞＝主語だとわかり、「何かが世界を変えた」と読める。`,
...

  {
    ...
    intro: '語の作りから見当がつかないときは、まわりの文が助けになります。言いかえ・対比・例示・原因結果——この四つの手がかりのどれかで、筆者はたいてい意味を補ってくれています。その手がかりの見つけ方を練習します。',
    order: 922,
    studyPeriod: '小6後半・直前',
    targetLevel: 'nyushi',
    keyPoints: [
...
⚠ 注意：increasing（増えている）を「減っている」と読みちがえると、However（しかし）の意味が通らなくなる。「山あいの村は空気がきれい。しかし、その村でも車の数が増えている」という流れになって初めて However が生きる。つなぎ語と語の意味は、たがいに手がかりになる。`,
...

  {
    ...
    intro: '意味が分からなくても、その語が名詞か動詞かさえ分かれば読み進められます。名詞なら「何か」、動詞なら「何かをする」と置きかえればよいからです。a や the のうしろは名詞、といった形の手がかりを使います。',
    order: 923,
    studyPeriod: '小6後半・直前',
    targetLevel: 'nyushi',
    keyPoints: [
...
⚠ 注意：飛ばすかどうかは「その語が設問に関係するか」でも決まる。設問に survive という語が出ていたら、必ず意味を確定させる。まず設問を先読みしておくのは、このためでもある。`,
  ...
  //  11. 内容一致問題・要旨把握（s424〜s425） 
  {
    ...
    intro: '内容一致問題の選択肢は、本文の語をそのまま使ってはくれません。言いかえてあるので、見た目の一致だけで選ぶと引っかかります。しかも誤答の作り方には型があります。言いすぎ、すりかえ——その型を先に知っておきます。',
    order: 924,
    studyPeriod: '小6後半・直前',
    targetLevel: 'nyushi',
    keyPoints: [
...
⚠ 注意：a few（少しはある）と only a few（ごくわずかしかない）と few（ほとんどない）は意味の強さがちがう。本文の only a few を「けっこういる」と読むと、イを選んでしまう。`,
      ...
      {
        heading: 'なぜ正解は言いかえてあり、なぜ誤答は4つの型で作られるのか',
        mangaId: 'eigo_s424_manga',
        body: `内容一致問題で正解が本文と同じ語で書かれていたら、本文を探すだけで解けてしまい、**意味を理解しているか**を測れません。だから出題者は正解を言いかえ（at night→during the night）、誤答には本文と同じ語をわざと残します。見た目の一致で選ぶと、誤答に引きよせられます。判断は「語が同じか」ではなく「意味が同じか」です。

誤答の作り方が4つの型に決まっているのは、本文の一部を**少しだけ変える**のがもっとも作りやすく、もっとも引っかかるからです。some→all と強める（言いすぎ）、妹→ケンと主語を入れかえる（すりかえ）、常識で正しそうなことを足す（本文にない）、前半だけ本文どおりにする（一部だけ正しい）。型を知っていれば、選択肢の強い語・人名・時・場所に○をつけるだけで、見るべき所が定まります。

■ 確かめのしかた
①設問文の「合うもの」「合わないもの」に線を引く。ここを読みちがえると全部落とす。
②選択肢の**強い語**（all・every・always・never・only・must）と**人名・時・場所・数字**に○をつける。
③本文の該当する1文と突き合わせる。正解は**本文のどの1文に対応するか**を言えるか。語がちがっても意味が同じなら○。
④選択肢は**最後まで読む**。a few（少しある）・only a few（ごくわずか）・few（ほとんどない）の強さのちがいを本文で確かめる。

★ ここがポイント：正解は**意味を測るために言いかえてある**ので、語ではなく意味で照合する。誤答は**言いすぎ・すりかえ・本文にない・一部だけ**の4型で、強い語と人名・時・場所に○をつけて見破る。`,
      },
    ],
    trapExamples: [
      {
...

  {
    ...
    intro: 'タイトル選びでよく起こる失敗は、ある一つの段落だけの内容を選んでしまうことです。逆に、本文に書かれていない大きすぎる一般論も誤りです。せますぎず広すぎない一文をどう決めるか、その基準をはっきりさせます。',
    order: 925,
    studyPeriod: '小6後半・直前',
    targetLevel: 'nyushi',
    keyPoints: [
