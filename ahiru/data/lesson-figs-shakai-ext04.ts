...
export const lessonFigsShakaiExt04: Record<string, Figure> = {
  ...
  lf_shakaiext04_111: {
    ...
    steps: [
      ...
      "いちばん大きいのは「その他 50%」で、全体のおよそ50%。",
      "内わけは 中国 20% 20%、アメリカ 15% 15%、オーストラリア 5% 5%、韓国 5% 5% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "輸出額と輸入額を合わせた「貿易総額」で見ると、日本の最大の貿易相手国は中国、2位はアメリカ（近年のおおよその割合）",
    ],
    buildSteps: 4,
  },
  lf_shakaiext04_111b: {
    ...
    steps: [
      ...
      "いちばん大きいのは「中国」で24.4（兆円）。",
      "いちばん小さいのは「台湾」で4.3。差は20.1。",
      "大きい順にならべると 中国 → アメリカ → オーストラリア → アラブ首長国 → サウジ → 台湾。棒の高さを見比べて確かめる。",
      "日本の輸入相手国（近年の年間輸入額・兆円）。輸入では中国が断然の1位で、資源を売ってくれる国が上位に入る",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_112: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「アジア 55%」で、全体のおよそ55%。",
      "内わけは アジア 55% 55%、北アメリカ 23% 23%、ヨーロッパ 12% 12%、その他 10% 10%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "日本の輸出先を地域別に見ると、半分以上がアジア。「アメリカが最大の相手」という印象より、まずアジア全体が大きいことをおさえる",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_113: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「機械類 37%」で、全体のおよそ37%。",
      "内わけは 機械類 37% 37%、自動車 16% 16%、鉄鋼 4% 4%、自動車部品 4% 4% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "日本の輸出品目（近年のおおよその割合）。機械類と自動車で半分以上をしめる。機械類には半導体等製造装置・電気機器などが含まれる",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_114: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「その他 47%」で、全体のおよそ47%。",
      "内わけは 機械類 25% 25%、原油 10% 10%、液化天然ガス 6% 6%、石炭 5% 5% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "日本の輸入品目（近年のおおよその割合）。1位は原油ではなく機械類。原油・液化天然ガス・石炭の割合は原油価格で大きく上下する",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_115: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「サウジ」で40（%）。",
      "いちばん小さいのは「カタール」で7。差は33。",
      "大きい順にならべると サウジ → アラブ首長国 → クウェート → カタール → その他。棒の高さを見比べて確かめる。",
      "原油の輸入相手国。上位はすべて中東（西アジア）の国で、中東への依存度は約95%にのぼる",
    ],
    buildSteps: 4,
  },
  lf_shakaiext04_115b: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「オーストラリア」で42（%）。",
      "いちばん小さいのは「カタール」で5。差は37。",
      "大きい順にならべると オーストラリア → その他 → マレーシア → ロシア → アメリカ → カタール。棒の高さを見比べて確かめる。",
      "液化天然ガス（LNG）の輸入相手国。原油とちがい1位はオーストラリアで、中東依存度は低い。石炭・鉄鉱石もオーストラリアが1位",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_116: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「米」で98（%）。",
      "いちばん小さいのは「大豆」で6。差は92。",
      "大きい順にならべると 米 → 野菜 → 肉類 → 果実 → 小麦 → 大豆。棒の高さを見比べて確かめる。",
      "品目別の食料自給率。米はほぼ自給できるが小麦・大豆は大部分を輸入。カロリーベースの総合食料自給率は約38%",
    ],
    buildSteps: 4,
  },
  lf_shakaiext04_116b: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「アメリカ」で45（%）。",
      "いちばん小さいのは「オーストラリア」で20。差は25。",
      "大きい順にならべると アメリカ → カナダ → オーストラリア。棒の高さを見比べて確かめる。",
      "小麦の輸入先はアメリカ・カナダ・オーストラリアの3か国でほぼ100%。大豆・とうもろこしもアメリカが最大の相手国",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_117: {
    ...
    steps: [
      "よこじくは「年」、たてじくは「%」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「2020」で62（%）。",
      "いちばん小さいのは「1960」で23。差は39。",
      "大きい順にならべると 2020 → 2000 → 1990 → 1960 → 1980。棒の高さを見比べて確かめる。",
      "日本の輸入額にしめる工業製品の割合。昔は2割ほどだったが、今では6割をこえる。「原料を輸入して製品を輸出する」加工貿易の形がくずれてきた",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_118: {
    ...
    steps: [
      "よこじくは「年度」、たてじくは「%」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「2022」で26（%）。",
      "いちばん小さいのは「1990」で6。差は20。",
      "大きい順にならべると 2022 → 2020 → 2010 → 2000 → 1990。棒の高さを見比べて確かめる。",
      "日本の製造業が海外の工場でつくる割合（海外生産比率）。年々上がっており、国内の工場や雇用が減る「産業の空洞化」につながった",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_119: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「その他 52%」で、全体のおよそ52%。",
      "内わけは 自動車 35% 35%、原動機 5% 5%、建設用機械 4% 4%、自動車部品 4% 4% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "アメリカ向け輸出の3分の1以上が自動車。1980年代の日米貿易摩擦の中心も自動車で、日本は輸出の自主規制と現地生産で対応した",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_120: {
    ...
    steps: [
      "よこじくは「年」、たてじくは「円／1ドル」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（1970, 360）、終わりは（2024, 151）。",
      "全体として209だけ減っている。右下がりは減少を表す。",
      "かたむきが急なところほど、変わり方が大きい。",
      "1ドル＝何円かの移り変わり。グラフが下がる＝円高（輸入に有利）、上がる＝円安（輸出に有利）。1973年に変動相場制へ、1985年のプラザ合意で急な円高になった",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_121: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「船・重量」で99（%）。",
      "いちばん小さいのは「航空・重量」で1。差は98。",
      "大きい順にならべると 船・重量 → 船・金額 → 航空・金額 → 航空・重量。棒の高さを見比べて確かめる。",
      "日本の貿易を「金額」と「重さ」で分けたようす。飛行機は重さではごくわずかなのに、金額では2割前後をしめる＝軽くて高価なものを運んでいる",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_122: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「名古屋港」で12.9（兆円）。",
      "いちばん小さいのは「関西空港」で5.9。差は7。",
      "大きい順にならべると 名古屋港 → 成田空港 → 横浜港 → 東京港 → 神戸港 → 関西空港。棒の高さを見比べて確かめる。",
      "輸出額の多い港・空港（近年の年間輸出額・兆円）。1位は自動車を積み出す名古屋港。成田国際空港がすぐ後ろにせまる",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_123: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「成田空港」で20.2（兆円）。",
      "いちばん小さいのは「千葉港」で5.4。差は14.8。",
      "大きい順にならべると 成田空港 → 東京港 → 名古屋港 → 大阪港 → 横浜港 → 千葉港。棒の高さを見比べて確かめる。",
      "輸入額の多い港・空港（近年の年間輸入額・兆円）。1位は成田国際空港。医薬品・通信機・集積回路など軽くて高価な品が集まる",
    ],
    buildSteps: 4,
  },
  lf_shakaiext04_123b: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「成田空港」で33（兆円）。",
      "いちばん小さいのは「神戸港」で11。差は22。",
      "大きい順にならべると 成田空港 → 名古屋港 → 東京港 → 横浜港 → 大阪港 → 神戸港。棒の高さを見比べて確かめる。",
      "輸出額＋輸入額（貿易額合計）で見ると1位は成田国際空港。「日本最大の貿易港」と問われたら空港が答えになることがある",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_127: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「自動車」で55（%）。",
      "いちばん小さいのは「航空」で0.2。差は54.8。",
      "大きい順にならべると 自動車 → 内航海運 → 鉄道 → 航空。棒の高さを見比べて確かめる。",
      "国内の貨物輸送の分担率（トンキロ）。トラックが半分以上、船が約4割で、鉄道は5%ほどしかない",
    ],
    buildSteps: 4,
  },
  lf_shakaiext04_127b: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「トラック」で216（g）。",
      "いちばん小さいのは「鉄道」で20。差は196。",
      "大きい順にならべると トラック → 船 → 鉄道。棒の高さを見比べて確かめる。",
      "1トンの荷物を1km運ぶときに出る二酸化炭素の量（g）。鉄道・船に切りかえる「モーダルシフト」が進められている理由",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_131: {
    ...
    steps: [
      "よこじくは「年度」、たてじくは「億個」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「2022」で50.1（億個）。",
      "いちばん小さいのは「2010」で32.2。差は17.9。",
      "大きい順にならべると 2022 → 2021 → 2019 → 2015 → 2010。棒の高さを見比べて確かめる。",
      "宅配便の取扱個数の変化。インターネット通信販売の広がりで年間50億個をこえた。再配達とドライバー不足が大きな課題",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_143b: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「北海道」で8.3（万km2）。",
      "いちばん小さいのは「香川」で0.19。差は8.11。",
      "大きい順にならべると 北海道 → 岩手 → 福島 → 長野 → 新潟 → 香川。棒の高さを見比べて確かめる。",
      "北海道だけがけたちがいに広く、日本の国土の約2割をしめる。2位の岩手県でも北海道の5分の1以下",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_146: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「A国」で24.4（兆円）。",
      "いちばん小さいのは「D国」で4.6。差は19.8。",
      "大きい順にならべると A国 → B国 → C国 → D国。棒の高さを見比べて確かめる。",
      "日本の輸入相手国上位4か国（国名をかくしたもの）。主な輸入品のヒントとあわせて国名を当てる練習に使う",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_147: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「その他 76%」で、全体のおよそ76%。",
      "内わけは 半導体等製造装置 9% 9%、科学光学機器 6% 6%、金（非貨幣用） 5% 5%、集積回路 4% 4% …。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "成田国際空港の輸出品。自動車が出てこず、小さくて高価な精密機械・集積回路が並ぶのが空港の特徴",
    ],
    buildSteps: 4,
  },
  ...
  lf_shakaiext04_148: {
    ...
    steps: [
      "よこじくは「年」、たてじくは「分」を表している。まず何と何を比べた図かをつかむ。",
      "いちばん大きいのは「1964」で240（分）。",
      "いちばん小さいのは「現在」で141。差は99。",
      "大きい順にならべると 1964 → 1965 → 1992 → 現在。棒の高さを見比べて確かめる。",
      "東京〜新大阪の所要時間。開業時は4時間かかったが、「のぞみ」の登場などで2時間半を切るまで短くなった",
    ],
    buildSteps: 4,
  },
