...
export const lessonFigsKokugoExt08: Record<string, Figure> = {
  ...
  lf_kkext08_271: {
    ...
    steps: [
      ...
      "印がついているのは 指す内容、それ。位置を目もりで確かめる。",
      "軸の目盛りは文の番号。説明文の指示語はほとんどが前を指すので、第2文の「それ」を見たら第1文へもどって探す",
    ],
    buildSteps: 3,
  },
  ...
  lf_kkext08_275: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は1から3まで、1きざみで目もりがふってある。",
      "印がついているのは 次のような、指す内容。位置を目もりで確かめる。",
      "「次のようなことだ」「それは〜からである」は例外で、指す内容が後ろにある。前を探して見つからないときは後ろを疑う",
    ],
    buildSteps: 3,
  },
  ...
  lf_kkext08_284: {
    ...
    steps: [
      ...
      "印がついているのは 話題、説明、結論。位置を目もりで確かめる。",
      "軸の目盛りは形式段落の番号。改行の数ではなく内容のまとまりで区切り、意味段落にまとめる",
    ],
    buildSteps: 4,
  },
  // s285: 中心文とそれを支える文
  ...
  lf_kkext08_289: {
    ...
    steps: [
      ...
      "印がついているのは 事実、利点、問題点、提案。位置を目もりで確かめる。",
      "軸の目盛りは意味段落の番号。十字前後の名詞で見出しをつけて並べると、そのまま文章の流れになる",
    ],
    buildSteps: 3,
  },
  ...
  lf_kkext08_290: {
    ...
    steps: [
      ...
      "印がついているのは 話題、問題提起、根拠、まとめ。位置を目もりで確かめる。",
      "軸の目盛りは段落番号。段落の一文目だけを拾い読みすると、役割の並びが見えてくる",
    ],
    buildSteps: 3,
  },
  // s291: 序論・本論・結論
  ...
  lf_kkext08_292: {
    ...
    steps: [
      ...
      "この数直線は1から4まで、1きざみで目もりがふってある。",
      "色のついた範囲は 2以上 かつ 4以下。●はその数をふくみ、○はふくまない。",
      "印がついているのは 主張。位置を目もりで確かめる。",
      "頭括型。目盛りは段落番号で、最初に主張を置き、そのあとに理由と具体例が続く。理由は後ろにある",
    ],
    buildSteps: 4,
  },
  // s293: 尾括型
  lf_kkext08_293: {
    ...
    steps: [
      ...
      "印がついているのは 主張。位置を目もりで確かめる。",
      "尾括型。説明と具体例を積み上げ、最後に主張を述べる。中学入試で最も多い型で、最終段落を精読する",
    ],
    buildSteps: 4,
  },
  // s294: 双括型
  lf_kkext08_294: {
    ...
    steps: [
      ...
      "印がついているのは 主張、主張。位置を目もりで確かめる。",
      "双括型。最初と最後の二か所に主張がある。後ろの主張のほうが一歩深まっているので、比べて増えた言葉に注目する",
    ],
    buildSteps: 4,
  },
  // s295: 段落どうしの関係の四つの型
  ...
  lf_kkext08_300: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は1から4まで、1きざみで目もりがふってある。",
      "印がついているのは くり返し、くり返し、くり返し。位置を目もりで確かめる。",
      "軸の目盛りは文（段落）の番号。同じ内容が三か所以上、言い方を変えてくり返されていれば、それが主張",
    ],
    buildSteps: 3,
  },
  ...
  lf_kkext08_305: {
    ...
    steps: [
      ...
      "この数直線は1から4まで、1きざみで目もりがふってある。",
      "色のついた範囲は 2以上 かつ 3以下。●はその数をふくみ、○はふくまない。",
      "印がついているのは たとえば、このように。位置を目もりで確かめる。",
      "軸の目盛りは文の番号。太い線の部分が具体例。ここをかっこでくくると、外側の第1文と第4文に主張が残る",
    ],
    buildSteps: 4,
  },
  ...
  lf_kkext08_314: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は1から3まで、1きざみで目もりがふってある。",
      "印がついているのは できごとA、できごとB。位置を目もりで確かめる。",
      "軸の目盛りは時間の順。AのあとにBが起きただけでは因果とは言えない。「Aだから B」と入れて意味が通るかで確かめる",
    ],
    buildSteps: 3,
  },
  // s315: 対比＋因果＋主張の総合構成図
