...
export const lessonFigsKokugoExt07: Record<string, Figure> = {
  ...
  k7f_s227: {
    ...
    steps: [
      ...
      "印がついているのは ①教室に一人、②真希が来る、③翌朝の職員室。位置を目もりで確かめる。",
      "時が動く・場所が変わる・人物が出入りする、の三つが場面の切れ目。ここでは切れ目が二か所あり、場面は三つに分かれる",
    ],
    buildSteps: 3,
  },
  ...
  k7f_s237: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-2から2まで、1きざみで目もりがふってある。",
      "印がついているのは かなしみ、ふあん、ふつう、あんしん。位置を目もりで確かめる。",
      "心情はまずプラスかマイナスかを決め、それから強さと種類をしぼる。0より左がマイナス、右がプラス",
    ],
    buildSteps: 3,
  },
  ...
  k7f_s239: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から4まで、1きざみで目もりがふってある。",
      "印がついているのは 入学式・よけた、卒業式・動かず。位置を目もりで確かめる。",
      "母が「えりを直す」という同じ動作が二度。ちがうのは「ぼく」の反応で、そのちがいが心情の変化を表す",
    ],
    buildSteps: 3,
  },
  ...
  k7f_s242: {
    ...
    steps: [
      "よこじくは「場面の流れ（①行き ②話し合い ③帰り）」、たてじくは「心情」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（1, -2）、終わりは（3, 1）。",
      "全体として3だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "かたむきが急なところほど、変わり方が大きい。",
      "坂道は何も変わっていない。「長い・冷たい」から「温かい」へ変わったのは主人公の心のほう",
    ],
    buildSteps: 4,
  },
  ...
  k7f_s244: {
    ...
    steps: [
      ...
      "印がついているのは 根拠①、根拠②、根拠③、根拠④。位置を目もりで確かめる。",
      "根拠①手をあげない②昨日までは先頭③同じ楽器の陸④ケースをいじる。四つそろって「自信のなさ」と決まる",
    ],
    buildSteps: 3,
  },
  ...
  k7f_s245: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から4まで、1きざみで目もりがふってある。",
      "印がついているのは ①心細い、②話しかけ、③打ちとけ。位置を目もりで確かめる。",
      "変化の設問は【変化前】【きっかけ】【変化後】の三つの箱に分けて書き出す",
    ],
    buildSteps: 3,
  },
  ...
  k7f_s246: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から4まで、1きざみで目もりがふってある。",
      "印がついているのは 昼・ひとこと、帰宅、夜・気づく。位置を目もりで確かめる。",
      "きっかけ（昼のひとこと）と心情が変わった時点（夜）は離れていることがある。心情の中身とつながるほうがきっかけ",
    ],
    buildSteps: 3,
  },
  ...
  k7f_s247: {
    ...
    steps: [
      "よこじくは「場面（①選ばれた ②千秋の言葉 ③帰り道）」、たてじくは「心情」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（1, 2）、終わりは（3, 2）。",
      "はじめと終わりが同じ値。とちゅうの動きに注目する。",
      "かたむきが急なところほど、変わり方が大きい。",
      "同じ「喜び」でも①は自分が選ばれた喜び、③は相手の気持ちを知ったうえでの喜びで中身がちがう",
    ],
    buildSteps: 4,
  },
  ...
  k7f_s248: {
    ...
    steps: [
      "よこじくは「時間の流れ」、たてじくは「心情」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（1, -2）、終わりは（3, 2）。",
      "全体として4だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "線が2本あるので、同じよこじくの値どうしで上下を見比べる。",
      "一気型は「〜をきっかけに」、じわじわ型は「〜をくり返すうちに」と書き分ける",
    ],
    buildSteps: 4,
  },
  ...
  k7f_s249: {
    ...
    steps: [
      ...
      "印がついているのは 口では平気、本心は喜び。位置を目もりで確かめる。",
      "「別にほしくなかった」という言葉と、その場を離れない足・軽くなった足取りのずれ。体に近いほうが本心",
    ],
    buildSteps: 3,
  },
  ...
  k7f_s250: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から4まで、1きざみで目もりがふってある。",
      "印がついているのは 変化前、きっかけ、変化後。位置を目もりで確かめる。",
      "字数が少ないときに削るのは【変化前】。配点の高い【きっかけ】は最優先で書く",
    ],
    buildSteps: 3,
  },
  ...
  k7f_s251: {
    ...
    steps: [
      "よこじくは「試合の前（1）と当日（2）」、たてじくは「変化の大きさ」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（1, 0）、終わりは（2, 2）。",
      "全体として2だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "線が2本あるので、同じよこじくの値どうしで上下を見比べる。",
      "行動を変えたのは父（来なかった→見に来た）。「ぼく」は態度こそ変えていないが、心には小さな変化が起きている",
    ],
    buildSteps: 4,
  },
  ...
  k7f_s252: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から4まで、1きざみで目もりがふってある。",
      "印がついているのは ①自信がない、②人に届いた、③続ける。位置を目もりで確かめる。",
      "主題は変化の行き着いた先（③）にある。「結果ではなく、届いたことが続ける力になる」が主題",
    ],
    buildSteps: 3,
  },
  ...
  k7f_s255: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から4まで、1きざみで目もりがふってある。",
      "印がついているのは ずれた道具、心の支え、自分で決める。位置を目もりで確かめる。",
      "同じ方位磁針が三度登場し、そのたびに見え方が変わる。この変化が主題を運んでいる",
    ],
    buildSteps: 3,
  },
  ...
  k7f_s263: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から4まで、1きざみで目もりがふってある。",
      "印がついているのは 自分の答え、ずれを消す、残りを照合。位置を目もりで確かめる。",
      "選択肢を読む前に自分なりの答えを一言で作る。それから、合わない部分に線を引いて消していく",
    ],
    buildSteps: 3,
  },
  ...
  k7f_s266: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から4まで、1きざみで目もりがふってある。",
      "印がついているのは きっかけ、心情、その後。位置を目もりで確かめる。",
      "選択肢は【きっかけ】【心情】【その後の行動】の三か所を一つずつ本文と照らす。一つでも合わなければ消す",
    ],
    buildSteps: 3,
  },
};
