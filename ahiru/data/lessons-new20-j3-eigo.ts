...
　仮定法過去完了 … 今の事実に反する仮定は過去の事実に反する仮定／過去形（be動詞は were が原則）はhad ＋ 過去分詞
+--------------------+------------------------+------------------------------+
...
+----------+---------------------------+------------------------------+
　would／単純な推量・意志／ふつう
　could … 単純な推量・意志は能力・可能性を強調／ふつうは「できる」ことに焦点
　might … 単純な推量・意志は弱い可能性・控えめな推量／ふつうはいちばん弱い（不確か）
+----------+---------------------------+------------------------------+
...
　（明日雨が降ったら、家にいます） … If I were a bird, I would fly to you.は（もし私が鳥なら、あなたのところへ飛んでいくのに）
　→明日雨が降る可能性は十分にある … If I were a bird, I would fly to you.は→私が鳥になることはあり得ない
+--------------------------------------------+--------------------------------------------------+
| If you are free, let's go shopping.         | If I had wings, I could fly.                      |
　（もし暇なら、買い物に行こう）／（もし翼があれば、飛べるのに）
　→相手が暇かどうかは現実にありうる話 … （もし翼があれば、飛べるのに）は→人間に翼はない、現実にありえない話
+--------------------------------------------+--------------------------------------------------+
...
　I wish … 実現可能な願いは実現しない・反する願い／現在形／will＋原形は過去形（仮定法過去）
+----------+----------------------------+------------------------------+
...
　I wish ＋ had ＋ 過去分詞 … 今はあの時（過去）／I wish I were rich.（今、金持ちならなあ）はI wish I had been rich then.（あの時、金持ちだったらなあ）
+---------------------------+----------------------------+---------------------------------+
...
　as if ＋ had ＋ 過去分詞 … 主節と同時のありえない様子は主節より前の時点でのありえない様子
+---------------------------------+--------------------------------------------+
...
　仮定法過去完了 … 過去形（be動詞はwere）はhad ＋ 過去分詞／would/could/might ＋ 原形はwould/could/might ＋ have ＋ 過去分詞
+----------------+------------------------------+--------------------------------------+
...
+------------------------+---------------------------+
　If I were 〜／Were I 〜
　If I had 過去分詞 〜 … Were I 〜はHad I 過去分詞 〜
　If it should 〜 … Were I 〜はShould it 〜
+------------------------+---------------------------+
...
　Without 〜, S would have 過去分詞 … If it were not for 〜, S would 原形はIf it had not been for 〜, S would have 過去分詞
　With 〜, S could 原形 … If it were not for 〜, S would 原形はIf S had 〜, S could 原形
+---------------------------+--------------------------------------------------+
...
　today … thenはthat day／this weekはnext week／that weekはthe following week
　tomorrow … thenはthe next day／this weekはlast week／that weekはthe week before
　yesterday … thenはthe day before／this weekはago／that weekはbefore
　tonight … thenはthat night／this weekはthis／that weekはthat
　here … thenはthere／this weekはthese／that weekはthose
+-------------+------------------+  +-------------+-------------------+
...
　Yes/No疑問文 … say/tell ＋ (that) ＋ 平叙文はask ＋ if/whether ＋ 平叙文語順／He said (that) he was busy.はHe asked if I was busy.
　疑問詞疑問文 … say/tell ＋ (that) ＋ 平叙文はask ＋ 疑問詞 ＋ 平叙文語順／He said (that) he was busy.はHe asked where I lived.
　命令文（肯定） … say/tell ＋ (that) ＋ 平叙文はtell/ask ＋ 人 ＋ to 原形／He said (that) he was busy.はHe told me to open the door.
　命令文（否定） … say/tell ＋ (that) ＋ 平叙文はtell/ask ＋ 人 ＋ not to 原形／He said (that) he was busy.はHe told me not to be late.
+--------------+------------------------------+------------------------------------------------+
