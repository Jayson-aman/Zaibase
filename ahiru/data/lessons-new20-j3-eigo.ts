    ...
    sections: [
      {
        ...
        mangaId: 'new20_j3_eigo_03_kateihou_manga',
...
⚠注意：「〜できるのに」という日本語が出てきたら could、「〜かもしれないのに」なら might、それ以外はwouldを基本にすると判断しやすい。ただし絶対のルールではなく、文全体の意味を優先して考えること。`,
      ...
      {
        heading: 'なぜ would・could・might で伝わる重みが変わるのか',
        mangaId: 'new20_j3_eigo_04_manga',
        body: `仮定法過去の主節の助動詞は、もとの助動詞（will・can・may）を過去形にしたものです。だから意味のちがいも、もとの助動詞を引きついでいます。would は will（意志・単純な推量）の過去形なので「〜するだろうに」、could は can（能力・可能性）の過去形なので「〜できるのに」、might は may（かもしれない）の過去形なので「〜かもしれないのに」と、いちばん確信が弱くなります。文法の形は三つとも同じで、ちがうのは話し手の確信の強さだけです。

日本語の「〜できるのに」が出てきたら could、「〜かもしれないのに」なら might、それ以外は would を基本にすると選びやすいですが、絶対のルールではなく文全体の意味で決めます。否定形も wouldn't・couldn't・might not と同じ規則です。

■ 確かめのしかた
①主節の助動詞を**もとの助動詞**に戻して意味を確かめる：would←will（推量・意志）、could←can（できる）、might←may（かもしれない）。
②日本語の手がかり：「〜できるのに」→could、「〜かもしれないのに」→might、それ以外→would。
③if 節は過去形（be動詞は were）、主節は助動詞の過去形＋原形。形は三つとも同じ。
④否定形は wouldn't／couldn't／might not。

★ ここがポイント：would・could・might は**もとの助動詞（will・can・may）の意味を引きついだ過去形**なので、意志・能力・弱い可能性で使い分ける。形は同じで、ちがうのは確信の強さ。`,
      },
    ],
    trapExamples: [
      {
...
（直説法（ありうる条件）と仮定法過去（現実に反する仮定）のちがい）
・直説法 … If it rains tomorrow, I will stay home.（明日雨が降ったら、家にいます）→明日雨が降る可能性は十分にある
・仮定法過去 … If I were a bird, I would fly to you.（もし私が鳥なら、あなたのところへ飛んでいくのに）→私が鳥になることはあり得ない
・直説法 … If you are free, let's go shopping.（もし暇なら、買い物に行こう）→相手が暇かどうかは現実にありうる話
・仮定法過去 … If I had wings, I could fly.（もし翼があれば、飛べるのに）→人間に翼はない、現実にありえない話
...
⚠注意：I hope のあとに仮定法（過去形）を使うのは誤り。hopeは常に「ありうる」内容にしか使わない。`,
      ...
      {
        heading: 'なぜ I wish のあとは過去形で、なぜ hope とはちがうのか',
        mangaId: 'new20_j3_eigo_06_iwish_manga',
        body: `I wish は「現実にはそうではないが、そうだったらなあ」という**現実に反する願望**を表します。英語では、現実から一歩離れていることを**時制を一つ過去にずらす**ことで示すので、今のことでも過去形（be動詞は were）にします。if 節の仮定法過去とまったく同じ発想で、can は could、will は would になります。I wish I can swim. と現在形のままにすると、「離れている」しるしがなくなります。

I hope が現在形や will をとるのは、hope が**これから実現しうる願い**（合格するといいね）だからです。実現の可能性があるので、現実から離れる必要がなく、時制をずらしません。「実現できそうか、できなさそうか」で hope と wish を選び分けます。

■ 確かめのしかた
①I wish のあとが**過去形（were・could・would）**か。× I wish I can→could、× I wish I am→were。
②「現実には〜ではない」と言えるか。言えれば wish（現実に反する）。
③実現しうる願いなら **I hope＋現在形／will**（I hope you will pass the exam.）。hope のあとに過去形を使わない。
④I wish it would stop raining.（will→would）。that は省略されることが多い。

★ ここがポイント：I wish は**現実に反する願望**なので、現実から離れているしるしとして**時制を一つ過去にずらす**（were・could・would）。実現しうる願いは hope＋現在形。`,
      },
    ],
    trapExamples: [
      {
...
■ 確かめのしかた
①「今」の願望→I wish＋過去形（I wish I were rich.）、「あの時」の後悔→I wish＋**had＋過去分詞**（I wish I had been rich then.）。日本語の「〜していれば」「〜だったらなあ」で過去を振り返っているか。
②× I wish I would have studied→I wish I had studied。× I wish I would bring→had brought。
③否定は hadn't＋過去分詞（I wish I hadn't said such a thing.）。
④If only＋同じ形（If only I had listened to my teacher!）。感嘆符で終わることが多い。

★ ここがポイント：過去の後悔は**もう一段階過去にずらして had＋過去分詞**。I wish のあとは**if 節にあたる内容**なので、主節の形 would have は使わない。`,
      },
    ],
    trapExamples: [
      {
...
■ 確かめのしかた
①as if のあとが**過去形か had＋過去分詞**か。現在形のままになっていないか。
②**主節と同時**の様子→過去形（be動詞は were）。**主節より前**の出来事→had＋過去分詞。「見た目の時点より前に何かをした」なら had。
③文の後半に対比（though he had actually just walked）があれば、前の時点との比較→had run。
④as if＝as though で書きかえ可。look／sound／feel／talk／act のあとに来ることが多い。

★ ここがポイント：as if は**現実に反する様子**なので仮定法。**主節と同時なら過去形、主節より前なら had＋過去分詞**と、ずらす段数で時点の前後を表す。`,
      },
    ],
    trapExamples: [
      {
...
　〇 He said that he was tired.`,
      ...
      {
        heading: 'なぜ間接話法では代名詞・時制・時の語が変わるのか',
        mangaId: 'new20_j3_eigo_13_wahou_manga',
        body: `直接話法は発言を**録音を再生するように**そのまま引用します（He said, "I am tired."）。間接話法は伝える人が**自分の立場から要約して報告する**形です（He said that he was tired.）。立場が変わるので、発言の中の「I」は伝える人から見た「he」に、「今」は報告する時点から見た「その時」に変わります。時制が一段階過去にずれるのも、発言した時点が報告する時点より前だからです。四つのチェック（that でつなぐ・代名詞・時制・時と場所の語）は、すべて「立場の変化」から出てきます。

コンマと引用符を消し忘れる誤り（× He said, that he was tired.）が多いのは、直接話法の見た目が残るからです。that は接続詞で、引用符の代わりに文をつなぐ役目をします。一度に全部覚えず、①骨組み→②代名詞→③時制→④時・場所の語の順に積み上げます。

■ 確かめのしかた
①コンマと引用符を**完全に消し**、that でつなぐ（× He said, that）。
②代名詞を伝える人の立場に（"I"→he／she）。
③伝達動詞が過去なら that 節の時制を一段階過去に（am→was、will→would）。
④now→then、here→there、tomorrow→the next day、today→that day。直接話法は「再生」、間接話法は「報告」。

★ ここがポイント：間接話法は**伝える人の立場からの報告**なので、代名詞・時制・時と場所の語が立場に合わせて変わる。引用符とコンマを消して that でつなぎ、四つを順に積み上げる。`,
      },
    ],
    trapExamples: [
      {
...
■ 確かめのしかた
①伝達動詞を **ask** に（say to 人→ask 人）。？・コンマ・引用符を取る。
②疑問詞がなければ **if／whether** でつなぐ。疑問詞があれば疑問詞をそのまま使う。
③if／whether のあとは**平叙文の語順**、do／does／did は消える（× asked me do I know→asked me if I knew）。
④代名詞・時制・時の語を変える（Are you busy?→if I was busy、Did you call her?→if he had called her、tomorrow→the next day）。whether or not の形もある。

★ ここがポイント：Yes／No 疑問文には疑問詞がないので**「〜かどうか」の if／whether**を借りる。名詞のかたまりになった時点で疑問文ではないので、**平叙文の語順に戻り do／does／did が消える**。`,
      },
    ],
    trapExamples: [
      {
