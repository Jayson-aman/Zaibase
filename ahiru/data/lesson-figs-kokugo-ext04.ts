...
export const lessonFigsKokugoExt04: Record<string, Figure> = {
  ...
  kv_117: {
    ...
    steps: [
      ...
      "印がついているのは あった方がよい、必要、不可欠。位置を目もりで確かめる。",
      "数字は「なくては困る度合い」の目安。必要＜必須・不可欠。「必須」「不可欠」はそれがないと成り立たないときだけ使う",
    ],
    buildSteps: 3,
  },
  kv_119: {
  ...
  kv_120: {
    ...
    steps: [
      ...
      "印がついているのは 末路、結果、成果。位置を目もりで確かめる。",
      "マイナス評価←→プラス評価。「結果」は中立、「成果」はよい結果だけ、「末路」は落ちぶれた最後にしか使えない",
    ],
    buildSteps: 3,
  },
  ...
  kv_123: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-3から3まで、1きざみで目もりがふってある。",
      "印がついているのは 減少、現状維持、増加。位置を目もりで確かめる。",
      "対義語は「同じ一本の軸の両はし」。増加⇔減少は「量」という一本の軸の上で反対を向いている",
    ],
    buildSteps: 3,
  },
  kv_124: {
  ...
  kv_126: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-3から3まで、1きざみで目もりがふってある。",
      "印がついているのは 薄い、ふつう、厚い／濃い。位置を目もりで確かめる。",
      "「薄い」は〈厚い〉の反対にも〈濃い〉の反対にもなる。和語の対義語は文脈を見てから決める",
    ],
    buildSteps: 3,
  },
  ...
  kv_133: {
    ...
    steps: [
      ...
      "印がついているのは 柴犬のハチ、犬、動物、生物。位置を目もりで確かめる。",
      "右へ行くほど抽象的（共通点だけを取り出す）、左へ行くほど具体的。説明文は右の語で主張し、左の語で例を示す",
    ],
    buildSteps: 3,
  },
  kv_134: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-3から3まで、1きざみで目もりがふってある。",
      "印がついているのは 主観、感想＋根拠、客観。位置を目もりで確かめる。",
      "主観＝自分だけの見方（私はこう感じる）／客観＝だれが見てもそう言える見方（測った数値・事実）",
    ],
    buildSteps: 3,
  },
  kv_135: {
  ...
  kv_142: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-3から3まで、1きざみで目もりがふってある。",
      "印がついているのは ローカル（地域）、国・地方、グローバル（地球規模）。位置を目もりで確かめる。",
      "グローバル⇔ローカルは「広さ」の軸。近年はその両方を同時に見る「グローカル」という言い方もある",
    ],
    buildSteps: 3,
  },
};
