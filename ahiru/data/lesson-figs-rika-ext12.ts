...
export const lessonFigsRikaExt12: Record<string, Figure> = {
  ...
  lf_rika_ext12_412: {
    ...
    steps: [
      ...
      "いちばん大きいのは「河口付近」で8（堆積物の粒の大きさ(mm・目安)）。",
      "いちばん小さいのは「沖合（深い場所）」で0.05。差は7.95。",
      "大きい順にならべると 河口付近 → 少し沖合 → 沖合（深い場所）。棒の高さを見比べて確かめる。",
      "河口に近いほど粗い粒（れき・砂）が、沖合に行くほど細かい粒（泥）が堆積する",
    ],
    buildSteps: 4,
  },
  ...
  lf_rika_ext12_415: {
    ...
    caption: '地層が深く埋もれるほど、上に積もった堆積物の重みで圧力が大きくなる。押し固められ（圧縮）、鉱物ですき間が埋められる（接着）ことで堆積物は堆積岩になる',
    steps: [
      "よこじくは「埋没深度(m)」、たてじくは「かかる圧力（相対値）」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（0, 0）、終わりは（200, 4）。",
      "全体として4だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "かたむきが急なところほど、変わり方が大きい。",
      "地層が深く埋もれるほど、上に積もった堆積物の重みで圧力が大きくなる。押し固められ（圧縮）、鉱物ですき間が埋められる（接着）ことで堆積物は堆積岩になる",
    ],
    buildSteps: 4,
  },
  ...
  lf_rika_ext12_422: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「れき（2mm以上）」で5（粒の直径(mm・例)）。",
      "いちばん小さいのは「泥（1/16mm未満）」で0.02。差は4.98。",
      "大きい順にならべると れき（2mm以上） → 砂（2〜1/16mm） → 泥（1/16mm未満）。棒の高さを見比べて確かめる。",
      "れき岩・砂岩・泥岩は粒の大きさ（直径）で区別する。境目は2mmと1/16mm（0.0625mm）",
    ],
    buildSteps: 4,
  },
  ...
  lf_rika_ext12_424: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「石灰岩（反応あり＝泡が出る）」で1（うすい塩酸をかけたときの反応）。",
      "いちばん小さいのは「チャート（反応なし）」で0。差は1。",
      "2本を見比べて、どちらがどれだけ大きいかをつかむ。",
      "石灰岩（主成分は炭酸カルシウム）はうすい塩酸をかけると二酸化炭素の泡を出して溶ける。チャート（主成分は二酸化ケイ素）は塩酸をかけても反応しない",
    ],
    buildSteps: 4,
  },
  ...
  lf_rika_ext12_428: {
    ...
    steps: [
      ...
      "印がついているのは 古生代（サンヨウチュウ・フズリナ）、中生代（アンモナイト・恐竜）、新生代（ビカリア・ナウマンゾウ）。位置を目もりで確かめる。",
      "地質年代は古い方から古生代→中生代→新生代の順。それぞれの代表的な示準化石とセットで覚える",
    ],
    buildSteps: 3,
  },
  ...
  lf_rika_ext12_433: {
    ...
    steps: [
      "よこじくは「震源からの距離(km)」、たてじくは「地震発生からの経過時間(秒)」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（0, 0）、終わりは（48, 6）。",
      "全体として6だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "線が2本あるので、同じよこじくの値どうしで上下を見比べる。",
      "グラフの傾きが小さいP波の方が速く伝わる。同じ距離でもS波の方が到達までの時間が長い＝P波の方が先に届く",
    ],
    buildSteps: 4,
  },
  ...
  lf_rika_ext12_434: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「S波到達」で8（P波到達からの経過時間(秒)）。",
      "いちばん小さいのは「P波到達（基準）」で0。差は8。",
      "2本を見比べて、どちらがどれだけ大きいかをつかむ。",
      "P波とS波の到達時刻の差（この場合8秒）が初期微動継続時間。S波到達時刻そのものではない",
    ],
    buildSteps: 4,
  },
  ...
  lf_rika_ext12_436: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「M7」で1000（地震のエネルギー（M5を1とした相対値））。",
      "いちばん小さいのは「M5」で1。差は999。",
      "大きい順にならべると M7 → M6 → M5。棒の高さを見比べて確かめる。",
  ...
  lf_rika_ext12_438: {
    ...
    steps: [
      "よこじくは「初期微動継続時間(秒)」、たてじくは「震源からの距離(km)」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（0, 0）、終わりは（8, 64）。",
      "全体として64だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "かたむきが急なところほど、変わり方が大きい。",
      "震源からの距離は初期微動継続時間にほぼ比例する（大森公式）。このグラフでは 距離(km) = 8 × 初期微動継続時間(秒)",
    ],
    buildSteps: 4,
  },
  ...
  lf_rika_ext12_439: {
    ...
    steps: [
      "よこじくは「震源からの距離(km)」、たてじくは「到達までの時間(秒)」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（0, 0）、終わりは（48, 6）。",
      "全体として6だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "線が2本あるので、同じよこじくの値どうしで上下を見比べる。",
      "このグラフから、震源からの距離が36kmの地点の初期微動継続時間は約4.5秒と読み取れる（36÷8＝4.5）",
    ],
    buildSteps: 4,
  },
  ...
  lf_rika_ext12_441: {
    ...
    caption: '同じ地震では初期微動継続時間1秒あたりの距離は一定。32km÷4秒＝8km。地点Yの震源距離＝8×10＝80km',
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「地点Y（初期微動10秒）」で80（震源からの距離(km)）。",
      "いちばん小さいのは「地点X（初期微動4秒）」で32。差は48。",
      "2本を見比べて、どちらがどれだけ大きいかをつかむ。",
      "同じ地震では初期微動継続時間1秒あたりの距離は一定。32km÷4秒＝8km。地点Yの震源距離＝8×10＝80km",
    ],
    buildSteps: 4,
  },
  ...
  lf_rika_ext12_442: {
    ...
    caption: '3地点のデータはすべて「震源距離＝8×初期微動継続時間」の関係に乗る（1秒あたり8km）',
    steps: [
      "よこじくは「初期微動継続時間(秒)」、たてじくは「震源からの距離(km)」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（2, 16）、終わりは（12, 96）。",
      "全体として80だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "かたむきが急なところほど、変わり方が大きい。",
      "3地点のデータはすべて「震源距離＝8×初期微動継続時間」の関係に乗る（1秒あたり8km）",
    ],
    buildSteps: 4,
  },
  ...
  lf_rika_ext12_444: {
    ...
    step: 1,
    points: [
      { x: 1, label: '玄武岩質（二酸化ケイ素少・粘性小）' },
      { x: 2, label: '安山岩質（中間）' },
      { x: 3, label: '流紋岩質（二酸化ケイ素多・粘性大）' },
    ],
    caption: 'マグマの粘り気は二酸化ケイ素の含有量が多いほど大きくなる：玄武岩質＜安山岩質＜流紋岩質',
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から4まで、1きざみで目もりがふってある。",
      "印がついているのは 玄武岩質（二酸化ケイ素少・粘性小）、安山岩質（中間）、流紋岩質（二酸化ケイ素多・粘性大）。位置を目もりで確かめる。",
      "マグマの粘り気は二酸化ケイ素の含有量が多いほど大きくなる：玄武岩質＜安山岩質＜流紋岩質",
    ],
    buildSteps: 3,
  },
  ...
  lf_rika_ext12_445: {
    kind: 'barChart',
    yLabel: '由来するマグマの二酸化ケイ素含有量(%・目安)',
    bars: [
      { label: '軽石（白っぽい）', value: 70 },
      { label: 'スコリア（黒っぽい）', value: 50 },
    ],
    caption: '軽石とスコリアはどちらも気泡を多く含み軽いが、軽石は二酸化ケイ素の多い白っぽいマグマ、スコリアは二酸化ケイ素の少ない黒っぽいマグマに由来する',
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「軽石（白っぽい）」で70（由来するマグマの二酸化ケイ素含有量(%・目安)）。",
      "いちばん小さいのは「スコリア（黒っぽい）」で50。差は20。",
      "2本を見比べて、どちらがどれだけ大きいかをつかむ。",
      "軽石とスコリアはどちらも気泡を多く含み軽いが、軽石は二酸化ケイ素の多い白っぽいマグマ、スコリアは二酸化ケイ素の少ない黒っぽいマグマに由来する",
    ],
    buildSteps: 4,
  },
  ...
  lf_rika_ext12_447: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から4まで、1きざみで目もりがふってある。",
      "印がついているのは 急冷（地表付近）→結晶小（斑状組織＝火山岩）、徐冷（地下深く）→結晶大（等粒状組織＝深成岩）。位置を目もりで確かめる。",
      "冷え方がゆっくりなほど結晶が成長する時間が長くなり、大きな結晶（等粒状組織）になる",
    ],
    buildSteps: 3,
  },
  ...
  lf_rika_ext12_448: {
    ...
    caption: '火山岩は二酸化ケイ素含有量が多いほど白っぽくなる：玄武岩＜安山岩＜流紋岩',
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「流紋岩（白っぽい）」で70（二酸化ケイ素含有量(%・目安)）。",
      "いちばん小さいのは「玄武岩（黒っぽい）」で50。差は20。",
      "大きい順にならべると 流紋岩（白っぽい） → 安山岩（中間） → 玄武岩（黒っぽい）。棒の高さを見比べて確かめる。",
      "火山岩は二酸化ケイ素含有量が多いほど白っぽくなる：玄武岩＜安山岩＜流紋岩",
    ],
    buildSteps: 4,
  },
  ...
  lf_rika_ext12_449: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「花こう岩（白っぽい）」で70（二酸化ケイ素含有量(%・目安)）。",
      "いちばん小さいのは「はんれい岩（黒っぽい）」で50。差は20。",
      "大きい順にならべると 花こう岩（白っぽい） → せん緑岩（中間） → はんれい岩（黒っぽい）。棒の高さを見比べて確かめる。",
      "深成岩も同じ規則：はんれい岩＜せん緑岩＜花こう岩。同じ色（同じマグマ）の火山岩とペアで覚える（はんれい岩⇔玄武岩、せん緑岩⇔安山岩、花こう岩⇔流紋岩）",
    ],
    buildSteps: 4,
  },
};
