...
export const lessonFigsRikaExt12: Record<string, Figure> = {
  ...
  lf_rika_ext12_444: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から4まで、1きざみで目もりがふってある。",
      "印がついているのは 玄武岩質（SiO2少・粘性小）、安山岩質（中間）、流紋岩質（SiO2多・粘性大）。位置を目もりで確かめる。",
      "マグマの粘り気はSiO2（二酸化ケイ素）の含有量が多いほど大きくなる：玄武岩質＜安山岩質＜流紋岩質",
    ],
    buildSteps: 3,
  },
  ...
  lf_rika_ext12_445: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「軽石（白っぽい）」で70（由来するマグマのSiO2含有量(%・目安)）。",
      "いちばん小さいのは「スコリア（黒っぽい）」で50。差は20。",
      "2本を見比べて、どちらがどれだけ大きいかをつかむ。",
      "軽石とスコリアはどちらも気泡を多く含み軽いが、軽石はSiO2の多い白っぽいマグマ、スコリアはSiO2の少ない黒っぽいマグマに由来する",
    ],
    buildSteps: 4,
  },
  ...
  lf_rika_ext12_449: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「花こう岩（白っぽい）」で70（SiO2含有量(%・目安)）。",
