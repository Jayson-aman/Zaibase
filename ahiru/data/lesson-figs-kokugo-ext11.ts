...
export const lessonFigsKokugoExt11: Record<string, Figure> = {
  ...
  kf11_s398: {
    ...
    steps: [
      ...
      "印がついているのは あし、わろし、よろし、よし。位置を目もりで確かめる。",
      "右へ行くほどよい評価。よし（すばらしい）＞よろし（悪くない）＞わろし（よくない）＞あし（悪い）",
    ],
    buildSteps: 4,
  },
  // 古文の一日の時間帯（0時〜24時）。
  kf11_s399: {
    ...
    steps: [
      ...
      "印がついているのは あかつき、あけぼの、つとめて、ひる。位置を目もりで確かめる。",
      "あかつき（まだ暗い夜明け前）→あけぼの（空が白みはじめるころ）→つとめて・あした（早朝）→ひる→ゆふぐれ→よひ（日が暮れて間もないころ）",
    ],
    buildSteps: 3,
  },
  // 有名な古典作品の成立年（およそ）。
  kf11_s406: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は850から1750まで、150きざみで目もりがふってある。",
      "印がついているのは 竹取物語、枕草子、方丈記、徒然草。位置を目もりで確かめる。",
      "竹取物語・枕草子は平安時代、方丈記・平家物語（1240年ごろ）・徒然草は鎌倉時代、奥の細道は江戸時代の作品",
    ],
    buildSteps: 3,
  },
  // ── 5. 漢文の訓読 ────────────────────────────
  ...
  kf11_s411: {
    ...
    steps: [
      ...
      "印がついているのは 白文、訓読文、書き下し文。位置を目もりで確かめる。",
      "漢字だけの白文に訓点（返り点・送りがな・句読点）を付けたものが訓読文、それを日本語の文に書き改めたものが書き下し文",
    ],
    buildSteps: 4,
  },
  ...
  kf11_s412: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から5まで、1きざみで目もりがふってある。",
      "印がついているのは 備、有、患、無。位置を目もりで確かめる。",
      "「有レ備無レ患」の読む順番。レ点は下の一字を先に読んでから、すぐ上の一字に返る。書き下し文は「備へ有れば患ひ無し」",
    ],
    buildSteps: 3,
  },
  ...
  kf11_s413: {
    ...
    steps: [
      ...
      "印がついているのは 百、聞、一、見。位置を目もりで確かめる。",
      "「百聞不レ如二一見一」の読む順番。一点の付いた「見」まで読んだら二点の「如」へ返り、最後にレ点の「不」を読む",
    ],
    buildSteps: 3,
  },
  ...
  kf11_s414: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から7まで、1きざみで目もりがふってある。",
      "印がついているのは 宋、人、田、耕。位置を目もりで確かめる。",
      "「宋人有下耕二田一者上」の読む順番。まず一二点を片づけ、上点の「者」を読んでから下点の「有」に返る（韓非子・守株）",
    ],
    buildSteps: 3,
  },
  // ── 6. 漢詩 ─────────────────────────────────
  ...
  kf11_s417: {
    ...
    steps: [
      ...
      "いちばん大きいのは「七言律詩」で56（詩全体の字数（字））。",
      "いちばん小さいのは「五言絶句」で20。差は36。",
      "大きい順にならべると 七言律詩 → 五言律詩 → 七言絶句 → 五言絶句。棒の高さを見比べて確かめる。",
      "絶句は4句、律詩は8句。五言は1句5字、七言は1句7字。孟浩然「春暁」は4句×5字＝20字の五言絶句",
    ],
    buildSteps: 4,
  },
};
