...
export const lessonFigsRikaExt01: Record<string, Figure> = {
  ...
  lf_rikaext01_010: {
    ...
    steps: [
      "よこじくは「光の強さ」、たてじくは「見かけの光合成量(CO2 mg/時)」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（0, -2.4）、終わりは（8, 3.6）。",
      "全体として6だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "かたむきが急なところほど、変わり方が大きい。",
      "暗所(光0)ではCO2放出2.4mg/時＝呼吸量。真の光合成量＝見かけの光合成量＋2.4mg",
    ],
    buildSteps: 4,
  },
  ...
  lf_rikaext01_011: {
    ...
    steps: [
      "よこじくは「光の強さ(lux)」、たてじくは「見かけの光合成量(CO2 mg/時)」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（0, -3）、終わりは（3000, 1.5）。",
      "全体として4.5だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "かたむきが急なところほど、変わり方が大きい。",
      "2000luxで見かけの光合成量が0＝光補償点。呼吸量は3.0mg/時なので、この点でも真の光合成量は3.0mg/時",
    ],
    buildSteps: 4,
  },
  ...
  lf_rikaext01_012: {
    ...
    steps: [
      "よこじくは「光の強さ」、たてじくは「見かけの光合成量」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（0, -1.5）、終わりは（10, 7）。",
      "全体として8.5だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
  ...
  lf_rikaext01_034: {
    ...
    steps: [
      "よこじくは「光の強さ」、たてじくは「CO2の出入り(mg/時、＋は吸収)」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（0, -1.8）、終わりは（8, 7.5）。",
      "全体として9.3だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "かたむきが急なところほど、変わり方が大きい。",
      "暗所での呼吸量は1.8mg/時。光の強さ7〜8で見かけの光合成量が7.5mg/時で一定＝光飽和点。真の光合成量＝7.5+1.8=9.3mg",
    ],
    buildSteps: 4,
  },
