...
・段落の最初の this / these は前段落の内容をまとめることが多い`,
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】本文（テクノロジーとコミュニケーションの変化についてのパッセージ）を読み、内容と合っていない選択肢を1つ選ぶ。\n【なぜ③が不一致なのか】本文には「対面コミュニケーションがデジタルメッセージに置き換えられつつあることを一部の人が心配している」と書かれており、これは「補完している（complement）」という肯定的な内容ではなく「置き換えられている（replace）」という批判的な内容だから。\n【ポイント1】①「数日〜数週間かかることがあった」は本文の"waited for days or even weeks"と一致する。\n【ポイント2】②「数秒でメッセージを送受信できる」は本文の"receive answers within seconds"と一致する。④「テクノロジーはコミュニケーション方法を変えた」も本文冒頭の"Technology has changed the way we communicate."と一致する。\n【ポイント3】③「デジタルメッセージが対面コミュニケーションを完全に補完している」は、本文の「置き換えられつつある（replace）」という内容と異なるため不一致。replace（置き換える）とcomplement（補完する）は意味がちがう。\n【答え】③ 一部の人はデジタルメッセージが対面コミュニケーションを完全に補完していると考えている。\n【確かめ】本文の該当箇所を読み直し、「置き換え」と「補完」という2つの語の意味のちがいを確認する。\n【よくあるまちがい】選択肢の語句が本文に似た言葉で出てくることだけで「合っている」と判断してしまう。\n【ここが絶対】「合っていないものを選べ」問題では、選択肢の語句を本文の語句と1つずつ丁寧に照合し、言い換えの意味のちがいに注意する。',
    difficulty: 'advanced',
    course: 'koko-general',
    examType: 'koko',
    maxOnly: true,
