...
export const figuresGradeE6Sansu: Record<string, Figure> = {
  ...
  grade_e6_sansu_21: {
    ...
    caption: '相似比3:5 → 面積比9:25、ABC27cm²のときDEF75cm²',
    steps: [
      '相似比3:5から面積比を求める:3×3:5×5',
      '面積比は9:25になる',
      'ABCの面積27cm²が、比の9にあたる',
      '比の1にあたる面積を求める:27÷9=3cm²',
      'DEFの面積は比の25にあたる',
      'DEFの面積を求める:3×25=75cm²',
    ],
  },
  ...
  grade_e6_sansu_24: {
    ...
    radiusLabel: '10cm',
    showCenter: true,
    caption: '直径20cm(半径10cm) → 面積=10×10×3.14=314cm²',
    steps: [
  ...
  grade_e6_sansu_25: {
    ...
    showCenter: true,
    caption: '半径6cm・中心角90度のおうぎ形 → 面積28.26cm²',
    steps: [
      'まず円全体の面積を求める:6×6×3.14',
      '円全体の面積=113.04cm²',
      '中心角90度は、円全体360度の90/360にあたる',
      'おうぎ形の面積を求める:113.04×90/360=28.26cm²',
    ],
  },
  ...
  grade_e6_sansu_26: {
    ...
    radiusLabel: '5cm',
    showCenter: true,
    caption: '1辺10cmの正方形に内接する円。かどの部分の面積合計=100−78.5=21.5cm²',
    steps: [
      '正方形の1辺の長さは10cm',
      '正方形の面積を求める:10×10=100cm²',
      '円の半径を求める:10÷2=5cm',
      '円の面積を求める:5×5×3.14=78.5cm²',
      'かどの部分の面積は、正方形の面積から円の面積を引いた残り',
      'かどの部分の合計を求める:100−78.5=21.5cm²',
    ],
  },
  ...
  grade_e6_sansu_29: {
    ...
    caption: '底面積20cm²(8×5÷2)・柱の長さ12cm → 体積240cm³',
    steps: [
  ...
  grade_e6_sansu_30: {
    ...
    steps: [
      '円柱の底面積を求める:5×5×3.14=78.5cm²',
      '円柱の水の体積を求める:78.5×10=785cm³',
      '四角柱の1辺の長さは10cm',
      '四角柱の底面積を求める:10×10=100cm²',
      '水の深さは、体積÷底面積で求められる',
