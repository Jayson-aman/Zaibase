...
export const moshi202609KokoEigo: Question[] = [
  ...
  },
  {
    ...
    explanation:
      '【何を聞かれているか】\n「顔色が悪い」という状況に合う、正しい助動詞を選ぶ文法問題。\n\n【なぜmustを使うのか】\nmustは「〜しなければならない」という強い義務・必要性を表す助動詞。顔色が悪い相手に「今すぐ医者に診てもらうべきだ」と強く勧める場面にふさわしい。\n\n【ポイント1】助動詞の意味の違いを確認する\nmust＝強い義務・必要性、may＝許可、can＝能力・可能性、will＝未来・意志。\n\n【ポイント2】文脈から強さを判断する\n"You look very pale."（顔色がとても悪い）という深刻な状況なので、弱い許可（may）や単なる可能性（can）ではなく、強い必要性（must）が適切。\n\n【ポイント3】他の選択肢を消去する\n②"may"は「〜してもよい」という許可の意味で文脈に合わない。③"can"は能力・可能性の意味で、この場面での強い勧めには弱すぎる。\n\n【答え】\n① must\n\n【確かめ】\n"You must see a doctor right now."を訳し、「今すぐ医者に診てもらわなければならない」という強い必要性の意味になっていることを確認する。\n\n【よくあるまちがい】\nmustとmayを混同し、②「〜してもよい」という許可の意味で捉えてしまうミス。\n\n【ここが絶対】\nmust＝強い義務・必要性、may＝許可、can＝能力・可能性。それぞれの助動詞が持つ「気持ちの強さ」の違いを意識して覚える。',
...
The movie will be shown to everyone at the festival in November.`,
    ...
    explanation:
      '【何を聞かれているか】\n本文を読んで、文化祭に向けて3年生が制作しているものを選ぶ問題。\n\n【なぜ"have decided to〜"に注目するのか】\n"have decided to〜"（〜することに決めた）という表現の直後に、具体的な決定内容（何を作るか）が書かれていることが多い。\n\n【ポイント1】該当する文を確認する\n"the third-year students have decided to make a short movie about local history"（3年生は地域の歴史についての短い映画を作ることに決めた）。\n\n【ポイント2】準備の様子も確認する\n生徒たちは祖父母から古い写真を集めたり、町の人に話を聞いたりして準備を進めている、という描写が本文にある。\n\n【ポイント3】選択肢を照合する\n①演劇、③合唱、④絵画展はいずれも本文に登場せず、②「短い映画」が本文の"a short movie"とそのまま一致する。\n\n【答え】\n②\n\n【確かめ】\n選んだ選択肢が"make a short movie about local history"の内容と一致していることを確認する。\n\n【よくあるまちがい】\n本文中の"movie"という具体的な単語を見落として、文化祭でよくある他の出し物（演劇や合唱など）を思い込みで選んでしまうミス。\n\n【ここが絶対】\n"have decided to〜"＝「〜することに決めた」という表現は、行事に関する文章で頻出。この直後の具体的な内容を正確に読み取る。',
...
Sara`,
    ...
    explanation:
      '【何を聞かれているか】\nEメールを読んで、内容と一致する選択肢を選ぶ問題。\n\n【なぜ「誰が・いつ・どこで・何をしたか」を整理するのか】\nEメールには複数の話題（夏休みの出来事、クイズの結果、週末の予定など）が含まれることが多く、それぞれを整理しながら読まないと、選択肢のひっかけに惑わされやすい。\n\n【ポイント1】該当する文を確認する\n"I went to my grandparents\' house in Nagano and swam in the river every day."（長野の祖父母の家に行き、毎日川で泳いだ）が選択肢①と一致する。\n\n【ポイント2】他の選択肢を本文と照合する\n②Mr. Greenは"from Canada"（カナダ出身）でアメリカではない。③Saraは"I got every question right"（全問正解した）と述べており、間違えた問題はない。④Saraが誘っているのは映画ではなく図書館での勉強（"study ... at the library"）。\n\n【ポイント3】"went to"と"swam in"の意味を確認する\n過去形の動詞から、すでに起きた出来事（夏休みの体験）だとわかる。\n\n【答え】\n①\n\n【確かめ】\n選んだ選択肢が"went to my grandparents\' house in Nagano and swam in the river every day"の内容と一致していることを確認する。\n\n【よくあるまちがい】\n「土曜日」という単語だけを見て、内容を確認せずに④を選んでしまうミス。何をするために誘っているのかまで正確に読み取る必要がある。\n\n【ここが絶対】\nEメール問題は「誰が・いつ・どこで・何をした/する予定か」を整理しながら読むと、内容一致問題が解きやすくなる。',
