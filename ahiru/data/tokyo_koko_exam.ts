...
問3. 二次方程式 x²＋ax＋b＝0 の2つの解が x＝2 と x＝3 であるとき、a と b の値を求めよ。`,
    ...
    explanation:
      '【何を聞かれているか】（問1）二次方程式x²－5x＋6＝0を解の公式で解く、（問2）連続する2つの整数n、n＋1について大きい方の2乗から小さい方の2乗を引いた差が常に奇数になることを証明する、（問3）二次方程式x²＋ax＋b＝0の解がx＝2、3であるときのa、bを求める。\n【なぜその式なのか】問1は解の公式にそのまま数値を代入する。問2は式を展開して整理し、偶数＋1の形（奇数の定義）に到達させる。問3は2次方程式の解と係数の関係（解の和＝－a、解の積＝b）を使う。\n【ステップ1】問1：解の公式x＝(5±√(25－24))/2に代入すると、x＝(5±1)/2より、x＝3またはx＝2。\n【ステップ2】問2：(n＋1)²－n²を展開する。n²＋2n＋1－n²＝2n＋1。2nは偶数なので、2n＋1は必ず奇数になる。よって差は常に奇数（証明終）。\n【ステップ3】問3：解と係数の関係より、2＋3＝－aからa＝－5、2×3＝bからb＝6。\n【答え】問1. x＝2, x＝3　問2. 証明（(n+1)²-n²=2n+1は必ず奇数）　問3. a＝－5, b＝6\n【確かめ】問3はx＝2、x＝3を実際にx²－5x＋6＝0に代入して0になることを確認する（4-10+6=0、9-15+6=0）。\n【よくあるまちがい】問2で展開の途中でn²どうしが打ち消し合うことを見落とし、2n²+2n+1のような誤った式にしてしまう。\n【ここが絶対】解と係数の関係は、2次方程式x²+ax+b=0の解をp,qとすると「p+q=-a」「pq=b」になる。',
  },
  {
    ...
    explanation:
      '【何を聞かれているか】（問1）△ABCで∠B＝∠CならばAB＝ACであることを証明する、（問2）正三角形ABCの辺BCをCの側に延長しCD＝BCとなる点Dをとったときの∠ACDと∠ADBを求める、（問3）AB＝AC＝5cm、BC＝6cmの二等辺三角形の面積を求める。\n【なぜその式なのか】問1は角の二等分線という補助線を引いて2つの三角形の合同を示す、二等辺三角形の証明の基本の型。問2は一直線の角度の関係（180°）と、CA＝CDから作られる新しい二等辺三角形の性質を使う。問3は頂点から底辺に垂線をひくと底辺が2等分される性質と、三平方の定理を使う。\n【ステップ1】問1：∠Aの二等分線をひき、BCとの交点をMとする。△ABMと△ACMで、AMは共通、∠BAM＝∠CAM（二等分線）、∠ABM＝∠ACM（仮定）なので、1組の辺とその両はしの角がそれぞれ等しく合同。よってAB＝AC（対応する辺）。\n【ステップ2】問2：B,C,Dは一直線上にあり、正三角形なので∠ACB＝60°。一直線は180°なので∠ACD＝180－60＝120°。また、正三角形よりCA＝BC、条件よりCD＝BCなので、CA＝CD。△ACDはCA＝CDの二等辺三角形で、頂角120°の底角は(180－120)÷2＝30°。よって∠ADC＝30°で、B,C,Dが一直線上にありCがBとDの間にあるので∠ADB＝∠ADC＝30°。\n【ステップ3】問3：BCの中点MをとるとBM＝6÷2＝3cm。△ABMは∠AMB＝90°の直角三角形なので、AM²＝AB²－BM²＝25－9＝16、AM＝4cm（3:4:5の直角三角形）。面積＝6×4÷2＝12cm²。\n【答え】問1. 証明（△ABM≡△ACMからAB=AC）　問2. ∠ACD＝120°、∠ADB＝30°　問3. 12cm²\n【確かめ】問2は△ABDの内角の和を確認する。∠ABD＝60°、∠ADB＝30°なので∠BAD＝180－60－30＝90°で、合計180°になっている。\n【よくあるまちがい】問3で斜めの辺5cmを高さとして使い6×5÷2=15cm²としてしまう。高さは底辺に垂直な長さでなければならない。\n【ここが絶対】二等辺三角形の証明は角の二等分線（または頂点からの垂線）という補助線を引いて合同を示す。二等辺三角形の面積は、頂点から底辺への垂線で直角三角形に分け、三平方の定理で高さを求める。',
  },
  {
...
問3. 食物連鎖「植物→草食動物→肉食動物」において、植物の個体数が急激に減少した場合、短期的に草食動物と肉食動物の個体数はどう変化するか。それぞれ答えよ。`,
    ...
    explanation:
      '【何を聞かれているか】エンドウの交配でRR×rrのF1、F1どうしのF2の表現型比、食物連鎖で植物が急減したときの草食・肉食動物の変化。\n【なぜそうなるのか】RR（丸の純系）とrr（しわの純系）を交配すると、子はすべて両親から1つずつ遺伝子を受けつぎRrになる。Rが優性なので見た目はすべて丸。F1（Rr）どうしを交配すると、遺伝子の組み合わせはRR:Rr:rr＝1:2:1になり、RrもRRも同じ「丸」に見えるので表現型は丸:しわ＝3:1になる。食物連鎖では下位の生物（植物）が減ると、それを食べる草食動物がまず食料不足で減り、さらにその後を追うように肉食動物も食料不足で減っていく。\n【ステップ1】RR×rr→子はすべてRr（遺伝子型）、表現型はすべて丸。\n【ステップ2】Rr×Rr→RR:Rr:rr＝1:2:1、表現型は丸(RR+Rr):しわ(rr)＝3:1。\n【ステップ3】植物減少→草食動物が先に減少→やや遅れて肉食動物も減少。\n【答え】問1. 遺伝子型：Rr、表現型：丸　問2. 丸：しわ＝3：1　問3. 草食動物は減少、肉食動物も遅れて減少する\n【確かめ】F2の遺伝子型の比1:2:1を全部たすと4になり、そのうち丸になるRR+Rrは1+2＝3、しわのrrは1なので3:1で確かめが取れる。\n【よくあるまちがい】F2の遺伝子型比（1:2:1）と表現型比（3:1）を混同する。RrとRRが見た目では区別できず、どちらも「丸」に数えることを見落としやすい。\n【ここが絶対】優性の法則により、Rrという遺伝子の組み合わせでも見た目は優性形質（丸）になることと、食物連鎖では下位の変化が時間差で上位にも連鎖することを押さえる。',
  },
];
...
問3. 電流の大きさを2倍、磁場の強さを3倍にしたとき、力の大きさは元の何倍になるか。`,
  ...
  },
  {
    ...
    pitfall:
      '物質量（mol）を使った気体の体積計算は高校化学の内容で、高校入試には出ない。中学では、反応する重さや気体の体積の比をそのまま使って計算する。',
    subject: 'rika',
    course: 'koko-waseda',
    examType: 'koko',
    difficulty: 'advanced',
    ...
    explanation:
      '【何を聞かれているか】塩酸と亜鉛の反応式、亜鉛6.5gから発生する水素の体積、水上置換で最初の気体を集めない理由。\n【なぜそうなるのか】亜鉛は塩酸と反応して水素を発生しながら塩化亜鉛になる（Zn＋2HCl→ZnCl₂＋H₂）。この反応では亜鉛と水素の物質量（モル数）が1:1で対応するので、亜鉛のモル数がわかれば発生する水素のモル数もそのままわかり、標準状態では1molの気体はどんな気体でも22.4Lを占める。水上置換では、実験を始める前から装置の中に残っていた空気が最初に押し出されてくるため、そのままでは水素と空気が混ざってしまう。\n【ステップ1】亜鉛のモル数＝6.5g÷65g/mol＝0.1mol。\n【ステップ2】反応式よりZn:H₂＝1:1なので、発生するH₂も0.1mol。\n【ステップ3】体積＝0.1mol×22.4L/mol＝2.24L。\n【答え】問1. Zn＋2HCl → ZnCl₂＋H₂　問2. 2.24 L　問3. 最初は試験管（装置）の中に残っていた空気が出てくるため\n【確かめ】反応式の係数（Zn:HCl:ZnCl₂:H₂＝1:2:1:1）を見て、ZnとH₂の係数がどちらも1であることから1:1の対応が正しいことを確認する。\n【よくあるまちがい】HClの係数2を見て、ZnとH₂の対応も1:2だと勘違いしてしまう。反応式は**着目する物質どうしの係数の比**で読む。\n【ここが絶対】標準状態では気体の種類によらず1molが22.4Lを占めること、水上置換では最初に出る気体（装置内の空気）は集めないことを押さえる。',
  },
  {
...
問3. 直角三角形の直角をはさむ2辺が5と12のとき、斜辺の長さを求めよ。`,
    ...
    explanation:
      '【何を聞かれているか】（問1）3辺が3,4,5の直角三角形の面積、（問2）その三角形の内接円の半径r、（問3）直角をはさむ2辺が5と12のときの斜辺の長さを求める。\n【なぜその式なのか】直角三角形では直角をはさむ2辺がそのまま底辺・高さになる。内接円の半径は「面積÷半周長」の公式で求まる。斜辺の長さは三平方の定理c²＝a²＋b²で求める。\n【ステップ1】問1：直角をはさむ2辺3,4を底辺・高さとして面積を求める。(1/2)×3×4＝6cm²。\n【ステップ2】問2：半周長を求める。(3+4+5)÷2＝6。内接円の半径r＝面積÷半周長＝6÷6＝1cm。\n【ステップ3】問3：三平方の定理c²＝5²+12²＝25+144＝169を使う。c＝√169＝13cm。\n【答え】問1. 6 cm²　問2. r＝1 cm　問3. 13 cm\n【確かめ】問3は5,12,13が三平方の定理を満たす代表的な整数の組（ピタゴラス数）であることを確認する。\n【よくあるまちがい】問1で斜辺5を高さとして使ってしまう。直角三角形では直角をはさむ2辺が底辺・高さになる。\n【ここが絶対】直角三角形の内接円の半径は「面積÷半周長」。斜辺は三平方の定理c²=a²+b²で求める。',
  },
];
...
　オ. 水上置換で集める`,
    ...
    explanation:
      '【何を聞かれているか】過酸化水素水に二酸化マンガンを加えたときに発生する気体とその化学式、MnO₂の役割、発生する気体の性質。\n【なぜそうなるのか】過酸化水素（H₂O₂）は水と酸素に分解する性質があり、二酸化マンガン（MnO₂）を加えるとその分解が速くなる。MnO₂自身は反応の前後で変化しないので、反応の速さだけを速める「触媒」としてはたらいている。発生する酸素は、分子量32が空気の平均分子量約29より大きいためわずかに空気より重く、無色無臭で水にほとんど溶けないため水上置換で集められ、自分自身は燃えないがものが燃えるのを助ける性質（助燃性）を持つ。\n【ステップ1】2H₂O₂→（MnO₂）→2H₂O＋O₂の反応から、発生する気体は酸素（O₂）と分かる。\n【ステップ2】MnO₂は反応の前後で変化せず反応の速さだけを速めるので「触媒」としてはたらく。\n【ステップ3】選択肢を1つずつ検討する：ア（空気より重い）○、イ（無色無臭）○、ウ（水によく溶ける）×（実際は溶けにくい）、エ（助燃性がある）○、オ（水上置換で集める）○。\n【答え】問1. 酸素・O₂　問2. 触媒（反応速度を速める・自身は変化しない）　問3. ア・イ・エ・オ\n【確かめ】酸素が水に溶けにくい気体であることは、水中の魚が呼吸できる（わずかに溶けた酸素を使っている）事実とも矛盾しない。\n【よくあるまちがい】「水によく溶ける」を正しいと判断してしまう。酸素はごく少量しか水に溶けないからこそ、水上置換という方法で集めることができる。\n【ここが絶対】触媒は反応の前後で自身は変化せず、反応の速さだけを変える物質であることと、酸素は水に溶けにくく助燃性を持つことを押さえる。',
  },
  {
