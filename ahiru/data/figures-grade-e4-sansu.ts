...
export const figuresGradeE4Sansu: Record<string, Figure> = {
  ...
  grade_e4_sansu_11: {
    ...
    steps: ['180°から分かっている2つの角をひく', '180 − 50 − 70 = 60°'],
  },
  ...
  grade_e4_sansu_13: {
    ...
    steps: ['360°から分かっている3つの角をひく', '360 − 90 − 80 − 110 = 80°'],
  },
  ...
  grade_e4_sansu_20: {
    ...
    steps: [
      '向かい合う辺の長さは等しいので、9cmの辺が2本・6cmの辺が2本',
      'まわりの長さ = (9 + 6) × 2 = 30cm',
    ],
  },
  ...
  grade_e4_sansu_23: {
    ...
    steps: [
      '下の境目：十の位が5になる2350（切り上げて2400になる最小の数）',
      '上の境目：2450手前まで（2450になると切り上げて2500になってしまう）',
    ],
  },
  ...
  grade_e4_sansu_25: {
    ...
    steps: [
      '範囲は345以上355未満',
      'この中でいちばん小さい整数は345、いちばん大きい整数は354',
    ],
  },
  ...
  grade_e4_sansu_27: {
    ...
    steps: [
      '1時間ごとの変化を計算する：+2, +3, +2, +1, −2, −2',
      'いちばん大きい変化は+3℃で、10時から11時の間',
    ],
  },
  ...
  grade_e4_sansu_30: {
    ...
    steps: [
      '3週目→4週目：45 − 29 = 16cm',
      '4週目→5週目：58 − 45 = 13cm',
      '16cm > 13cmなので、3週目から4週目の間のほうが大きく伸びた',
    ],
  },
  ...
  grade_e4_sansu_48: {
    ...
    steps: ['底面積 = 4 × 5 = 20c㎡', '高さ = 120 ÷ 20 = 6cm'],
  },
  ...
  grade_e4_sansu_50: {
    ...
    steps: [
      '縦に並んだ4面は組み立てると側面を1周する帯になる',
      '1つとばしの面どうしが向かい合うので、あ⇔う、い⇔え',
      '左右に張り出したお⇔かも向かい合う1組',
    ],
  },
};
