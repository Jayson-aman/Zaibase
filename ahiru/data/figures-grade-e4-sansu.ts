...
export const figuresGradeE4Sansu: Record<string, Figure> = {
  ...
  grade_e4_sansu_26: {
    ...
    steps: [
      'たての軸が気温（℃）、横の軸が時こく。グラフはまず、どちらの軸が何を表しているかを確かめるところから始める。',
      '点は1時間ごとにはかった気温を表していて、それを順に線で結んだものが折れ線グラフ。',
      '線は9時から右上がりに上がっていき、あるところで折り返して右下がりに変わる。',
      'その折り返しの点が、線のいちばん高いところ（山のてっぺん）。ここが気温のいちばん高い時こくになる。',
      'てっぺんの点から真横にたどってたての軸を読むと26℃。これがその日のいちばん高い気温。',
      '同じ点から真下にたどって横の軸を読むと13。これが求める時こく。',
      '数字で確かめても同じ。18・20・23・25・26・24・22 のうちいちばん大きいのは26で、それは13時のところ。',
      '13時は正午（12時）の1時間後なので、午後1時と答える。折れ線グラフは「てっぺんから真下と真横へ、十字にたどる」のが基本の読み方。',
    ],
    buildSteps: 2,
  },
  ...
  grade_e4_sansu_28: {
    ...
    steps: [
      'たての軸が高さ（cm）、横の軸が週。点は週ごとにはかったヒマワリの高さ。',
      '聞かれているのは「4週目から5週目までに伸びた長さ」。高さそのものではなく、2つの点の差を出す問題。',
      'まず4週目の点を見つけ、そこから真横にたどってたての軸を読むと45cm。',
      'つぎに5週目の点を見つけ、同じように真横にたどると58cm。',
      '伸びた長さは、あとの高さから前の高さを引けばよい。58 − 45 ＝ 13cm。',
      'グラフの上では、この差が2つの点のたての開きとして見えている。線のかたむきが急な区間ほど、この差が大きい。',
      '58cmをそのまま答えにしないこと。「何cmになったか」と「何cm伸びたか」はちがう。聞かれているのは差のほう。',
    ],
    buildSteps: 2,
  },
  ...
  grade_e4_sansu_29: {
    ...
    steps: [
      '同じヒマワリのグラフ。今度は1週目から5週目までに伸びた長さを求める。',
      '1週目の点を真横にたどると10cm。これが出発点の高さ。',
      '5週目の点を真横にたどると58cm。これが最後の高さ。',
      '伸びた長さは 58 − 10 ＝ 48cm。はしとはしの差だけで求まる。',
      '1週ごとの伸びをたしても確かめられる。8 ＋ 11 ＋ 16 ＋ 13 ＝ 48cmで一致する。',
      'とちゅうの点を1つずつ見なくても、両はしの差だけで答えが出る。区間が長いときはこちらのほうが速くて確実。',
    ],
    buildSteps: 2,
  },
