...
export const eigoExt05Lessons: Lesson[] = [
  //  1. can / be able to（s156〜s159） 
  {
    ...
    intro: '「彼女はピアノをひけます」を英語にすると She can play the piano. です。ここで多くの人が She can plays. と書いてしまいます。日本語では「ひける」と動詞そのものが変わるのに、英語では can を足すかわりに動詞は原形に戻る。この「戻る」感覚が助動詞のすべての出発点です。',
    order: 656,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：can のうしろに to を入れて × I can to swim. とするまちがいも多い。want to play・be able to play のように to を使う形を先に習っているとつられやすいが、助動詞のうしろは to なしの原形である。`,
...

  {
    ...
    intro: 'Can you swim? に対して「はい、泳げます」を Yes, I can swim. と長く答えると、まちがいではないのに会話ではくどく響きます。英語は Yes, I can. で切り上げるのがふつうです。しかも答えの主語は you ではなく I に入れかえます。たずねる形と答える形をセットで身につけましょう。',
    order: 657,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：What can you see? のように疑問詞を前に出したあとは、必ず「can ＋ 主語」の順になる。× What you can see? と主語が先に来る語順は、日本語の語順につられた典型的なまちがいである。`,
...

  {
    ...
    intro: '「来年には泳げるようになります」を英語にしようとして I will can swim next year. と書いてしまう人がいます。しかし英語では助動詞を二つ続けて置くことができません。そこで登場するのが be able to です。can に足りない過去と未来を、どう補うのかを見ていきましょう。',
    order: 658,
    studyPeriod: '小5前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：「昨日は雨がやんだので、公園でサッカーができた」のような一回の出来事に could を使うと不自然になる。過去の文を英作するときは、「もともとの力の話か、その日一度だけの話か」を確かめるくせをつけたい。`,
...

  {
    ...
    intro: 'Can I open the window? と Can you open the window? — ちがうのは一語だけですが、前者は「開けてもいいですか」、後者は「開けてくれますか」です。だれがその動作をするのかで意味が入れかわります。会話で使う can の意味を、場面ごとに整理していきましょう。',
    order: 659,
    studyPeriod: '小5前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：Can it be true?（本当だろうか）のように、疑問文で「いったい〜だろうか」という驚きを表すこともある。訳すときは前後の文の内容から判断する。`,
  ...
  //  2. may / might（s160〜s162） 
  {
    ...
    intro: 'お店に入ると、店員さんが May I help you? と声をかけてきます。直訳すれば「私はあなたを手伝ってもよいですか」。日本語の「いらっしゃいませ」にあたる決まり文句です。may は相手にへりくだって許しを求める語で、Can I 〜? よりていねいに響きます。',
    order: 660,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：May I help you? を「私を手伝ってくれますか」と取りちがえる受験生が多い。動作をするのは I（店員）なので、「（私が）お手伝いしましょうか」という申し出である。「手伝ってくれますか」と頼むときは Can you help me? となる。`,
...

  {
    ...
    intro: 'It may rain tomorrow. を「明日は雨が降ってもよい」と訳すと、意味が通りません。正しくは「明日は雨が降るかもしれない」です。同じ may に、許可とまったくちがう「推量」の意味があるからです。might とのひびきの差もふくめて確かめていきます。',
    order: 661,
    studyPeriod: '小5前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：It maybe rain tomorrow. は誤り。maybe は副詞なので文の先頭に置き、うしろは will rain のようにふつうの文が続く。`,
...

  {
    ...
    intro: 'may には「〜してもよい」と「〜かもしれない」という二つの意味がありました。では You may go home. はどちらでしょうか。「帰ってよろしい」とも「帰るかもしれない」とも読めてしまいます。文のどこを見れば決められるのか、その手順を作っていきます。',
    order: 662,
    studyPeriod: '小5前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：Maybe を文の途中に入れて × It will maybe rain. とするのは不自然。Maybe it will rain. と文頭に置く形で覚える。`,
  ...
  //  3. must / have to（s163〜s167） 
  {
    ...
    intro: '「もう帰らなければなりません」を英語で言うとき、日本語につられて長い文を作りたくなります。でも英語なら I must go home now. の五語で足ります。「しなければならない」という気持ちは must 一語が引き受け、動詞は原形のまま。英語の身軽さがよく分かる単元です。',
    order: 663,
    studyPeriod: '小5後半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：must のうしろに to を入れて × You must to go. とするまちがいが非常に多い。have to の to につられるためである。「to が付くのは have to のほうだけ」と唱えて覚える。`,
...

  {
    ...
    intro: 'must と同じ意味だと習う have to。ところが疑問文にすると、Must you go? に対して Do you have to go? となり、do が現れます。have to は見た目こそ助動詞のようですが、中身は一般動詞 have の仲間だからです。この一点をおさえれば形はすべて決まります。',
    order: 664,
    studyPeriod: '小5後半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：Does he have to 〜? の答えを Yes, he must. とするのは不自然。聞かれた形（does）で受けて Yes, he does. と答える。`,
...

  {
    ...
    intro: 'must には過去形も未来形もありません。では「昨日は早く起きなければならなかった」はどう言うのでしょう。ここで have to が活躍します。have を had にすれば過去、will have to にすれば未来。時制を自由に動かせるのが have to の強みです。',
    order: 665,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：「〜しなければならないでしょう」を書くとき、まず will を書いてから have to を続ける。will の直後に must や has to を書きたくなったら、助動詞のルール③を思い出すこと。`,
...

  {
    ...
    intro: '英語で一番こわい取りちがえの一つです。You must not go. は「行ってはいけない」、You don\'t have to go. は「行かなくてよい」。日本語ではどちらも「〜ない」で終わるのに、意味は正反対です。相手を止めるのか、自由にするのかが変わってしまいます。',
    order: 666,
    studyPeriod: '小5後半',
    targetLevel: 'moshi',
    keyPoints: [
...
★ ここがポイント：**must not は動作を、don't have to は義務を打ち消す**ので意味が正反対（禁止／不要）。Must I? の No は「義務がない」ので **don't have to**。訳を書いたら禁止か不要かを必ず読み返す。`,
...

  {
    ...
    intro: '何度電話しても友だちが出ないとき、He must be busy. と言えます。「彼はいそがしいにちがいない」という意味で、義務とは関係ありません。must にも may と同じように推量の意味があるのです。must・may・might を「どれくらい確信しているか」の目盛りで並べてみましょう。',
    order: 667,
    studyPeriod: '小5後半',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：選択問題では「意味の強さ」で正解が決まることがある。「たぶん〜だろう」と書いてあれば may、「ぜったい〜にちがいない」なら must、と日本語の強さに合わせて選ぶ。`,
  ...
  //  4. should / had better（s168〜s170） 
  {
    ...
    intro: 'かぜをひいた友だちに「病院に行ったほうがいいよ」と言いたいとき、must を使うと「行かなければだめだ」と命令のように響きます。ここで使うのが should です。You should see a doctor. なら、おしつけずに助言する言い方になります。強さのちがいが分かる単元です。',
    order: 668,
    studyPeriod: '小5後半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：Should I 〜? の答えで No, you shouldn't.（やめたほうがいい）と No, you don't have to.（その必要はない）は意味がちがう。相手の質問の内容に合うほうを選ぶ。`,
...

  {
    ...
    intro: 'had better は「〜したほうがよい」と訳されるので、should よりやわらかい言い方だと思われがちです。実は逆で、「そうしないとまずいことになる」という警告のひびきがあります。目上の人に You had better 〜. と言うと失礼になることも。強さを知って使い分けます。',
    order: 669,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：had better を「〜したほうがよい」という和訳だけで覚えていると、丁寧語のつもりで目上の人に使ってしまう。英作文の場面設定（相手はだれか）を必ず確認する。`,
...

  {
    ...
    intro: '「勉強したら?」とすすめるとき、英語では Why don\'t you study? と言います。直訳すれば「なぜ勉強しないの?」。責めているように見えて、実はやさしいすすめの言い方です。日本語からは想像しにくいこうした表現を、まとめて身につけます。',
    order: 670,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：Why don't you 〜? に対して「Because 〜」と理由を答えるのは誤り。提案なので、Sure. や That's a good idea. のように賛成・不賛成で答える。`,
  ...
  //  5. will / would（s171〜s173） 
  {
    ...
    intro: '「明日は雨が降るでしょう」も「私が持ちますよ」も、英語ではどちらも will を使えます。予想と意志という別のことを、一語でまかなっているのです。一方 be going to は、前から決めていた予定に使います。同じ未来でも、選び方で伝わり方が変わります。',
    order: 671,
    studyPeriod: '小5後半',
    targetLevel: 'kiso',
    keyPoints: [
...
これは上位校でねらわれる決まりである。`,
...

  {
    ...
    intro: 'お店で I want a hamburger. と言っても通じますが、子どもっぽく聞こえます。大人は I\'d like a hamburger. と言うのがふつうです。would like は want のていねいな言いかえで、would like to 〜 なら「〜したいのですが」になります。注文の場面で必ず出てくる形です。',
    order: 672,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：Would you like to 〜?（〜しませんか）と Would you 〜?（〜してくれませんか）はまったく別の意味。like to があるかないかで、相手にすすめているのか、頼んでいるのかが変わる。`,
...

  {
    ...
    intro: 'Will you open the door? と Would you open the door? — どちらも「開けてくれますか」ですが、後者のほうがていねいです。英語では、遠回しな言い方ほどていねいに響くという性質があります。頼み方の強さを、目盛りの上にならべて整理していきましょう。',
    order: 673,
    studyPeriod: '小5後半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：Would you like to 〜? を「〜してくれませんか」と訳す誤りが非常に多い。like to があれば「〜したいですか・〜しませんか」と、相手の気持ちをたずねる文である。`,
  ...
  // ───────────────────── 6. shall / Let's（s174〜s176） ─────────────────────
  {
    ...
    intro: 'Shall I carry your bag? は「私がかばんを持ちましょうか」という申し出です。ところがこれを、いっしょに持とうという意味だと勘ちがいして Shall we 〜? と混同する人が多くいます。だれがその動作をするのかが、I と we で分かれます。まずは Shall I から確かめます。',
    order: 674,
    studyPeriod: '小6前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：相手にしてもらいたいときに Shall you 〜? とは言わない。英語に Shall you 〜? という依頼の形は存在しないので、Will you 〜? / Can you 〜? / Could you 〜? を使う。`,
...

  {
    ...
    intro: 'Shall we dance? は「いっしょにおどりませんか」。Shall I dance? なら「私がおどりましょうか」で、意味がまるでちがいます。一語のちがいで、さそいにも申し出にも変わるのです。Let\'s 〜. への言いかえや、否定の Let\'s not 〜. までまとめて扱います。',
    order: 675,
    studyPeriod: '小6前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：「〜しましょう」と「〜しましょうか（私が）」は日本語では一字ちがいだが、英語では Let's / Shall we（いっしょに）と Shall I（私が）に分かれる。だれが動くのかを必ず確かめる。`,
...

  {
    ...
    intro: '「手伝いましょうか」と言われて「はい、お願いします」と返すとき、英語では Yes, please. です。ところが Shall we 〜? に対しては Yes, let\'s. と答えます。同じ「はい」でも、たずね方によって決まった返しが変わるのです。場面ごとに対で覚えていきましょう。',
    order: 676,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：That's too bad.（それは残念ですね）は相手の残念な知らせに対する決まり文句である。「それはとても悪い」と直訳しないよう気をつける。`,
  ...
  //  7. 依頼・許可の会話表現（s177〜s180） 
  {
    ...
    intro: '道でこまったとき、Where is the station? だけでは、ぶっきらぼうに聞こえます。Could you tell me the way to the station? と言えば、ぐっとていねいになります。この could は「できた」という過去の意味ではなく、遠慮のひびきを出すために使われているのです。',
    order: 677,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：道案内の答えは命令文（Go / Turn）で表す。これは次の命令文の課とつながる。「行ってください」とていねいに言うときは、文末に please を付ける。`,
...

  {
    ...
    intro: '写真をとってよいか聞くとき、Can I take a picture? でも通じますが、初めて会う人には May I take a picture? のほうが安心です。どちらも自分が動作をする許可を求める形。ていねいさの度合いと、場面に合った選び方を身につけます。',
    order: 678,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：電話で自分の名前を言うときは This is Ken (speaking). と言う。I am Ken. は目の前の相手に自己紹介するときの言い方で、電話では使わない。また相手をたずねるときは Who are you? ではなく May I ask who is calling? や Who's calling, please? を使う。`,
...

  {
    ...
    intro: 'Can I 〜? と Can you 〜?、May I 〜? と Would you 〜?。似た形がならぶと、どれを使えばよいか分からなくなります。実は「だれがするか」と「どれくらいていねいか」の二つの軸でならべると、きれいに整理できます。表にして一気に見わたしましょう。',
    order: 679,
    studyPeriod: '小6前半',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：mind のうしろは動名詞（-ing）で、to 不定詞は使わない。× Would you mind to open 〜? は誤り。`,
...

  {
    ...
    intro: '英語の会話では、Sure. / Of course. / I\'m afraid not. のように、決まった返しがくり返し登場します。これは冷たいのではなく、その場でいちいち考えなくてよいようにできた便利な形です。入試の会話文でも同じ表現が何度も出ます。まとめて覚えてしまいましょう。',
    order: 680,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：You're welcome.（どういたしまして）は Thank you. への返事。Excuse me.（すみません）は人に話しかけるときや軽くあやまるとき、I'm sorry. は本当に悪かったときと、使い分けがある。`,
  ...
  //  8. 命令文（s181〜s184） 
  {
    ...
    intro: '英語で「静かにしなさい」は Be quiet. です。主語がありません。英語の文はふつう主語で始まるはずなのに、命令するときだけ主語を省き、動詞の原形で始めるという特別なきまりがあります。日本語では気づきにくい、英語らしい約束事です。',
    order: 681,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：命令文の文末はピリオドが基本。強い調子を表したいときだけ感嘆符を使う（Look out!／Stop!）。会話文の並べかえ問題では、文末の記号まで採点されることがある。`,
...

  {
    ...
    intro: '「走ってはいけません」を英語にするとき、No run. と書いてしまう人がいます。看板の No running. につられるからです。文として言うときは Don\'t run. が正しい形。be動詞の文でも Don\'t be late. のように Don\'t を使います。',
    order: 682,
    studyPeriod: '小5前半',
    targetLevel: 'kiso',
    keyPoints: [
...
⚠ 注意：Don't be late for school.（学校に遅れてはいけません）のように、be動詞のあとに形容詞や熟語が続く形は頻出。be を落として × Don't late for school. と書くまちがいに気をつける。`,
...

  {
    ...
    intro: 'Please sit down. と Sit down, please. — どちらも正しく、please は前にも後ろにも置けます。ただし後ろに置くときはコンマが必要です。また Ken, come here. のように名前で呼びかけるときもコンマが要ります。この小さな記号が、書き取り問題では点になります。',
    order: 683,
    studyPeriod: '小5前半',
    targetLevel: 'oyo',
    keyPoints: [
...
例）Everyone, look at this picture.`,
...

  {
    ...
    intro: 'Hurry up, and you\'ll catch the bus.（急ぎなさい、そうすればバスに間に合う）。Hurry up, or you\'ll miss the bus.（急ぎなさい、さもないと乗りおくれる）。and と or の一語で、はげましと警告が入れかわります。if を使った文への書きかえまでできるようにします。',
    order: 684,
    studyPeriod: '小5前半',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：or には「または」という意味もあるので、コンマの前が命令文になっているかを必ず確かめる。Tea or coffee?（紅茶かコーヒーか）の or とは別のはたらきである。`,
  ...
  //  9. 感嘆文（s185〜s187） 
  {
    ...
    intro: '「なんて美しい花なんだろう」は What a beautiful flower it is! です。ここで a を落として What beautiful flower 〜 と書くと形がくずれます。感嘆文でも、数えられる名詞が一つなら a や an が要るからです。語順と冠詞、二つを同時にそろえます。',
    order: 685,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：a / an の位置は What のすぐあと。× What beautiful a flower の順にはならない。「What ＋ a ＋ 形容詞 ＋ 名詞」の順を口に出して覚える。`,
...

  {
    ...
    intro: 'How beautiful! と How beautiful is it? — 前者は「なんて美しいんだ」という感動、後者は「どれくらい美しいの」という質問です。同じ How で始まるのに中身がちがいます。見分けるかぎは、あとに続く語順と、文の終わりが ! か ? かにあります。',
    order: 686,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：文末の記号でも見分けられる。? なら疑問文、! なら感嘆文。読解でも、記号を先に見ると意味を取りちがえない。`,
...

  {
    ...
    intro: 'What a fast runner he is! と How fast he runs! は、どちらも「彼はなんて速く走るのだろう」という意味です。同じことを二通りに言えるのは、名詞を使うか使わないかがちがうから。どちらで書くかは、あとに続く語を見れば決まります。',
    order: 687,
    studyPeriod: '小6前半',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：What と How のどちらでも書ける内容でも、問題に語数の指定や語群がある場合は、指定に合うほうを選ぶ。並べかえ問題では、a があれば What、なければ How と当たりを付けられる。`,
  ...
  //  10. 付加疑問・否定疑問（s188〜s190） 
  {
    ...
    intro: '「今日は暑いですね」の「ですね」にあたるのが付加疑問です。It\'s hot today, isn\'t it? のように、文の最後に短い疑問をくっつけます。日本語は「ね」の一字ですが、英語は前の文が肯定か否定か、どんな動詞かによって形が変わります。作り方には決まった手順があります。',
    order: 688,
    studyPeriod: '小6前半',
    targetLevel: 'oyo',
    keyPoints: [
...
⚠ 注意：付加疑問は「相手に確かめる」ための言い方なので、話しことばでよく使われる。読解では、話し手が相手の同意を求めている場面だと分かる手がかりになる。`,
...

  {
    ...
    intro: 'You aren\'t busy, are you? と聞かれて「はい、いそがしくありません」と答えたいとき、英語では No, I\'m not. です。日本語の「はい」につられて Yes と答えると、まるで逆の意味になります。命令文や Let\'s に付く特別な形もあわせて確かめます。',
    order: 689,
    studyPeriod: '小6前半',
    targetLevel: 'moshi',
    keyPoints: [
...
⚠ 注意：命令文に do you? や can you? を付けるのは誤り。「命令文には will you?、Let's には shall we?」と、二つセットで暗記する。`,
...

  {
    ...
    intro: 'Don\'t you like natto? と聞かれて、きらいなら答えは No, I don\'t. です。日本語なら「はい、きらいです」と言うので、つい Yes と答えたくなります。英語は質問の形に関係なく、好きなら Yes、好きでないなら No。ここがずれると、会話が正反対に伝わります。',
    order: 690,
    studyPeriod: '小6前半',
    targetLevel: 'moshi',
    keyPoints: [
