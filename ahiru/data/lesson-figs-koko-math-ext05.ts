...
export const lessonFigsKokoMathExt05: Record<string, Figure> = {
  ...
  lf_kokomathext05_156: {
    ...
    steps: [
      ...
      "図の点は (−2, 4)、(−1, 1)、(0, 0)。",
      "x と −x で y の値が等しいので、グラフは y 軸について対称。頂点は原点、軸は y 軸",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext05_158: {
    ...
    steps: [
      "よこじくが x、たてじくが y。点の位置は（x, y）の順で読む。",
      "放物線は y ＝ 2x²。原点を頂点とし、y じくについて左右対称になる。",
      "図の点は (2, 8)、(2, 2)、(2, −4)。",
      "a>0 は上向き、a<0 は下向き。|a| が大きいほど細く、小さいほど横に広がる（x=2 での値で比較）",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext05_161: {
    ...
    steps: [
      "よこじくが x、たてじくが y。点の位置は（x, y）の順で読む。",
      "放物線は y ＝ 0.5x²。原点を頂点とし、y じくについて左右対称になる。",
      "図の点は x=0 → y=0、x=2 → y=2、x=4 → y=8。",
      "0≦x≦4 なら 0≦y≦8。2≦x≦4 なら x=0 を含まないので 2≦y≦8（0 は入らない）",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext05_162: {
    ...
    steps: [
      "よこじくが x、たてじくが y。点の位置は（x, y）の順で読む。",
      "放物線は y ＝ 1x²。原点を頂点とし、y じくについて左右対称になる。",
      "図の点は 左端 (−1, 1)、最小 (0, 0)、右端 (3, 9)。",
      "−1≦x≦3 は x=0 を含むので最小値は 0。答えは 0≦y≦9 で、1≦y≦9 は誤り",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext05_163: {
    ...
    steps: [
      "よこじくが x、たてじくが y。点の位置は（x, y）の順で読む。",
      "放物線は y ＝ -0.5x²。原点を頂点とし、y じくについて左右対称になる。",
      "図の点は 左端 (−2, −2)、最大 (0, 0)、最小 (4, −8)。",
      "−2≦x≦4 では x=0 で最大値 0、|x| が最大の x=4 で最小値 −8。答えは −8≦y≦0",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext05_166: {
    ...
    steps: [
      "よこじくが x、たてじくが y。点の位置は（x, y）の順で読む。",
      "直線は y ＝ 4x − 3。傾きが4で、x が1増えると y は4変わる。",
      "図の点は (1, 1)、(3, 9)。",
      "x が 1→3 のときの変化の割合 (9−1)÷(3−1)=4 は、2点を結ぶ直線の傾き 4 に等しい",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext05_170: {
    ...
    steps: [
      "よこじくが x、たてじくが y。点の位置は（x, y）の順で読む。",
      "直線は y ＝ 4x。傾きが4で、x が1増えると y は4変わる。",
      "図の点は (0, 0)、(2, 8)。",
      "2x²=4x の両辺を x で割ると原点の交点が消える。2x(x−2)=0 と因数分解して x=0, 2",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext05_171: {
    ...
    steps: [
      ...
      "傾きは a(p+q)=(1/2)(−2+4)=1、切片は −apq=−(1/2)(−2)(4)=4。よって y=x+4",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext05_172: {
    ...
    steps: [
      "よこじくが x、たてじくが y。点の位置は（x, y）の順で読む。",
      "直線は y ＝ 1x ＋ 6。傾きが1で、x が1増えると y は1変わる。",
      "図の点は A(−2, 4)、B(3, 9)、C(0, 6)。",
      "ぬられた部分の面積を出すときは、じくに平行な線を底辺にとると計算が楽になる。",
      "OC=6 を底辺に △OAC=(1/2)×6×2=6、△OCB=(1/2)×6×3=9。△OAB=15（高さは x 座標）",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokomathext05_175: {
    ...
    steps: [
      "よこじくが x、たてじくが y。点の位置は（x, y）の順で読む。",
      "直線は y ＝ -1x ＋ 4。傾きが-1で、x が1増えると y は-1変わる。",
      "図の点は A(−4, 8)、B(2, 2)、C(0, 4)。",
      "ぬられた部分の面積を出すときは、じくに平行な線を底辺にとると計算が楽になる。",
      "OC=4、A と B の x 座標の差は 4+2=6。△OAB=(1/2)×4×6=12",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokomathext05_178: {
    ...
    steps: [
      "よこじくが x、たてじくが y。点の位置は（x, y）の順で読む。",
      "直線は y ＝ 1x ＋ 2。傾きが1で、x が1増えると y は1変わる。",
      "図の点は A(−1, 1)、B(2, 4)、P(1/2, 1/4)。",
      "ぬられた部分の面積を出すときは、じくに平行な線を底辺にとると計算が楽になる。",
      "PQ=(x+2)−x² は x=1/2（A と B の x 座標の平均）で最大 9/4。△PAB=(1/2)×3×(9/4)=27/8",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokomathext05_179: {
    ...
    steps: [
      "よこじくが x、たてじくが y。点の位置は（x, y）の順で読む。",
      "放物線は y ＝ 1x²。原点を頂点とし、y じくについて左右対称になる。",
      "図の点は A(−3, 9)、B(−1, 1)、C(1, 1)。",
      "ぬられた部分の面積を出すときは、じくに平行な線を底辺にとると計算が楽になる。",
      "BC=2、AD=6、高さ 9−1=8 の台形。面積は (1/2)×(2+6)×8=32",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokomathext05_180: {
    ...
    steps: [
      "よこじくが x、たてじくが y。点の位置は（x, y）の順で読む。",
      "直線は y ＝ 1x ＋ 6。傾きが1で、x が1増えると y は1変わる。",
      "図の点は A(−2, 4)、B(3, 9)、P(4, 4)。",
      "y=x 上のどの点 P でも △PAB=△OAB=15。放物線との交点 (1, 1) も条件を満たす",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext05_181: {
    ...
    steps: [
      ...
      "図の点は A(−1, 1)、B(3, 9)、M(1, 5)。",
      "ぬられた部分の面積を出すときは、じくに平行な線を底辺にとると計算が楽になる。",
      "AB の中点 M(1, 5) は x も y も平均。OM は △OAB（面積6）を 3 と 3 に2等分する",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokomathext05_184: {
    ...
    steps: [
      "よこじくが x、たてじくが y。点の位置は（x, y）の順で読む。",
      "放物線は y ＝ 1x²。原点を頂点とし、y じくについて左右対称になる。",
      "図の点は A(−1, 1)、B(2, 4)、C(1, 5)。",
      "ぬられた部分の面積を出すときは、じくに平行な線を底辺にとると計算が楽になる。",
      "平行四辺形 OACB では C=A+B−O=(1, 5)。対角線 OC と AB の中点はどちらも (1/2, 5/2)",
    ],
    buildSteps: 4,
  },
  ...
  lf_kokomathext05_186: {
    ...
    steps: [
      ...
      "直線は y ＝ 1x ＋ 6。傾きが1で、x が1増えると y は1変わる。",
      "図の点は D(−6, 0)、A(−2, 4)、A′。",
      "DA′=4、DB′=9、AA′=4、BB′=9。△DAA′∽△DBB′（相似比 4:9、面積比 16:81）",
    ],
    buildSteps: 3,
  },
  ...
  lf_kokomathext05_188: {
    ...
    steps: [
      "よこじくが x、たてじくが y。点の位置は（x, y）の順で読む。",
      "放物線は y ＝ 4.9x²。原点を頂点とし、y じくについて左右対称になる。",
      "図の点は 1秒 4.9m、2秒 19.6m、3秒 44.1m。",
      "時間は負にならないので x≧0 の部分だけが意味をもつ。2秒後→4秒後の平均の速さは 4.9×(2+4)=29.4 m/秒",
    ],
    buildSteps: 3,
  },
};
