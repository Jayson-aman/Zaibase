...
export const lessonFigsRikaExt08: Record<string, Figure> = {
  ...
  lf_rex08_07: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「NaOH水溶液」で13（pH）。",
      "いちばん小さいのは「塩酸」で1。差は12。",
      "大きいほうから NaOH水溶液 → アンモニア水 → 重そう水 → 水 と続く。上位がどれかをおさえる。",
      "塩酸・NaOH水溶液は強酸・強アルカリでpHが7から遠く離れている。炭酸水・重そう水は弱い",
    ],
    buildSteps: 4,
  },
  // s266: pHのランキング実戦演習
  lf_rex08_08: {
    ...
    steps: [
      ...
      "大きい順にならべると NaOH水溶液 → せっけん水 → 重そう水 → 水道水 → 炭酸水 → 食酢。棒の高さを見比べて確かめる。",
  ...
  lf_rex08_11: {
    ...
    steps: [
      ...
      "いちばん大きいのは「固体が溶けている(食塩水・砂糖水・NaOH水溶液・石灰水)」で、全体のおよそ57.1%。",
      "内わけは 気体が溶けている(塩酸・炭酸水・アンモニア水) 42.9%、固体が溶けている(食塩水・砂糖水・NaOH水溶液・石灰水) 57.1%。",
  ...
  lf_rex08_29: {
    ...
    steps: [
      ...
      "酸が過剰でも残る固体は2.4gのまま変わらないが、アルカリが過剰だと固体(NaOH)2.0gが上乗せされ4.4gになる",
    ],
    buildSteps: 4,
  },
