...
export const lessonFigsRikaExt08: Record<string, Figure> = {
  ...
  lf_rex08_05: {
    ...
    steps: [
      ...
      "いちばん大きいのは「漂白剤」で13（pH）。",
      "いちばん小さいのは「胃液」で2。差は11。",
      "大きい順にならべると 漂白剤 → せっけん水 → 水道水 → 食酢 → 胃液。棒の高さを見比べて確かめる。",
      "数字が小さいほど酸性が強く、大きいほどアルカリ性が強い(pHの詳細は次章で学習)",
    ],
    buildSteps: 4,
  },
  ...
  lf_rex08_06: {
    ...
    steps: [
      ...
      "pHは0〜14の数値。7が中性、7より小さいほど酸性が強く、7より大きいほどアルカリ性が強い",
    ],
    buildSteps: 3,
  },
  ...
  lf_rex08_07: {
    ...
    bars: [
      ...
      { label: '水酸化ナトリウム水溶液', value: 13 },
    ],
    caption: '塩酸・水酸化ナトリウム水溶液は強酸・強アルカリでpHが7から遠く離れている。炭酸水・重そう水は弱い',
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「水酸化ナトリウム水溶液」で13（pH）。",
      "いちばん小さいのは「塩酸」で1。差は12。",
      "大きいほうから 水酸化ナトリウム水溶液 → アンモニア水 → 重そう水 → 水 と続く。上位がどれかをおさえる。",
      "塩酸・水酸化ナトリウム水溶液は強酸・強アルカリでpHが7から遠く離れている。炭酸水・重そう水は弱い",
    ],
    buildSteps: 4,
  },
  // s266: pHのランキング実戦演習
  lf_rex08_08: {
    ...
    steps: [
      "棒の高さが数の大きさを表している。まず何を比べた図かをつかむ。",
      "いちばん大きいのは「水酸化ナトリウム水溶液」で13（pH）。",
      "いちばん小さいのは「食酢」で3。差は10。",
      "大きい順にならべると 水酸化ナトリウム水溶液 → せっけん水 → 重そう水 → 水道水 → 炭酸水 → 食酢。棒の高さを見比べて確かめる。",
      "酸性の中で最も7に近い炭酸水(pH5)が最も弱い酸性",
    ],
    buildSteps: 4,
  },
  ...
  lf_rex08_09: {
    ...
    steps: [
      ...
      "いちばん大きいのは「食塩水」で7（pH）。",
      "いちばん小さいのは「塩酸」で1。差は6。",
      "大きい順にならべると 食塩水 → 炭酸水 → 塩酸。棒の高さを見比べて確かめる。",
      "塩酸・炭酸水は酸性、食塩水は中性",
    ],
    buildSteps: 4,
  },
  ...
  lf_rex08_25: {
    ...
    steps: [
      "よこじくは「加えた水溶液Bの体積(mL)」、たてじくは「pH」。点をつないだ線が、どう変わっていくかを表している。",
      "はじめは（0, 1）、終わりは（60, 13）。",
      "全体として12だけ増えている。右上がりなら増加、右下がりなら減少と読む。",
      "かたむきが急なところほど、変わり方が大きい。",
      "B=30mLでpHがちょうど7(中性)になる。中和点の直前・直後でpHが急激に変化する",
    ],
    buildSteps: 4,
  },
  ...
  lf_rex08_36: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から14まで、2きざみで目もりがふってある。",
      "印がついているのは 強酸性、中性、強アルカリ性。位置を目もりで確かめる。",
      "水溶液の性質・中和反応の総まとめ。pH・指示薬・中和計算・気体と固体の区別を復習しよう",
    ],
    buildSteps: 3,
  },
};
