...
export const lessonFigsEigoExt09: Record<string, Figure> = {
  ...
  lf_eigoext09_297: {
    ...
    steps: [
      ...
      "印がついているのは I（主語）、want（動詞）、to play、soccer。位置を目もりで確かめる。",
      "「わたしはサッカーをしたい」の語順。目盛りの数字は並べる順番を表す。③の to play が want の目的語（〜することを）で、動詞が二つ続いて見えるのが名詞的用法の目印",
    ],
    buildSteps: 3,
  },
  ...
  lf_eigoext09_300: {
    ...
    steps: [
      ...
      "印がついているのは something、cold、to drink。位置を目もりで確かめる。",
      "「何か冷たい飲み物」の語順。-thing で終わる語は、形容詞（②cold）も不定詞（③to drink）も後ろに置く。日本語「冷たい→飲み物」とは逆の順になる",
    ],
    buildSteps: 3,
  },
  ...
  lf_eigoext09_307: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「目的（〜するために）」で、全体のおよそ70%。",
      "内わけは 目的（〜するために） 70%、感情の原因（〜して） 22%、結果・判断の根拠 8%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "副詞的用法の内わけのおおよその割合。大半が目的で、次が感情の原因。結果（grow up to be 〜）や判断の根拠（kind to help 〜）はまれなので、決まり文句として覚えれば足りる",
    ],
    buildSteps: 4,
  ...
  lf_eigoext09_311: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から5まで、1きざみで目もりがふってある。",
      "印がついているのは It is（形だけの主語）、easy、for me、to swim（本当の主語）。位置を目もりで確かめる。",
      "「わたしにとって泳ぐことは簡単だ」の語順。①の It は訳さない形だけの主語で、本当の主語は④の to swim。③の for me（だれが泳ぐか）は形容詞のあと・to の前に置く",
    ],
    buildSteps: 3,
  },
  ...
  lf_eigoext09_313: {
    ...
    steps: [
      ...
      "色のついた範囲は 0以上 かつ 60未満。●はその数をふくみ、○はふくまない。",
      "印がついているのは too hot to drink（熱すぎて飲めない）。位置を目もりで確かめる。",
      "コーヒーの温度に見立てた too ... to 〜 の図。太線の範囲（60度未満）なら飲めるが、90度は限度をこえているので飲めない。too は「行きすぎて無理」を表すので、not がなくても否定の意味になる",
    ],
    buildSteps: 4,
  },
  ...
  lf_eigoext09_314: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から24まで、4きざみで目もりがふってある。",
      "色のついた範囲は 18以上 かつ 24以下。●はその数をふくみ、○はふくまない。",
      "印がついているのは too young to drive、old enough to drive。位置を目もりで確かめる。",
      "運転できる年齢に見立てた図。18歳の境目に達していれば old enough to drive（できる）、達していなければ too young to drive（できない）。enough と too はちょうど反対の意味を表す",
    ],
    buildSteps: 4,
  },
  ...
  lf_eigoext09_320: {
    ...
    steps: [
      "円全体を100%として、それぞれが全体のどれくらいかを表した円グラフ。",
      "いちばん大きいのは「不定詞だけ（want・decide）」で、全体のおよそ40%。",
      "内わけは 不定詞だけ（want・decide） 40%、動名詞だけ（enjoy・finish） 35%、どちらもよい（like・begin） 25%。",
      "割合は「部分 ÷ 全体 × 100」で求める。全部たすと100%になることを確かめる。",
      "目的語に何をとるかによる動詞の三分類（入試に出る動詞のおおよその割合）。不定詞だけの組は「これからのこと」、動名詞だけの組は「すでに・現にしていること」を目的語にする",
    ],
    buildSteps: 4,
  ...
  lf_eigoext09_323: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は-5から5まで、5きざみで目もりがふってある。",
      "印がついているのは 動名詞 〜ing（すでにした）、不定詞 to 〜（これからする）。位置を目もりで確かめる。",
      "時間の向きで見た不定詞と動名詞のちがい。remember to lock（これからかける）／remember locking（かけたことを覚えている）のように、同じ動詞でも後ろの形で時間の向きが変わる",
    ],
    buildSteps: 3,
  },
  ...
  lf_eigoext09_324: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から4まで、1きざみで目もりがふってある。",
      "印がついているのは a、sleeping（一語）、baby。位置を目もりで確かめる。",
      "「眠っている赤ちゃん」の語順。説明する分詞が一語のときは名詞の前に置く。sleeping in the bed のように二語以上になったら、the baby sleeping in the bed と後ろに回る",
    ],
    buildSteps: 3,
  },
  ...
  lf_eigoext09_326: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から5まで、1きざみで目もりがふってある。",
      "印がついているのは the letter、written、in English、（is difficult）。位置を目もりで確かめる。",
      "「英語で書かれた手紙」の語順。②③のかたまりが①の名詞を後ろから説明する。文の動詞は④の is で、written を文の動詞と読みちがえないことが読解の要点",
    ],
    buildSteps: 3,
  },
  ...
  lf_eigoext09_328: {
    ...
    steps: [
      ...
      "印がついているのは I know、a boy（先行詞）、who plays the piano。位置を目もりで確かめる。",
      "主格の関係代名詞。太線の範囲が「先行詞 a boy を後ろから説明するかたまり」。who は He の代わり（代名詞）と、二文をつなぐ接着剤の二役を果たすので、he を重ねて書いてはいけない",
    ],
    buildSteps: 4,
  },
  ...
  lf_eigoext09_330: {
    ...
    steps: [
      "数直線は、右へ行くほど数が大きくなる。目もりの1つ分がいくつかを最初に確かめる。",
      "この数直線は0から7まで、1きざみで目もりがふってある。",
      "色のついた範囲は 3以上 かつ 6以下。●はその数をふくみ、○はふくまない。",
      "印がついているのは the book（先行詞）、which、I、read。位置を目もりで確かめる。",
      "目的格の関係代名詞。which のあとが「主語＋動詞」で、read の目的語が抜けた★の穴がある。ここに先行詞 the book が入るはずだった、と考えるともとの二文にもどせる",
    ],
    buildSteps: 4,
  },
